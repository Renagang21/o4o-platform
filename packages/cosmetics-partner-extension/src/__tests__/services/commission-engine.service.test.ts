...
describe('CommissionEngineService', () => {
  ...
  const createPolicy = (overrides: Partial<CommissionPolicy> = {}): CommissionPolicy => {
    ...
    policy.partnerId = overrides.partnerId ?? undefined;
    policy.productId = overrides.productId ?? undefined;
    policy.campaignId = overrides.campaignId ?? undefined;
    policy.effectiveFrom = overrides.effectiveFrom ?? undefined;
    policy.effectiveTo = overrides.effectiveTo ?? undefined;
