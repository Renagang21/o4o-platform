...
export const pharmacyHubGuideFeaturesProps: GuideFeaturesPageProps = {
  ...
  groups: [
    ...
    },
    {
      ...
      items: [
        { label: 'QR', route: '/store-owner/qr' },
        { label: 'POP', route: '/store-owner/pop' },
        { label: '디지털 사이니지', route: '/store-owner/signage' },
        { label: '태블릿', route: '/store-owner/tablets' },
        { label: '상품 설명서', route: '/store-owner/manuals' },
      ],
