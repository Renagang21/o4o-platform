...
export const netureGuideO4OOverviewProps: GuideFeatureManualPageProps = {
  ...
  sections: [
    ...
    },
    {
      ...
      description:
        'O4O는 대형 유통이 잘 다루지 못하는 시장을 위한 구조입니다. 종류가 많고, 한 번에 적게 팔리며, 제품과 건강에 대한 설명이 있어야 판매되는 제품군이 중심입니다.',
      items: [
        { label: '다품종', detail: '제품 종류가 많아 일률적인 대량 유통으로는 다루기 어렵습니다.' },
        { label: '소량 판매', detail: '한 매장에서 한 번에 많이 팔리지 않아 초기 진입이 어렵습니다.' },
        { label: '정보 전달 중요', detail: '제품을 설명하지 않으면 고객이 가치를 이해하기 어렵습니다.' },
        { label: '건강 정보 중요', detail: '건강기능식품 · 의약외품처럼 올바른 정보 전달이 신뢰의 핵심인 제품이 많습니다.' },
      ],
    },
    {
      id: 'product',
      ...
      title: 'O4O 대상 제품의 특징',
      description:
        'O4O가 다루는 제품은 공통된 어려움을 가지고 있습니다. 좋은 제품이어도 유통비용과 설명 부담 때문에 매장에 들어가기 어렵고, 공급자는 이를 해결할 채널이 필요합니다.',
      items: [
        { label: '유통비용', detail: '영업 · 샘플 · 설명자료 · 초기 재고 등 매장 진입에 드는 비용이 큽니다.' },
        { label: '정보 전달', detail: '제품을 제대로 설명할 자료와 채널이 있어야 매장과 고객이 이해합니다.' },
        { label: '공급자의 필요', detail: '소규모 공급자일수록 직접 매장을 뚫기 어려워 함께할 운영 구조가 필요합니다.' },
      ],
    },
    {
      id: 'problem',
      ...
      items: [
        { label: '유통비용 감소', detail: '공통 운영 구조와 콘텐츠를 공유해 매장 진입 비용을 낮춥니다.' },
        { label: '좋은 제품의 시장 진입', detail: '초기 매장 랜딩을 지원해 좋은 제품이 실제 매장에 들어가도록 돕습니다.' },
        { label: '판매자의 관심 유도', detail: '매장 경영자가 부담 없이 다뤄볼 수 있는 조건과 자료를 제공합니다.' },
        { label: '제품 · 건강 정보 전달', detail: '매장에서 고객에게 올바른 제품 · 건강 정보가 전달되도록 합니다.' },
      ],
    },
    {
      id: 'roles',
...
export const netureGuideForOperatorProps: GuideFeatureManualPageProps = {
  ...
  index: {
    ...
    cards: [
      ...
      { title: '콘텐츠 운영', audience: '공통', summary: '공급자 자료 활용 + 직접 · 조합원 참여 제작.', to: '#content' },
  ...
  sections: [
    {
      ...
      title: '운영자는 무엇을 하는가',
      description:
        '운영자는 공급자 자료를 받아 매장이 바로 쓸 수 있는 실행 자산으로 만들고, 매장을 모집 · 지원하며, 그 운영으로 수익 모델을 만드는 사업자입니다. 단순 승인자가 아니라 능동적인 운영 주체입니다.',
      items: [
    ...
    },
    {
      ...
      title: '이벤트 오퍼',
      description:
        '이벤트 오퍼는 특정 참여 그룹의 매장에 한정해 제공하는 특별 공급 조건입니다. 여기에는 운영자가 반드시 이해해야 할 중요한 원칙이 있습니다.',
      items: [
        { label: '많이 모인다고 무조건 싸지지 않음', detail: '공동구매처럼 "많이 모이면 무조건 저렴해지는" 구조가 아닙니다. 조건은 공급자와의 합의로 정해집니다.' },
        { label: '공급자는 유통질서에 민감', detail: '공급자는 기존 거래선 · 가격 정책 보호에 민감합니다. 무리한 가격 인하 요구는 공급자가 받아들이기 어렵습니다.' },
        { label: '특정 참여 그룹을 위한 특별 조건', detail: '이벤트 오퍼는 모두에게 푸는 할인이 아니라, 특정 참여 그룹(네트워크 · 조합 등)에게만 제공하는 한정 공급 조건입니다.' },
        { label: '운영자의 역할', detail: '운영자는 참여 그룹을 명확히 하고, 공급자의 유통질서를 해치지 않는 선에서 조건을 조율합니다.' },
      ],
    },
    {
      id: 'content',
      ...
      title: '콘텐츠 운영',
      description:
        '운영자는 매장에 제공할 콘텐츠를 운영합니다. 공급자 자료를 활용하는 것은 물론, 운영자가 직접 제작하거나 조합원 · 참여자가 함께 만드는 방식도 가능합니다.',
      items: [
    ...
    },
    {
      ...
      title: '적용 예시',
      description:
        '운영자 모델은 한 가지 형태가 아닙니다. 같은 O4O 운영 구조 위에서 협동조합 · 세미 프랜차이즈 · 전문 네트워크 등 다양한 형태로 적용할 수 있습니다.',
      items: [
        { label: '협동조합', detail: '조합원 매장이 함께 자료 · 상품을 공유하고, 조합이 운영자로서 구성 · 지원 · 정산을 담당합니다.' },
        { label: '세미 프랜차이즈', detail: '본부가 운영자로서 통일된 자료 · 상품 · 콘텐츠를 제공하되, 매장의 자율을 존중하는 느슨한 결합 구조입니다.' },
        { label: '전문 네트워크', detail: '특정 분야 전문가 · 사업자가 네트워크를 만들어 전문 콘텐츠와 제품을 매장에 공급합니다.' },
      ],
    },
  ],
  bottomNav: {
