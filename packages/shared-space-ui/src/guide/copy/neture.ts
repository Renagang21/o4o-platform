...
export const netureGuideForSellerProps: GuideFeatureManualPageProps = {
  hero: {
    ...
    title: '내 매장 활용 가이드',
    description:
      '매장 경영자가 O4O에서 상품과 자료를 받아 매장에서 활용하는 흐름을 안내합니다. Neture에서 직접 제공하는 것은 상품 확인 · 장바구니 · 주문 · 배송 확인(전자상거래)과 매장 O4O 참여를 알리는 QR 생성입니다. POP · 블로그 · 디지털사이니지 제작과 제작자료 통합 관리는 서비스별 제공 범위가 다르며, 주로 약국 · 매장 전용 서비스에서 제공됩니다 — 아래 일부 항목은 그러한 매장 서비스 기준 설명입니다.',
  ...
  index: {
    ...
    lead: [
      'Neture에서 매장은 상품 확인 · 장바구니 · 주문 · 배송 확인과 O4O 참여 QR 생성을 직접 사용합니다.',
      'POP · 블로그 · 디지털사이니지 제작과 제작자료 관리는 서비스별 제공 범위가 다르며 주로 매장 전용 서비스에서 제공됩니다.',
  ...
  sections: [
    ...
    },
    {
      ...
      title: '매장 활용 자산 사용하기',
      description:
        '매장은 제공받은 다양한 자료를 그대로 또는 매장에 맞게 활용할 수 있습니다. 다만 이 자료들의 제작 · 통합 관리 기능(제작자료 라이브러리 등)은 서비스마다 제공 범위가 다릅니다 — Neture는 상품 · 주문 중심이며, 아래 자료 제작·관리는 약국 · 매장 전용 서비스에서 제공됩니다.',
      items: [
    ...
    },
    {
      ...
      title: 'POP 활용',
      description:
        'POP는 매장 안에서 제품을 알리고 소비자의 관심을 끌어 상담으로 이어주는 기본 자료입니다. POP 제작은 일부 매장 서비스에서 제공되는 매장 실행 도구이며, Neture에서는 공급 · 유통과 주문 흐름을 중심으로 안내합니다 — POP 제작은 현재 Neture의 직접 기능이 아닙니다.',
      items: [
    ...
    },
    {
      ...
      title: 'QR 활용',
      description:
        'Neture의 QR은 매장이 O4O 참여를 고객 · 직원에게 알리는 안내 QR을 직접 생성해 인쇄 · 배치하는 보조 도구(QR 생성기)입니다. 용도 · 대상을 고르면 QR을 만들어 PNG로 내려받거나 인쇄할 수 있습니다. 제품 정보 · 건강 정보로 연결되는 제품 QR 제작은 약국 · 매장 전용 서비스에서 제공됩니다.',
      items: [
        { label: '용도 · 대상 선택', detail: '공통 안내 / 방문 고객용 / 관계자용 등 용도와 업종 대상을 고릅니다.' },
        { label: 'QR 생성', detail: '선택한 안내 페이지로 연결되는 QR을 즉시 생성합니다.' },
        { label: 'PNG 다운로드 · 인쇄', detail: '생성한 QR을 PNG로 내려받거나 바로 인쇄합니다.' },
        { label: '매장 내·외부 배치', detail: 'TV · 진열대 · 출입구 · 계산대 등 매장 안팎에 배치합니다.' },
        { label: '제품 QR은 매장 서비스', detail: '제품 정보 · 건강 정보로 연결되는 제품 QR 제작 · 저장은 매장 전용 서비스에서 제공됩니다.' },
      ],
    },
    {
      id: 'blog',
      ...
      title: '블로그 · 콘텐츠 활용',
      description:
        '블로그 · 콘텐츠는 소비자 설명과 신뢰 형성에 쓰입니다. 블로그 제작은 매장 서비스에서 고객 안내 콘텐츠를 만들 때 활용되는 기능이며, Neture에서는 공급 · 유통 · 상품 · 주문 흐름을 중심으로 안내합니다 — 블로그 제작은 현재 Neture의 직접 기능이 아닙니다.',
      items: [
    ...
    },
    {
      ...
      title: '디지털사이니지 활용',
      description:
        '디지털사이니지 활용은 서비스별 제공 범위가 다릅니다. Neture에서는 공급 · 유통 정보와 상품 안내를 중심으로 다루며, 매장 화면 제작 · 편성 기능은 약국 · 매장 전용 서비스에서 제공됩니다.',
      items: [
    ...
    },
    {
      ...
      items: [
        { label: '상품 확인 · 상세', detail: '공급자 상품 · 운영자 승인 상품 · 이벤트 오퍼를 확인하고 상세를 봅니다.' },
        { label: '수량 · 장바구니', detail: '필요 수량을 정해 장바구니에 담습니다. 공급자별로 묶여 표시됩니다.' },
        { label: '공급자별 주문 금액 · 배송비 안내', detail: '공급자별 주문 금액과 배송비 · 무료배송 조건을 확인합니다(현재 안내 정보 성격이며 최종 금액은 주문 처리 단계에서 확정).' },
        { label: '주문 진행', detail: '배송 정보를 입력하고 주문을 생성합니다.' },
        { label: '공급자 배송 · 매장 확인', detail: '공급자가 매장으로 배송하고, 매장은 주문 · 배송 상태를 확인합니다. 누락 · 반품 · 문의는 안내 흐름에 따릅니다.' },
      ],
    },
    {
      id: 'start',
      ...
      items: [
        ...
        { label: '5. 받은 자료 · QR 적용', detail: '제공받은 자료와 Neture QR을 매장에 적용합니다. POP · 블로그 · 사이니지 제작은 서비스별 제공 범위에 따릅니다.' },
        { label: '6. 오퍼 · 승인 상품 참여', detail: '이벤트 오퍼에 참여하거나 운영자 승인 상품을 도입하고, 상품을 주문 · 배송 확인합니다.' },
      ],
    },
  ],
  bottomNav: {
...
// ─── /guide/business/own-product (자체 제품 · 서비스 전용 상품 운영 안내) ──
// WO-O4O-NETURE-BUSINESS-GUIDE-OWN-PRODUCT-V1
// 사업 모델 안내서 — "어떤 사업을 만들 수 있는가". 제품 개발·제조·등록 방법이 아님.

export const netureGuideBusinessOwnProductProps: GuideFeatureManualPageProps = {
  hero: {
    eyebrow: '사업 운영 안내',
  ...
  index: {
    ...
    lead: [
      '자체 제품은 운영자가 외부 제품을 소개하는 데서 한 걸음 더 나아가 자신의 사업 모델을 갖는 방법입니다.',
      '핵심은 "직접 만들어야 한다"가 아니라 "기획 · 브랜드 · 운영을 갖고, 공급 · 배송은 선택한다"입니다.',
      '아래 항목을 순서대로 읽으면 자체 제품 사업의 형태와 시작 방법을 이해할 수 있습니다.',
    ],
    cards: [
      { title: '이 문서의 대상', audience: '공통', summary: '약국 · 공급자 · 전문 분야 · 콘텐츠 기반 운영자.', to: '#audience' },
      { title: '왜 자체 제품을 생각하게 되는가', audience: '공통', summary: '기존 제품으로 해결되지 않는 니드 · 고객 요구.', to: '#why' },
      { title: '자체 제품이란 무엇인가', audience: '공통', summary: '단순 PB가 아니라 참여 매장과 함께 기획하는 제품.', to: '#what' },
      { title: '운영자가 직접 제조해야 하는가', audience: '중요', summary: '아니다 — 기획 · 브랜드 · 운영이 운영자의 몫.', to: '#manufacture' },
      { title: '두 가지 운영 방식', audience: '중요', summary: '(A) 운영자가 공급까지 겸업 / (B) 기획 · 운영만.', to: '#two-ways' },
  ...
  sections: [
    {
      ...
      title: '이 문서의 대상',
      description:
        '자체 제품은 특정 형태의 운영자만을 위한 것이 아닙니다. 이미 매장 네트워크를 가진 쪽이든, 공급망을 가진 쪽이든, 전문 분야나 콘텐츠를 가진 쪽이든 자체 제품 사업을 만들 수 있습니다.',
      items: [
        { label: '약국 네트워크 운영자', detail: '여러 약국이 함께 운영하는 그룹 — 참여 약국의 공통 니드를 전용 제품으로 풀 수 있습니다.' },
        { label: '공급자 기반 운영자', detail: '이미 제품 · 거래선을 가진 도매 · 제조 · 수입사 — 서비스 전용 상품으로 확장할 수 있습니다.' },
        { label: '전문 분야 운영자', detail: '특정 영역(예: 전문약사 · 특정 카테고리)에 강점을 가진 운영자.' },
        { label: '콘텐츠 기반 운영자', detail: '설명 · 교육 · 큐레이션 자산을 가진 운영자 — 콘텐츠를 제품과 결합할 수 있습니다.' },
      ],
    },
    {
      id: 'why',
      step: '02',
      title: '왜 자체 제품을 생각하게 되는가',
      description:
        '운영자가 네트워크를 운영하다 보면 기존 제품만으로는 채워지지 않는 지점을 발견하게 됩니다. 자체 제품은 그 빈자리에서 출발합니다.',
      items: [
        { label: '기존 제품으로 해결되지 않는 니드', detail: '시장의 일반 제품이 참여 매장 · 고객의 요구를 충분히 채우지 못하는 경우.' },
        { label: '특정 고객층의 요구', detail: '네트워크가 자주 만나는 특정 고객군의 반복되는 요구.' },
        { label: '참여 매장 공통 요구', detail: '여러 참여 매장에서 공통적으로 올라오는 현장 의견.' },
        { label: '차별화의 필요', detail: '저렴한 구매를 넘어, 네트워크만의 색을 갖고 싶을 때.' },
      ],
    },
    {
      id: 'what',
      ...
      title: '자체 제품이란 무엇인가',
      description:
        '여기서 말하는 자체 제품은 단순한 PB(자체 브랜드) 상품 설명이 아닙니다. 서비스 운영자가 참여 매장과 함께 필요성을 발견하고 제품을 기획하는 구조를 뜻합니다.',
      items: [
        { label: '함께 발견한 필요', detail: '운영자 혼자가 아니라 참여 매장 · 현장 의견에서 필요성이 드러납니다.' },
        { label: '기획된 제품', detail: '발견한 필요를 제품 컨셉 · 사양으로 구체화합니다.' },
        { label: '서비스 전용 상품', detail: '특정 서비스 · 네트워크에서만 유통되는 전용 상품으로 운영할 수 있습니다.' },
        { label: '공동 기획 상품', detail: '공급업체 · 참여 매장과 함께 기획해 만들 수도 있습니다.' },
      ],
    },
    {
      id: 'manufacture',
      step: '04',
      title: '운영자가 직접 제조해야 하는가',
      description:
        '가장 흔한 오해를 먼저 교정합니다. 자체 제품이라고 해서 운영자가 공장을 갖고 직접 제조 · 물류를 해야 하는 것은 아닙니다.',
      items: [
        { label: '제조는 필수가 아님', detail: '운영자가 반드시 생산 설비 · 제조를 직접 보유해야 하는 것은 아닙니다.' },
        { label: '운영자의 몫', detail: '운영자는 제품 기획 · 브랜드 · 운영을 담당할 수 있습니다.' },
        { label: '나머지는 협력', detail: '생산 · 공급 · 배송은 협력 공급업체가 맡을 수 있습니다.' },
      ],
    },
    {
      id: 'two-ways',
      ...
      title: '두 가지 운영 방식',
      description:
        '자체 제품은 두 가지 방식으로 운영할 수 있습니다. 어느 쪽도 강제되지 않으며, 운영자의 상황에 맞게 선택합니다.',
      items: [
        { label: '(A) 운영자가 공급자 역할 겸업', detail: '운영자가 생산 · 공급 · 배송까지 직접 수행합니다. 수직 통합형입니다.' },
        { label: '(B) 운영자는 기획 · 운영', detail: '운영자는 기획 · 브랜드 · 운영을 맡고, 협력 공급업체가 생산 · 공급 · 배송을 담당합니다.' },
        { label: '선택의 문제', detail: '둘 다 가능하며, 처음에는 (B)로 가볍게 시작해 점차 범위를 넓힐 수도 있습니다.' },
      ],
    },
    {
      id: 'semi-franchise',
      step: '06',
      title: '물류 없는 세미 프랜차이즈',
      description:
        '운영자가 기획 · 운영을 갖고 물류는 공급업체가 맡는 구조는, O4O 철학에서 말하는 물류 없는 세미 프랜차이즈 성격을 가집니다.',
      items: [
        { label: '운영자가 운영하는 것', detail: '제품 기획 · 브랜드 · 콘텐츠 · 매장 네트워크.' },
        { label: '공급업체가 맡는 것', detail: '생산 · 공급 · 배송 등 물류.' },
        { label: '가벼운 사업 구조', detail: '운영자는 물류 부담 없이 사업 정체성과 네트워크 운영에 집중할 수 있습니다.' },
      ],
    },
    {
      id: 'cooperation',
      ...
      title: '공급업체와 경쟁 관계인가',
      description:
        '자체 제품을 만든다고 해서 운영자와 공급업체가 경쟁하게 되는 것은 아닙니다. 오히려 협력 구조에 가깝습니다.',
      items: [
        { label: '역할 분업', detail: '운영자는 기획 · 네트워크, 공급업체는 생산 · 배송 — 가치사슬을 나눕니다.' },
        { label: '공급업체에게도 기회', detail: '공급업체 입장에서는 추가 주문 · 추가 거래가 생기는 기회입니다.' },
        { label: '유통질서 존중', detail: '공급자의 유통질서를 존중하는 전제 위에서 협력합니다.' },
      ],
    },
    {
      id: 'content',
      ...
      title: '콘텐츠와의 관계',
      description:
        '제품만으로는 사업이 운영되지 않습니다. 자체 제품이 매장과 소비자에게 닿으려면 콘텐츠가 함께 가야 합니다.',
      items: [
        { label: '설명 자료', detail: '제품을 이해시키는 상세 · 비교 · 안내 자료.' },
        { label: '매장 활용 자료', detail: '참여 매장이 진열 · 설명 · 응대에 바로 쓰는 실행 자산(POP · 사이니지 · 고객 안내문 등).' },
        { label: '교육 자료', detail: '매장 직원 · 운영자가 제품을 익히는 교육 콘텐츠.' },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        { label: '운영자 — 제품 기획', detail: '참여 매장 · 현장 의견을 바탕으로 제품을 기획합니다.' },
        { label: '공급업체 — 생산 · 공급', detail: '운영자의 기획을 받아 생산 · 공급 · 배송을 담당합니다.' },
        { label: '참여 매장 — 실행', detail: '받은 제품 · 콘텐츠를 내 매장에 적용하고 소비자에게 설명 · 판매합니다.' },
        { label: '소비자 — 구매', detail: '매장에서 제품 정보를 전달받아 이해하고 구매합니다.' },
      ],
    },
    {
      id: 'network',
      ...
      items: [
        { label: '정체성 형성', detail: '네트워크만의 전용 제품은 "우리 네트워크는 무엇을 하는 곳인가"를 또렷하게 만듭니다.' },
        { label: '참여 유인', detail: '차별화된 제품은 새로운 매장 · 공급자의 참여 동기가 됩니다.' },
        { label: '장기 차별화', detail: '시간이 지날수록 전용 제품 · 콘텐츠가 쌓여 모방하기 어려운 자산이 됩니다.' },
      ],
    },
    {
      id: 'start',
      ...
      items: [
        { label: '작게 시작', detail: '한 번에 큰 제품군을 만들 필요가 없습니다 — 하나의 필요에서 출발합니다.' },
        { label: '특정 분야 · 고객군', detail: '네트워크가 강점을 가진 분야 · 자주 만나는 고객군을 우선합니다.' },
        { label: '협력부터', detail: '직접 제조보다 협력 공급업체와의 (B) 방식으로 가볍게 검증해 볼 수 있습니다.' },
        { label: '콘텐츠와 함께', detail: '제품 기획과 동시에 설명 · 활용 자료를 준비하면 매장 적용이 빨라집니다.' },
      ],
    },
  ],
  bottomNav: {
    prev: { label: '← Business Guide', to: '/guide/business' },
    home: { label: '이용 안내로', to: '/guide' },
  },
};
...
// ─── /guide/business/operator-revenue (운영자 수익 구조 안내) ──
// WO-O4O-NETURE-BUSINESS-GUIDE-OPERATOR-REVENUE-V1
// 수익 구조 안내서 — "어떻게 수익을 만드는가". 수익 예측·성공사례·투자제안 아님.
// 현재 검증된 수익 구조(자체 제품·커미션)와 향후 가능한 수익 모델(광고·강좌·설문·패키지·구독)을 명확히 구분.

export const netureGuideBusinessOperatorRevenueProps: GuideFeatureManualPageProps = {
  hero: {
    eyebrow: '사업 운영 안내',
    title: '운영자 수익 구조 안내',
    description:
  ...
  index: {
    title: '운영자 수익 구조 한눈에 보기',
    lead: [
      '운영자는 사업 주체이며, 서비스를 지속하려면 수익 구조가 필요합니다.',
      '사업 모델 · 운영 도구 · 수익 구조는 서로 다릅니다 — 이 문서는 "수익 구조"를 다룹니다.',
      '현재 검증된 수익 구조와 향후 가능한 수익 모델을 구분해 표시합니다.',
    ],
    cards: [
      ...
      { title: '강좌와 설문', audience: '향후 가능', summary: '운영 활동 지원 구조 — 수익화는 준비 단계.', to: '#lms-survey' },
      { title: '운영 패키지와 구독', audience: '향후 가능', summary: '유료 운영 지원 · 네트워크 지원 — 준비 단계.', to: '#packages' },
      { title: '성장 단계', audience: '공통', summary: '콘텐츠/승인상품 → 오퍼/모집 → 자체제품/커미션/운영수익.', to: '#growth' },
      { title: '중요한 점', audience: '공통', summary: '하나만 고르는 것이 아니라 연결 과정에서 여러 수익 구조를 만든다.', to: '#key' },
    ],
  },
  sections: [
    {
      ...
      title: '이 문서의 대상',
      description:
        '이 문서는 서비스 운영자로서 사업 수익을 어떻게 만들지 고민하는 사람을 위한 안내서입니다. 이미 운영 중인 사람이든, 운영을 검토하는 사람이든 해당합니다.',
      items: [
        { label: '서비스 운영자', detail: '이미 매장 네트워크를 운영하며 수익 구조를 정비하려는 운영자.' },
        { label: '예비 운영자', detail: 'O4O 기반 서비스 운영을 검토하며 수익 가능성을 가늠하려는 사람.' },
        { label: '협동조합 · 전문 분야 네트워크', detail: '여러 매장이 함께 운영하거나 특정 분야에 강점을 가진 운영 그룹.' },
        { label: '공급자 기반 운영자', detail: '제품 · 공급망을 가진 채 매장 지원 서비스를 운영하려는 공급자.' },
      ],
    },
    {
      id: 'why',
      step: '02',
      title: '운영자는 왜 수익 구조가 필요한가',
      description:
        '운영자는 자료를 한 번 올리고 끝나는 역할이 아니라, 서비스를 지속적으로 운영하는 사업 주체입니다. 운영에는 비용이 들고, 그 비용을 감당하고 사업을 이어가려면 수익 구조가 필요합니다.',
      items: [
        { label: '서비스는 계속 운영된다', detail: '한 번의 작업이 아니라 지속적인 운영 활동이 필요합니다.' },
        { label: '콘텐츠 제작 비용', detail: '제품 설명 · 매장 자료 · 교육 콘텐츠를 만들고 갱신하는 데 자원이 듭니다.' },
        { label: '매장 지원 비용', detail: '매장 모집 · 안내 · 응대 등 지원 활동에 시간과 인력이 듭니다.' },
        { label: '운영자는 사업 주체', detail: '운영자는 봉사자가 아니라 수익 모델을 갖춘 사업 주체입니다.' },
      ],
    },
    {
      id: 'model-vs-revenue',
      step: '03',
      title: '사업 모델과 수익 구조는 다르다',
      description:
        '가장 먼저 구분해야 할 것은 "사업 모델"과 "수익 구조"입니다. 무엇을 하는 사업인가(모델)와 무엇으로 돈을 버는가(수익)는 다른 질문입니다.',
      items: [
        { label: '사업 모델 = 무엇을 하는가', detail: '약국 네트워크 · 공급자 네트워크 · 자체 제품 등 운영자가 하는 사업의 형태.' },
        { label: '수익 구조 = 무엇으로 버는가', detail: '실제 매출 · 커미션 · 광고 · 운영 서비스 등 수익이 발생하는 경로.' },
        { label: '둘은 연결되지만 같지 않다', detail: '같은 사업 모델이라도 수익 구조는 여러 가지일 수 있습니다.' },
      ],
    },
    {
      id: 'verified',
    ...
    },
    {
      id: 'tools',
      step: '05',
      title: '운영 도구와 수익 구조의 관계',
      description:
        '운영 도구는 사업을 운영하기 위한 수단이며, 그 자체가 수익 구조는 아닙니다. 도구는 수익이 발생하도록 돕는 역할을 합니다.',
      items: [
        { label: '운영 도구', detail: '운영자 승인 상품 · 이벤트 오퍼 · 판매자 모집 · 콘텐츠 · 유통참여형 펀딩.' },
        { label: '도구는 수익이 아니다', detail: '도구는 사업을 굴리는 수단이며, 수익은 그 위에서 자체 제품 판매 · 커미션 등으로 발생합니다.' },
        { label: '도구가 수익을 돕는다', detail: '예: 이벤트 오퍼 · 승인 상품은 거래를 만들고, 그 거래가 커미션 수익으로 이어질 수 있습니다.' },
      ],
    },
    {
      id: 'content',
      ...
      title: '콘텐츠는 왜 중요한가',
      description:
        '콘텐츠는 그 자체로 직접 수익이 되기보다, 수익이 발생하도록 돕는 자산입니다. 좋은 콘텐츠가 있으면 제품 판매와 매장 활용, 네트워크 성장이 쉬워집니다.',
      items: [
        { label: '제품 판매 지원', detail: '제품을 이해시키는 콘텐츠가 있으면 매장과 소비자의 구매가 쉬워집니다.' },
        { label: '매장 활용 지원', detail: '매장이 바로 쓰는 실행 자산(POP · 사이니지 · 안내문)이 활용도를 높입니다.' },
        { label: '네트워크 성장 지원', detail: '축적된 콘텐츠는 새 매장 · 공급자의 참여 동기가 됩니다.' },
      ],
    },
    {
      id: 'ads',
      step: '07',
      title: '광고와 스폰서십 (준비 단계)',
      description:
        '광고 · 스폰서십은 향후 가능한 수익 모델입니다. 일부 배치 기능은 존재하나, 광고비 · 정산으로 이어지는 수익 구조는 현재 준비 단계입니다.',
      items: [
        { label: '현재', detail: '커뮤니티 등에 일부 배치 기능이 있으나 광고 판매 · 정산 경로는 아직 제공되지 않습니다.' },
        { label: '향후 연계 가능', detail: 'Hero · 커뮤니티 · 디지털사이니지 · 강좌 등과 연계한 광고 · 스폰서십이 가능해질 수 있습니다.' },
        { label: '현재는 준비 단계', detail: '수익 구조로 안내하기에는 이른 단계임을 분명히 합니다.' },
      ],
    },
    {
      id: 'lms-survey',
      ...
      title: '강좌와 설문 (준비 단계)',
      description:
        '강좌 · 설문은 독립 사업이라기보다 운영자의 활동을 지원하는 구조입니다. 향후 수익화가 가능하지만 현재는 준비 단계입니다.',
      items: [
        { label: '강좌', detail: '교육 콘텐츠로 매장 · 운영을 지원하는 구조 — 유료 강좌 수익화는 준비 단계.' },
        { label: '설문', detail: '현장 의견 · 데이터 수집을 돕는 구조 — 수익화는 준비 단계.' },
        { label: '현재는 지원 구조', detail: '지금은 수익원이 아니라 운영을 돕는 활동으로 이해합니다.' },
      ],
    },
    {
      id: 'packages',
      step: '09',
      title: '운영 패키지와 구독 (준비 단계)',
      description:
        '향후에는 유료 운영 지원 · 네트워크 지원 · 전문 서비스를 패키지 · 구독 형태로 제공하는 수익 모델이 가능합니다. 현재는 준비 단계입니다.',
      items: [
        { label: '유료 운영 지원', detail: '매장 대상 유료 지원 서비스 — 향후 가능.' },
        { label: '네트워크 지원 · 전문 서비스', detail: '네트워크 운영 · 전문 영역 지원을 구독 형태로 제공 — 향후 가능.' },
        { label: '현재는 준비 단계', detail: '전용 결제 · 구독 기능은 아직 제공되지 않습니다.' },
      ],
    },
    {
      id: 'growth',
      ...
      title: '성장 단계',
      description:
        '수익 구조는 한 번에 완성되지 않습니다. 운영 단계가 진행되며 수익의 무게가 이동합니다.',
      items: [
        { label: '초기', detail: '콘텐츠 · 운영자 승인 상품으로 신뢰와 진열 기반을 만듭니다.' },
        { label: '성장', detail: '이벤트 오퍼 · 판매자 모집으로 거래와 매장을 늘립니다 — 커미션이 발생하기 시작합니다.' },
        { label: '확장', detail: '자체 제품 · 커미션 · 운영 수익으로 수익 모델을 고도화합니다.' },
      ],
    },
    {
      id: 'key',
      ...
      title: '중요한 점',
      description:
        '운영자는 광고 사업자 · 콘텐츠 사업자 · 제품 사업자 중 하나만 선택하는 것이 아닙니다. 참여 매장과 공급자를 연결하고, 그 과정에서 여러 수익 구조를 함께 만들 수 있습니다.',
      items: [
        { label: '하나만 고르지 않는다', detail: '여러 수익 구조를 상황에 맞게 조합할 수 있습니다.' },
        { label: '연결이 본질', detail: '운영자의 핵심은 매장과 공급자를 연결하는 것이며, 수익은 그 연결 위에서 발생합니다.' },
        { label: '검증된 것부터', detail: '먼저 검증된 자체 제품 · 커미션 구조로 시작하고, 향후 모델로 확장합니다.' },
      ],
    },
  ],
  bottomNav: {
...
export const netureGuideBusinessHubProps: GuideFeatureManualPageProps = {
  ...
  index: {
    ...
    cards: [
      ...
      { title: '자체 제품 · 서비스 전용 상품 운영 안내', audience: '사업 모델', summary: '운영자가 자체 제품으로 자신만의 사업을 만드는 방법 (물류 없는 세미 프랜차이즈).', to: '/guide/business/own-product' },
      ...
      { title: '운영자 수익 구조 안내', audience: '수익 구조', summary: '운영자가 무엇으로 수익을 만드는가 — 현재 가능/향후 가능 구분.', to: '/guide/business/operator-revenue' },
    ],
  },
  sections: [
    {
      ...
      description:
        '운영자가 실제로 어떤 사업을 운영할 수 있는지 설명합니다. 운영의 주체와 출신(매장 기반 · 공급자 기반)을 다루며, 운영자가 자체 제품으로 자신만의 사업을 만드는 방법까지 포함합니다.',
      items: [
        ...
        { label: '자체 제품 · 서비스 전용 상품 운영 안내', detail: '운영자가 자체 제품 · 서비스 전용 상품으로 자신만의 사업을 만드는 방법 (직접 제조 필수 아님 — 물류 없는 세미 프랜차이즈).' },
      ],
    },
    {
    ...
    {
      // 수익 구조 축. WO-O4O-NETURE-BUSINESS-GUIDE-OPERATOR-REVENUE-V1 로 안내서 연결.
      id: 'revenue',
      step: '03',
      title: '수익 구조 — 무엇으로 수익을 얻는가',
      description:
        '운영자가 수익을 만드는 구조를 설명합니다. 위 사업 모델과 운영 도구가 실제 수익으로 이어지는 경로이며, 현재 검증된 구조와 향후 가능한 구조를 운영자 수익 구조 안내에서 구분해 다룹니다.',
      items: [
...
export const netureGuideServiceGlycopharmProps: GuideFeatureManualPageProps = {
  hero: {
    ...
    primaryAction: { label: '상담하기 →', to: '/contact' },
    flowBarTitle: '서비스 흐름',
    flowLabels: ['서비스 개요', '접근 도메인', '참여 대상', 'O4O 활용', '주요 활용 영역', '무료혈당기 연계', '회원약국', '제품 · 콘텐츠 지원', 'CGM 연계'],
  },
  index: {
    title: '관련 안내',
    cards: [
  ...
  sections: [
    {
      step: '01',
      title: '서비스 개요',
      description: 'GlycoPharm은 O4O 기반 혈당관리약국 서비스로, 관련 상품과 건강정보 콘텐츠, 고객 안내 자료를 내 약국으로 연결합니다. 한국당뇨협회 무료혈당기 사업과 연계하여 약국이 혈당측정기 · 스트립 · CGM 관련 제품과 당뇨관리 콘텐츠 · 환자 상담을 함께 운영하도록 지원합니다. 고객 안내와 상담 보조에 활용하며, 진단 · 치료 · 복약 지시를 대신하지 않습니다.',
      items: [
        { label: 'O4O 혈당관리약국', detail: '관련 상품과 건강정보를 내 약국에서 안내합니다.' },
        { label: '한국당뇨협회 연계', detail: '무료혈당기 사업과 연계해 약국을 혈당관리 상담 거점으로 지원합니다.' },
    ...
    },
    {
      step: '06',
      title: '무료혈당기 사업 연계',
      description: '한국당뇨협회의 무료혈당기 사업은 의료기관에서 소비자에게 제공되는 무료혈당기 쿠폰을 바탕으로, 소비자가 서비스 참여 약국을 방문해 무료혈당기와 필요한 혈당측정 스트립을 구매하거나 상담받도록 연결하는 방식입니다. 참여 약국은 단순 판매처를 넘어, 당뇨 환자와 고위험군 소비자가 지속적으로 방문하는 혈당관리 상담 거점이 될 수 있습니다.',
      items: [
        { label: '의료기관 쿠폰 제공', detail: '의료기관이 소비자에게 무료혈당기 쿠폰을 전달합니다.' },
        { label: '참여 약국 방문', detail: '소비자가 참여 약국을 방문해 무료혈당기 · 스트립을 구매 · 상담합니다.' },
        { label: '상담 거점화', detail: '약국이 지속 방문이 일어나는 혈당관리 상담 접점이 됩니다.' },
      ],
    },
    {
      step: '07',
      title: '한국당뇨협회 회원약국',
      description: 'GlycoPharm 이용 약국은 한국당뇨협회 회원약국으로 참여할 수 있습니다. 당뇨 관련 전문성을 지역 소비자에게 알리고, 협회 CI와 안내 자료를 활용해 소비자 신뢰 이미지를 강화하며, 당뇨 관련 상담 기회를 확대할 수 있습니다.',
      items: [
        { label: '회원약국 참여', detail: '한국당뇨협회 회원약국으로 참여할 수 있습니다.' },
        { label: '전문성 홍보', detail: '당뇨 관련 전문성을 지역 소비자에게 안내합니다.' },
        { label: '협회 CI 활용', detail: '협회 CI · 안내 자료로 소비자 신뢰 이미지를 강화합니다.' },
        { label: '상담 기회 확대', detail: '당뇨 관련 상담 기회를 넓힐 수 있습니다.' },
      ],
    },
    {
      step: '08',
      title: '제품 · 콘텐츠 · 서비스 지원',
      description: '회원약국은 한국당뇨협회가 추천하거나 협력하는 업체의 제품과 서비스에 대한 다양한 지원을 활용할 수 있습니다. 당뇨 제품 판매부터 교육 콘텐츠, 협회 채널 협력까지 폭넓게 연결됩니다.',
      items: [
        { label: '당뇨 제품 활용', detail: '샘플판매 · 무재고 판매 · 약국 구비 판매를 활용할 수 있습니다.' },
        { label: '교육 콘텐츠 활용', detail: '동영상 · 간행물 · 카드뉴스 등 당뇨 교육 콘텐츠를 활용합니다.' },
        { label: '협회 채널 협력', detail: '회원 대상 커뮤니티 · 카페 · 카카오톡 채널과 협력할 수 있습니다.' },
        { label: '협력 업체 지원', detail: '협회 추천 업체의 제품 · 서비스 지원을 활용할 수 있습니다.' },
      ],
    },
    {
      step: '09',
      title: 'CGM 연계 확장',
      description: 'GlycoPharm은 한국당뇨협회 및 CGM(연속혈당측정기) 관련 업체와 협력하여 CGM 관련 앱과의 API 연동을 추진합니다. 이를 통해 약국은 당뇨 환자의 혈당관리 상담, CGM 관련 제품 안내, 관련 소모품 판매, 지속적인 환자관리 서비스로 확장할 수 있습니다. (연동은 추진 단계로, 확정된 기능이 아닙니다.)',
      items: [
        { label: 'CGM 업체 협력', detail: 'CGM 관련 업체와 협력 기반을 마련합니다.' },
        { label: '앱 API 연동 추진', detail: 'CGM 앱과의 API 연동을 추진합니다(연계 가능).' },
        { label: '환자관리 확장', detail: '당뇨 환자의 혈당관리 상담으로 확장할 수 있습니다.' },
        { label: '제품 · 소모품 안내', detail: 'CGM 관련 제품 안내와 소모품 판매 기회를 넓힙니다.' },
      ],
    },
  ],
  bottomNav: { prev: { label: '← 이용 안내', to: '/guide' }, home: { label: '홈으로', to: '/' } },
