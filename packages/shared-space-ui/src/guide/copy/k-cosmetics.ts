...
export const kCosmeticsGuideFeaturesProps: GuideFeaturesPageProps = {
  ...
  groups: [
    ...
    },
    {
      ...
      description: '상품 소개·사용법·매장 안내 글을 작성·발행하고 QR·POP·사이니지와 연결해 고객 안내에 활용합니다.',
      items: [
        { label: '매장 블로그 이용 방법', route: '/guide/features/blog' },
...
// ─── /guide/features/pop ───────────────────────────────────────────────
// WO-O4O-GP-KCOS-STORE-PRODUCTION-GUIDE-PORT-V1: KPA 구조 이식(K-Cosmetics 톤).
//   실제 StorePopPage 기준. 상품 소개·체험 안내 톤, commerce(주문·결제) 완료 표현 회피.

export const kCosmeticsGuideFeaturePopProps: GuideFeatureManualPageProps = {
  hero: {
    eyebrow: '기능별 이용 방법',
    title: 'POP 제작 이용 방법',
  ...
  index: {
    title: '함께 보면 좋은 가이드',
    cards: [
      { title: '매장 블로그 이용 방법', audience: '연결', summary: '상품 소개·안내 글을 QR·POP로 이어 활용합니다.', to: '/guide/features/blog' },
  ...
  sections: [
    {
      step: '01',
      title: 'POP 제작 개요',
      description: 'POP는 빈 화면이 아니라 내 자료함의 자료(상품 정보·성분·사용법·안내 콘텐츠)를 바탕으로 만듭니다. 만든 POP는 제작 자료에 저장되어 다시 출력할 수 있습니다.',
      items: [
        { label: '자료 기반 제작', detail: '내 자료함의 자료·콘텐츠를 골라 POP로 구성합니다.' },
        { label: 'AI 문구 보조', detail: '선택한 자료를 바탕으로 소개 문구 초안을 AI가 만들어 줍니다(선택).' },
    ...
    },
    {
      step: '03',
      title: '템플릿과 AI 문구',
      description: '템플릿 스타일에 맞춰 AI가 상품 소개 문구 초안을 만들어 줍니다. AI 문구를 만들지 않으면 자료의 제목·설명을 그대로 사용합니다. 상품 소개·사용법 안내 수준으로 작성합니다.',
      items: [
        { label: '템플릿 적용', detail: '고른 템플릿 스타일이 POP 레이아웃에 적용됩니다.' },
        { label: 'AI 문구 생성(선택)', detail: '초안을 만든 뒤 내용을 확인·수정해 사용합니다.' },
        { label: '소개 톤 유지', detail: '상품 소개·체험 안내 수준으로 작성합니다.' },
      ],
    },
    {
      step: '04',
    ...
    },
    {
      ...
      description: 'POP PDF를 생성하면 새 탭에서 열리고 제작 자료에 저장됩니다. 인쇄해 진열대·체험대·계산대 안내물로 활용합니다.',
      items: [
        { label: 'PDF 출력', detail: '인쇄용 PDF를 만듭니다.' },
        { label: '제작 자료 저장', detail: '결과는 제작 자료에 저장되어 다시 출력할 수 있습니다.' },
        { label: '안내 중심', detail: 'POP는 상품 소개·안내물입니다. 주문·결제 기능과는 별개입니다.' },
      ],
    },
  ],
  bottomNav: {
...
export const kCosmeticsGuideFeatureBlogProps: GuideFeatureManualPageProps = {
  hero: {
    eyebrow: '기능별 이용 방법',
    title: '매장 블로그 이용 방법',
    description: '상품 소개·사용법·매장 안내 글을 작성해 발행하고, QR·POP·사이니지와 연결해 고객·관광객 안내에 활용합니다',
  ...
  sections: [
    ...
    },
    {
      ...
      title: '글 작성',
      routeLabel: '/store/content/blog',
      description: '제목과 본문을 작성합니다. 본문은 서식·이미지를 넣을 수 있는 편집기로 작성하며, 슬러그(URL)와 요약은 선택 입력입니다. 상품 소개·사용법·매장 안내 글로 작성합니다.',
      items: [
...
export const kCosmeticsGuideFeatureProductionMaterialsProps: GuideFeatureManualPageProps = {
  hero: {
    eyebrow: '기능별 이용 방법',
  ...
  index: {
    ...
    cards: [
      ...
      { title: '매장 블로그 이용 방법', audience: '제작', summary: '상품 소개·안내 글을 작성합니다.', to: '/guide/features/blog' },
...
// 기존 services/web-k-cosmetics/src/pages/ServiceGuidePage.tsx 의 데이터를 그대로 옮긴 것이다.

export const kCosmeticsServiceIntroProps: GuideServiceIntroPageProps = {
  headline: '화장품 매장 운영을 위한 O4O 서비스 안내',
  lead:
  ...
  audiences: {
    title: '이용 대상',
    description: '매장 운영과 관련된 다양한 참여자가 K-Cosmetics를 활용할 수 있습니다.',
    cards: [
      {
        icon: Building2,
        title: '화장품 매장 경영자',
  ...
  features: {
    title: '주요 기능',
    description: '매장 운영과 콘텐츠 활용을 위한 핵심 기능을 제공합니다.',
    cards: [
      {
        icon: Building2,
        title: '매장 운영 지원',
      ...
      { icon: Store, title: '내 매장', desc: '매장별 운영 정보와 활용 자료를 관리합니다.' },
      {
        icon: FileText,
        title: '콘텐츠 활용',
  ...
  steps: {
    title: '이용 흐름',
    description: '회원가입부터 매장 현장 활용까지의 기본 흐름입니다.',
    items: [
