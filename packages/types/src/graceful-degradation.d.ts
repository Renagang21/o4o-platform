...
export type DegradationType = 'disable_feature' | 'reduce_functionality' | 'cache_fallback' | 'static_content' | 'simplified_ui' | 'rate_limit' | 'request_queuing' | 'redirect_traffic';
...
export type DegradationParameters = DisableFeatureParams | ReduceFunctionalityParams | CacheFallbackParams | StaticContentParams | SimplifiedUIParams | RateLimitParams | RequestQueuingParams | RedirectTrafficParams;
