...
export type WidgetType = 'text' | 'html' | 'image' | 'menu' | 'recent-posts' | 'categories' | 'tags' | 'archives' | 'search' | 'social-links' | 'contact-info' | 'newsletter' | 'custom-code' | 'rss-feed' | 'calendar';
export type WidgetPosition = 'footer-1' | 'footer-2' | 'footer-3' | 'footer-4' | 'sidebar-main' | 'sidebar-shop' | 'header-top' | 'header-bottom';
...
export type SocialPlatform = 'facebook' | 'twitter' | 'instagram' | 'youtube' | 'linkedin' | 'tiktok' | 'pinterest' | 'github' | 'discord' | 'telegram' | 'whatsapp' | 'email' | 'phone';
...
export type WidgetCategory = 'content' | 'navigation' | 'social' | 'forms' | 'media' | 'advanced';
