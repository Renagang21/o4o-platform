...
export type TemplateBlockType = 'hero' | 'heading' | 'paragraph' | 'image' | 'video' | 'button' | 'columns' | 'spacer' | 'card' | 'list' | 'quote' | 'code' | 'divider' | 'carousel' | 'gallery' | 'contact-form' | 'social-media' | 'newsletter' | 'pricing-table' | 'testimonial' | 'faq' | 'map' | 'countdown' | 'progress-bar';
...
export type TemplateType = 'page' | 'post' | 'category' | 'archive' | 'search' | '404' | 'email' | 'popup';
export type TemplateCategory = 'landing-page' | 'homepage' | 'about' | 'contact' | 'portfolio' | 'blog' | 'ecommerce' | 'business' | 'personal' | 'creative' | 'education' | 'nonprofit';
...
export type BlockCategory = 'basic' | 'media' | 'layout' | 'interactive' | 'ecommerce' | 'social' | 'forms' | 'advanced';
