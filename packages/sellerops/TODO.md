...
- [x] SellerOpsService (seller dashboard, profile, suppliers, listings, orders, settlement)

### Controllers

- [x] SellerOpsController

### DTOs

- [x] SellerOpsDashboardDto
- [x] SellerOpsProfileDto
