# Membership-Yaksa – Development TODO
...
- [x] YaksaMember
- [x] YaksaMemberCategory
- [x] YaksaMemberAffiliation
- [x] YaksaMembershipRole
- [x] YaksaMembershipYear
- [x] YaksaMemberVerification

### Services

- [x] MembershipYaksaService
- [x] VerificationService

### Controllers

- [x] MembershipController
...
- organization-core 확장 앱
- 약사회 회원 관리 및 자격 검증 기능
