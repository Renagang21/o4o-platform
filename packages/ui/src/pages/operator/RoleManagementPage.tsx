/**
 * Role Management Page — 역할 카탈로그 관리 (공통 컴포넌트)
 ...
 *
 * 사용법:
 *   <RoleManagementPage apiClient={api} isAdmin={isAdmin} />
 */
...
export interface RoleManagementPageProps {
  apiClient: {
    request: (config: { method: string; url: string; data?: unknown }) => Promise<{ data: unknown }>;
  };
  isAdmin: boolean;
  toast: {
