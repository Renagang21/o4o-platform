...
export interface StoreMarketingAnalyticsData {
  ...
  topQrCodes: Array<{ id: string; title: string; slug: string; scanCount: number }>;
...
export function StoreMarketingAnalyticsView({
  fetchAnalytics,
  primaryColor = '#0ea5e9',
    ...
    <div style={styles.container}>
      ...
      <div style={styles.header}>
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' }}>
            <Link to={backTo} style={{ color: c.neutral400, fontSize: '13px', textDecoration: 'none' }}>
              {breadcrumbRootLabel}
            </Link>
      ...
      <div style={styles.kpiGrid}>
        <div style={styles.kpiCard}>
          <TrendingUp size={20} style={{ color: primaryColor, marginBottom: '8px' }} />
