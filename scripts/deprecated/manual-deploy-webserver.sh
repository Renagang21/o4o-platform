...
# 웹서버는 빌드하면 안 됩니다!
# 대신 사용: ./scripts/webserver-receive-deployment.sh
# ============================================

set -e  # 에러 발생 시 중단

echo "⛔ 경고: 이 스크립트는 더 이상 사용하지 않습니다!"
echo "================================================"
echo "웹서버에서는 빌드하면 안 됩니다!"
echo ""
echo "올바른 방법:"
echo "1. GitHub Actions가 자동 빌드 & 배포 (권장)"
echo "2. 수동: ./scripts/webserver-receive-deployment.sh"
echo ""
echo "자세한 내용: WEBSERVER_DEPLOYMENT_GUIDE.md 참조"
exit 1
