import { AppDataSource } from '../apps/api-server/src/database/connection';
import { MediaFile } from '../apps/api-server/src/entities/MediaFile';
import { Post } from '../apps/api-server/src/entities/Post';
import { User } from '../apps/api-server/src/entities/User';
...
const MEDIA_FILES: MediaFileData[] = [
