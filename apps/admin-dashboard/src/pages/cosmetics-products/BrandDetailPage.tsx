  ...
  const fetchBrand = useCallback(async () => {
    ...
    try {
      ...
      setBrand({
        ...
        bannerUrl: 'https://via.placeholder.com/1200x300/dcfce7/16a34a?text=Nature+Republic',
        country: '대한민국',
        ...
        products: [
          {
            ...
            category: '세럼',
            price: 45000,
            imageUrl: 'https://via.placeholder.com/200x200/e0f2fe/0891b2?text=Serum',
            rating: 4.8,
            isBestSeller: true,
          },
          {
          ...
          },
          {
            ...
            category: '젤',
            price: 12000,
            imageUrl: 'https://via.placeholder.com/200x200/d1fae5/059669?text=Aloe',
            rating: 4.9,
            isBestSeller: true,
          },
          {
            ...
            category: '클렌저',
            price: 18000,
            imageUrl: 'https://via.placeholder.com/200x200/fef3c7/d97706?text=Oil',
            rating: 4.4,
            isBestSeller: false,
          },
        ],
