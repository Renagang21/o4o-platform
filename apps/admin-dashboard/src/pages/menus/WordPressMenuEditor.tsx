                  ...
                  {isEditing ? (
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        {item.target_audience && !item.target_audience.roles?.includes('everyone') && (
                          <span className="px-1.5 py-0.5 text-xs bg-yellow-100 text-yellow-800 rounded-md" title={`Restricted to: ${item.target_audience.roles?.join(', ')}`}>
                            Role Limited
                          </span>
                        )}
                        {item.display_mode === 'hide' && (
                          <span className="px-1.5 py-0.5 text-xs bg-red-100 text-red-800 rounded-md">Hidden</span>
                        )}
                      </div>
                      {item.url && (
        ...
        <div className="flex gap-6">
          ...
          <div className="w-96">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200">
              ...
              {/* Only show Categories and Tags tabs when Posts tab is active */}
