...
import {
  X, Star, Trash2, Upload, Link2, ImageIcon, ChevronDown, GripVertical,
} from 'lucide-react';
import {
  getMasterImages,
  importImageFromUrl,
...
import type { ProductImageItem } from '../../api/store-products.api';
...
export default function ImageManagerModal({ masterId, productName, onClose }: Props) {
