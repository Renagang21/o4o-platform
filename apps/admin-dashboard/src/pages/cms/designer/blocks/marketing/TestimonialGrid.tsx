/**
 * Marketing Block - TestimonialGrid
 *
 * Grid layout for displaying multiple testimonials
 */
...
export default function TestimonialGrid({
  ...
  return (
    <div className="py-12 px-4" style={{ backgroundColor: bgColor }}>
      ...
      {/* Grid */}
      <div className={`grid ${columnClasses[columns]} ${gapClasses[gap]} max-w-6xl mx-auto`}>
        {children || (
