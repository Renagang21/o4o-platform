            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                <Input
                  ...
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleChange('targetParticipantCount', parseInt(e.target.value) || 0)}
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <Input
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleChange('forumLink', e.target.value)}
