/**
 * SellerOps — 리스팅 등록: 상품 검색 페이지
 *
 * WO-O4O-PRODUCT-INPUT-ASSIST-V1
 *
 * 매장 운영자가 제품을 추가할 때 ProductMaster를 검색하여 선택하면
 * 리스팅 등록 폼으로 이동하며 자동 채움이 적용된다.
 */
...
const ProductSearchPage: React.FC = () => {
  ...
  const handleCreateNew = () => {
    navigate('/sellerops/listings/create');
  };
  ...
  return (
    <div className="p-6 max-w-2xl mx-auto">
      <PageHeader
        title="제품 추가"
        subtitle="등록할 제품을 검색하거나 직접 입력하세요"
        actions={[
          {
            id: 'back',
            label: '목록으로',
