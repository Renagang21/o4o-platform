/**
 * Phase PD-5: Seller Settlements Page
 *
 * Allows sellers to view their settlement history and preview upcoming settlements
 */
...
export default function SellerSettlements() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-3xl font-bold text-gray-900">내 정산 내역</h1>
        <p className="mt-2 text-gray-600">
          판매 정산 내역을 확인하고 예상 정산 금액을 조회하세요
        </p>
      </div>
          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div>
                ...
                <div className="text-2xl font-bold text-red-600">-{formatCurrency(preview.totalCommissionAmount)}</div>
              </div>
              <div>
