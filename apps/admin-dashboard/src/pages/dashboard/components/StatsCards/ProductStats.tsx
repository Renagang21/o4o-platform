...
import { Package, AlertTriangle, Plus, Award, ArrowUpRight, ArrowDownRight, ShoppingBag } from 'lucide-react';
...
const ProductStats: React.FC<ProductStatsProps> = ({ data, isLoading = false }) => {
  if (isLoading) {
    return (
