 ...
 * 3. FormRenderer component
 * 4. TemplateRenderer component
 * 5. Real data vs mock data toggle
...
export default function PresetIntegrationTest() {
  ...
  return (
    <div className="max-w-7xl mx-auto p-6">
      ...
      {/* Test 3: FormRenderer */}
      <section className="mb-8 border border-gray-200 rounded-lg p-6 bg-white">
        <h2 className="text-xl font-semibold mb-4">Test 3: FormRenderer Component</h2>
        <FormPresetTest />
      </section>

      {/* Test 4: TemplateRenderer */}
      <section className="mb-8 border border-gray-200 rounded-lg p-6 bg-white">
        <h2 className="text-xl font-semibold mb-4">Test 4: TemplateRenderer Component</h2>
        <TemplatePresetTest />
      </section>

      {/* Test 5: usePresets Hook */}
      <section className="mb-8 border border-gray-200 rounded-lg p-6 bg-white">
        <h2 className="text-xl font-semibold mb-4">Test 5: usePresets Hook (List)</h2>
        <PresetsListTest />
      </section>
      ...
      <section className="border border-blue-200 rounded-lg p-6 bg-blue-50">
        ...
        <ol className="list-decimal list-inside space-y-2 text-blue-800">
          ...
          <li>Verify preset list loads correctly in Test 5</li>
