...
import ViewPresetModal from '@/components/presets/ViewPresetModal';
...
const ViewPresets: React.FC = () => {
  ...
  const handleToggleActive = async (preset: ViewPreset) => {
    try {
      await viewPresetsApi.update(preset.id, { isActive: !preset.isActive });
