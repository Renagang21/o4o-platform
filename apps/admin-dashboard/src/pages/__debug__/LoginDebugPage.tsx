...
// 실제 Admin 로그인 페이지의 테스트 계정 (Login.tsx 참조)
const TEST_ACCOUNTS = [
  { label: 'Super Admin', email: 'admin@neture.co.kr', password: 'Admin2024!', description: '슈퍼 관리자' },
  { label: 'Manager', email: 'manager@neture.co.kr', password: 'Manager2024!', description: '일반 관리자' },
];
