...
interface CPTScreenOptionsProps {
  show: boolean;
...
export const CPTScreenOptions: React.FC<CPTScreenOptionsProps> = ({
  show,
  setShow,
  visibleColumns,
  onColumnToggle,
    ...
    <div className="relative">
      ...
      {show && (
        <div className="absolute right-0 top-full mt-2 w-72 bg-white border border-gray-300 rounded-md shadow-lg z-50">
          <div className="p-4">
            <h3 className="font-medium text-sm mb-3">열 표시</h3>
            ...
            <div className="border-t border-gray-200 mt-3 pt-3">
              <h3 className="font-medium text-sm mb-3">페이징</h3>
