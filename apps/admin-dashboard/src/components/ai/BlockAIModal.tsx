...
import { BLOCK_ACTION_PROMPTS } from '@o4o/ai-prompts/admin';
...
const AI_ACTIONS: AIAction[] = [
  {
    ...
    prompt: BLOCK_ACTION_PROMPTS['refine'],
  },
  {
    type: 'improve',
    label: '상세하게',
    ...
    prompt: BLOCK_ACTION_PROMPTS['improve'],
  },
  {
    type: 'translate-ko',
    label: '한국어로',
    ...
    prompt: BLOCK_ACTION_PROMPTS['translate-ko'],
  },
  {
    type: 'translate-en',
    label: 'English',
    ...
    prompt: BLOCK_ACTION_PROMPTS['translate-en'],
  },
  {
    type: 'cta',
    label: 'CTA 강화',
    ...
    prompt: BLOCK_ACTION_PROMPTS['cta'],
  },
  {
    type: 'seo',
    label: 'SEO 최적화',
    ...
    prompt: BLOCK_ACTION_PROMPTS['seo'],
  },
];
