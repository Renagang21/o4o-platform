...
import { User, UserFilters, UserBulkAction, UserFormData, UserStats, UserActivity } from '@/types/user'
...
export class UserApi {
  ...
  static async getUserActivity(userId: string): Promise<ApiResponse<UserActivity[]>> {
