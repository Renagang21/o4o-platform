...
export type CustomFieldType = 'text' | 'textarea' | 'number' | 'email' | 'url' | 'tel' | 'password' | 'date' | 'datetime' | 'time' | 'color' | 'range' | 'select' | 'radio' | 'checkbox' | 'toggle' | 'image' | 'gallery' | 'file' | 'wysiwyg' | 'code' | 'location' | 'repeater' | 'group' | 'tab';
