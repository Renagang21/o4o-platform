...
import {
  camelCase,
  paramCase
} from "./chunk-UPO4W7C2.js";
import {
  require_client
} from "./chunk-R3AENI7Z.js";
import {
  isPlainObject
} from "./chunk-5OYGJFT4.js";
import {
  require_react_dom
...
// ../../node_modules/@wordpress/blocks/node_modules/@wordpress/data/build-module/redux-store/index.js
var import_equivalent_key_map2 = __toESM(require_equivalent_key_map());

// ../../node_modules/@wordpress/blocks/node_modules/@wordpress/redux-routine/build-module/is-generator.js
function isGenerator(object) {
  return !!object && typeof object[Symbol.iterator] === "function" && typeof object.next === "function";
}

// ../../node_modules/@wordpress/blocks/node_modules/@wordpress/redux-routine/build-module/runtime.js
var import_rungen = __toESM(require_dist());

// ../../node_modules/@wordpress/blocks/node_modules/@wordpress/redux-routine/build-module/is-action.js
...
function createRuntime(controls2 = {}, dispatch2) {
  const rungenControls = Object.entries(controls2).map(([actionType, control]) => (value, next2, iterate, yieldNext, yieldError) => {
...
// ../../node_modules/@wordpress/blocks/node_modules/@wordpress/redux-routine/build-module/index.js
...
// ../../node_modules/@wordpress/blocks/node_modules/@wordpress/data/build-module/redux-store/combine-reducers.js
...
// ../../node_modules/@wordpress/blocks/node_modules/@wordpress/data/build-module/factory.js
function createRegistryControl(registryControl) {
  registryControl.isRegistryControl = true;
  return registryControl;
}

// ../../node_modules/@wordpress/blocks/node_modules/@wordpress/data/build-module/controls.js
...
// ../../node_modules/@wordpress/blocks/node_modules/@wordpress/data/build-module/lock-unlock.js
var {
  lock,
  unlock
...
// ../../node_modules/@wordpress/blocks/node_modules/@wordpress/data/build-module/promise-middleware.js
...
// ../../node_modules/@wordpress/blocks/node_modules/@wordpress/data/build-module/resolvers-cache-middleware.js
var createResolversCacheMiddleware = (registry, storeName) => () => (next2) => (action) => {
...
// ../../node_modules/@wordpress/blocks/node_modules/@wordpress/data/build-module/redux-store/thunk-middleware.js
...
// ../../node_modules/@wordpress/blocks/node_modules/@wordpress/data/build-module/redux-store/metadata/reducer.js
var import_equivalent_key_map = __toESM(require_equivalent_key_map());

// ../../node_modules/@wordpress/blocks/node_modules/@wordpress/data/build-module/redux-store/metadata/utils.js
...
// ../../node_modules/@wordpress/blocks/node_modules/@wordpress/data/build-module/redux-store/metadata/selectors.js
...
// ../../node_modules/@wordpress/blocks/node_modules/@wordpress/data/build-module/redux-store/metadata/actions.js
var actions_exports = {};
...
function createBindingCache(getItem, bindItem) {
  ...
  return {
    get(itemName) {
      ...
      let boundItem = cache2.get(item);
      if (!boundItem) {
        boundItem = bindItem(item, itemName);
        cache2.set(item, boundItem);
      }
      return boundItem;
    }
  };
...
function createReduxStore(key, options) {
  ...
  const storeDescriptor = {
    ...
    instantiate: (registry) => {
      ...
      lock(store2, privateRegistrationFunctions);
      ...
      const subscribe3 = store2 && ((listener) => {
...
// ../../node_modules/@wordpress/blocks/node_modules/@wordpress/data/build-module/store/index.js
var coreDataStore = {
  name: "core/data",
  instantiate(registry) {
...
// ../../node_modules/@wordpress/blocks/node_modules/@wordpress/data/build-module/utils/emitter.js
...
// ../../node_modules/@wordpress/blocks/node_modules/@wordpress/data/build-module/registry.js
...
function createRegistry(storeConfigs = {}, parent = null) {
  ...
  const subscribe3 = (listener, storeNameOrDescriptor) => {
  ...
  function registerStoreInstance(name, createStore2) {
    ...
    if (parent) {
      try {
        unlock(store2.store).registerPrivateActions(unlock(parent).privateActionsOf(name));
        unlock(store2.store).registerPrivateSelectors(unlock(parent).privateSelectorsOf(name));
      } catch (e) {
      }
    }
    return store2;
...
// ../../node_modules/@wordpress/blocks/node_modules/@wordpress/data/build-module/default-registry.js
var default_registry_default = createRegistry();

// ../../node_modules/@wordpress/blocks/node_modules/@wordpress/data/build-module/plugins/persistence/index.js
var import_deepmerge = __toESM(require_cjs());

// ../../node_modules/@wordpress/blocks/node_modules/@wordpress/data/build-module/plugins/persistence/storage/object.js
var objectStorage;
var storage = {
  getItem(key) {
...
// ../../node_modules/@wordpress/blocks/node_modules/@wordpress/data/build-module/plugins/persistence/storage/default.js
var storage2;
try {
...
// ../../node_modules/@wordpress/blocks/node_modules/@wordpress/data/build-module/components/registry-provider/context.js
...
// ../../node_modules/@wordpress/blocks/node_modules/@wordpress/data/build-module/components/async-mode-provider/context.js
...
// ../../node_modules/@wordpress/blocks/node_modules/@wordpress/data/build-module/components/use-select/index.js
var renderQueue = createQueue();

// ../../node_modules/@wordpress/blocks/node_modules/@wordpress/data/build-module/components/with-select/index.js
var import_jsx_runtime = __toESM(require_jsx_runtime());

// ../../node_modules/@wordpress/blocks/node_modules/@wordpress/data/build-module/components/with-dispatch/index.js
var import_jsx_runtime2 = __toESM(require_jsx_runtime());

// ../../node_modules/@wordpress/blocks/node_modules/@wordpress/data/build-module/components/with-registry/index.js
...
// ../../node_modules/@wordpress/blocks/node_modules/@wordpress/data/build-module/dispatch.js
function dispatch(storeNameOrDescriptor) {
  return default_registry_default.dispatch(storeNameOrDescriptor);
}

// ../../node_modules/@wordpress/blocks/node_modules/@wordpress/data/build-module/select.js
function select(storeNameOrDescriptor) {
  return default_registry_default.select(storeNameOrDescriptor);
}

// ../../node_modules/@wordpress/blocks/node_modules/@wordpress/data/build-module/index.js
...
var registerBlockBindingsSource = (source) => {
  ...
  const existingSource = unlock2(select(store)).getBlockBindingsSource(name);
  ...
  return unlock2(dispatch(store)).addBlockBindingsSource(source);
};
function unregisterBlockBindingsSource(name) {
  ...
  unlock2(dispatch(store)).removeBlockBindingsSource(name);
}
function getBlockBindingsSource(name) {
  return unlock2(select(store)).getBlockBindingsSource(name);
}
function getBlockBindingsSources() {
  return unlock2(select(store)).getAllBlockBindingsSources();
}
...
function getInnerBlocksProps(props = {}) {
  ...
  const children = (0, import_jsx_runtime4.jsx)(RawHTML, {
    children: html2
  });
  return {
    ...props,
...
function isEquivalentTextTokens(actual, expected, logger = createLogger()) {
  ...
  for (let i = 0; i < TEXT_NORMALIZATIONS.length; i++) {
    const normalize2 = TEXT_NORMALIZATIONS[i];
...
*/
//# sourceMappingURL=chunk-SAUJ7TVV.js.map
