...
var Checkbox = import_react.default.forwardRef(({ className, ...props }, ref) => (0, import_jsx_runtime.jsx)("input", { type: "checkbox", ref, className: cn("h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500", className), ...props }));
Checkbox.displayName = "Checkbox";
var RadioGroup = import_react.default.forwardRef(({ className, ...props }, ref) => (0, import_jsx_runtime.jsx)("div", { ref, className: cn("space-y-2", className), ...props }));
RadioGroup.displayName = "RadioGroup";
var RadioGroupItem = import_react.default.forwardRef(({ className, ...props }, ref) => (0, import_jsx_runtime.jsx)("input", { type: "radio", ref, className: cn("h-4 w-4 border-gray-300 text-blue-600 focus:ring-blue-500", className), ...props }));
RadioGroupItem.displayName = "RadioGroupItem";
var Slider = import_react.default.forwardRef(({ className, ...props }, ref) => (0, import_jsx_runtime.jsx)("input", { type: "range", ref, className: cn("w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer", className), ...props }));
Slider.displayName = "Slider";
var Dialog = ({ children, open, className, ...props }) => {
  if (!open)
    return null;
  return (0, import_jsx_runtime.jsx)("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50", children: (0, import_jsx_runtime.jsx)("div", { className: cn("bg-white rounded-lg shadow-lg", className), ...props, children }) });
};
var DialogContent = import_react.default.forwardRef(({ className, ...props }, ref) => (0, import_jsx_runtime.jsx)("div", { ref, className: cn("p-6", className), ...props }));
DialogContent.displayName = "DialogContent";
var DialogHeader = import_react.default.forwardRef(({ className, ...props }, ref) => (0, import_jsx_runtime.jsx)("div", { ref, className: cn("mb-4", className), ...props }));
DialogHeader.displayName = "DialogHeader";
var DialogTitle = import_react.default.forwardRef(({ className, ...props }, ref) => (0, import_jsx_runtime.jsx)("h2", { ref, className: cn("text-lg font-semibold", className), ...props }));
DialogTitle.displayName = "DialogTitle";
var SelectContent = import_react.default.forwardRef(({ className, children, ...props }, ref) => (0, import_jsx_runtime.jsx)("div", { ref, className: cn("bg-white border rounded-md shadow-lg", className), ...props, children }));
SelectContent.displayName = "SelectContent";
var SelectItem = import_react.default.forwardRef(({ className, ...props }, ref) => (0, import_jsx_runtime.jsx)("div", { ref, className: cn("px-3 py-2 hover:bg-gray-100 cursor-pointer", className), ...props }));
SelectItem.displayName = "SelectItem";
var SelectTrigger = import_react.default.forwardRef(({ className, ...props }, ref) => (0, import_jsx_runtime.jsx)("button", { ref, className: cn("flex h-10 w-full items-center justify-between rounded-md border border-input bg-background px-3 py-2 text-sm", className), ...props }));
SelectTrigger.displayName = "SelectTrigger";
var SelectValue = import_react.default.forwardRef(({ className, ...props }, ref) => (0, import_jsx_runtime.jsx)("span", { ref, className: cn(className), ...props }));
SelectValue.displayName = "SelectValue";
var ToggleGroup = import_react.default.forwardRef(({ className, type, value, onValueChange, ...props }, ref) => (0, import_jsx_runtime.jsx)("div", { ref, className: cn("flex space-x-1", className), ...props }));
ToggleGroup.displayName = "ToggleGroup";
var ToggleGroupItem = import_react.default.forwardRef(({ className, ...props }, ref) => (0, import_jsx_runtime.jsx)("button", { ref, className: cn("px-3 py-2 text-sm border rounded-md hover:bg-gray-100", className), ...props }));
ToggleGroupItem.displayName = "ToggleGroupItem";
var DropdownMenu = ({ children, ...props }) => (0, import_jsx_runtime.jsx)("div", { className: "relative inline-block", ...props, children });
var DropdownMenuTrigger = import_react.default.forwardRef(({ className, asChild, ...props }, ref) => (0, import_jsx_runtime.jsx)("button", { ref, className: cn(className), ...props }));
DropdownMenuTrigger.displayName = "DropdownMenuTrigger";
var DropdownMenuContent = import_react.default.forwardRef(({ className, align, ...props }, ref) => (0, import_jsx_runtime.jsx)("div", { ref, className: cn("absolute mt-2 w-48 bg-white border rounded-md shadow-lg z-50", align === "end" ? "right-0" : align === "start" ? "left-0" : "left-1/2 -translate-x-1/2", className), ...props }));
DropdownMenuContent.displayName = "DropdownMenuContent";
var DropdownMenuItem = import_react.default.forwardRef(({ className, ...props }, ref) => (0, import_jsx_runtime.jsx)("div", { ref, className: cn("px-4 py-2 text-sm hover:bg-gray-100 cursor-pointer", className), ...props }));
DropdownMenuItem.displayName = "DropdownMenuItem";
var Progress = import_react.default.forwardRef(({ className, value = 0, max = 100, ...props }, ref) => (0, import_jsx_runtime.jsx)("div", { ref, className: cn("w-full bg-gray-200 rounded-full h-2", className), ...props, children: (0, import_jsx_runtime.jsx)("div", { className: "bg-blue-600 h-2 rounded-full transition-all", style: { width: `${Math.min(value / max * 100, 100)}%` } }) }));
