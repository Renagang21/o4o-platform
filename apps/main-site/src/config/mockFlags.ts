...
export const MOCK_FLAGS = {
  ...
  // Partner (Phase 6-2)
  PARTNER_LINKS: shouldUseMock('VITE_USE_MOCK_PARTNER_LINKS'),
  PARTNER_ANALYTICS: shouldUseMock('VITE_USE_MOCK_PARTNER_ANALYTICS'),

  // Settlements (Phase 6-2)
  PARTNER_SETTLEMENTS: shouldUseMock('VITE_USE_MOCK_PARTNER_SETTLEMENTS'),
  SUPPLIER_SETTLEMENTS: shouldUseMock('VITE_USE_MOCK_SUPPLIER_SETTLEMENTS'),
  SELLER_SETTLEMENTS: shouldUseMock('VITE_USE_MOCK_SELLER_SETTLEMENTS'),
  ADMIN_SETTLEMENTS: shouldUseMock('VITE_USE_MOCK_ADMIN_SETTLEMENTS'),
} as const;
