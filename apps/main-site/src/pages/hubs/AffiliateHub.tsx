      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {sortedCards.map((card) => (
          ...
          >
            {/* 배지 */}
            {card.badge && (
              <span className="inline-block px-2 py-1 text-xs font-semibold text-white bg-pink-500 rounded mb-3">
                {card.badge}
              </span>
            )}
