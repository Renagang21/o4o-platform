...
export const DropshippingErrorBoundary: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <ModuleErrorBoundary moduleName="드랍쉬핑" fallbackUrl="/">
    {children}
  </ModuleErrorBoundary>
);
