...
const ReferralLinkBox: FC = () => {
  ...
  const shareLinks = {
    email: `mailto:?subject=O4O 파트너 프로그램 참여하기&body=파트너 프로그램에 참여하세요: ${referralLink}`,
    ...
    twitter: `https://twitter.com/intent/tweet?url=${encodeURIComponent(referralLink)}&text=O4O 파트너 프로그램에 참여하세요!`
  };
