...
import { createInfluencerRoutine } from '../../services/api';

export default function PartnerRoutineCreatePage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // Navigate to partner routines page
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">새 루틴 만들기</h1>
        <p className="text-gray-600">나만의 화장품 루틴을 만들어 고객들에게 추천하세요</p>
      </div>
