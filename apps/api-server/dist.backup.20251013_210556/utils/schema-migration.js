...
exports.getDefaultSettingsV1 = exports.validateMigration = exports.migrateCustomizerSettings = exports.migrateFromLegacy = exports.detectVersion = exports.mapLegacyColor = void 0;
// ============================================
// Version Constants
// ============================================
...
exports.mapLegacyColor = mapLegacyColor;
/**
 * Recursively map all color values in an object
 */
function mapColorsInObject(obj) {
...
function detectVersion(settings) {
    ...
    if ((_a = settings === null || settings === void 0 ? void 0 : settings._meta) === null || _a === void 0 ? void 0 : _a.version) {
    ...
    const hasLegacyStructure = !(settings === null || settings === void 0 ? void 0 : settings._meta) &&
        (((_b = settings === null || settings === void 0 ? void 0 : settings.colors) === null || _b === void 0 ? void 0 : _b.primaryColor) === '#0073aa' ||
            !(settings === null || settings === void 0 ? void 0 : settings.scrollToTop) ||
            !(settings === null || settings === void 0 ? void 0 : settings.buttons) ||
            !(settings === null || settings === void 0 ? void 0 : settings.breadcrumbs));
 ...
 */
function migrateFromLegacy(legacySettings) {
 ...
 */
function migrateCustomizerSettings(settings) {
...
exports.migrateCustomizerSettings = migrateCustomizerSettings;
/**
 * Validate migration result
 */
function validateMigration(settings) {
    const errors = [];
...
exports.getDefaultSettingsV1 = getDefaultSettingsV1;
