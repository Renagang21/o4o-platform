...
router.get('/', auth_middleware_1.authenticate, async (req, res) => {
    var _a, _b;
    try {
        const { page = 1, per_page = editor_constants_1.PAGINATION_DEFAULTS.BLOCKS_PER_PAGE, search = '', status = 'active', category = '', visibility = '', author = '', orderby = 'updated_at', order = 'DESC' } = req.query;
        ...
        logger_1.default.error('Error fetching reusable blocks:', {
            error: error.message,
            stack: error.stack,
...
router.get('/:id', auth_middleware_1.authenticate, async (req, res) => {
    ...
    try {
        ...
        logger_1.default.error('Error fetching reusable block:', {
...
router.post('/', auth_middleware_1.authenticate, async (req, res) => {
    ...
    try {
        ...
        logger_1.default.error('Error creating reusable block:', {
            error: error.message,
            stack: error.stack,
            userId: (_b = req.user) === null || _b === void 0 ? void 0 : _b.id,
...
router.put('/:id', auth_middleware_1.authenticate, async (req, res) => {
    ...
    try {
        ...
        if (block.revisions) {
            ...
            block.revisions = revisions.slice(-editor_constants_1.REVISION_LIMITS.MAX_REVISIONS);
        }
        // Update fields
        ...
        logger_1.default.error('Error updating reusable block:', {
            blockId: req.params.id,
            error: error.message,
            stack: error.stack,
            userId: (_b = req.user) === null || _b === void 0 ? void 0 : _b.id
...
router.delete('/:id', auth_middleware_1.authenticate, async (req, res) => {
    ...
    try {
        ...
        logger_1.default.error('Error deleting reusable block:', {
            blockId: req.params.id,
            error: error.message,
            stack: error.stack,
            userId: (_b = req.user) === null || _b === void 0 ? void 0 : _b.id
...
router.post('/:id/duplicate', auth_middleware_1.authenticate, async (req, res) => {
    ...
    try {
        ...
        const duplicateTitle = title || `${originalBlock.title} ${editor_constants_1.BLOCK_DUPLICATE.SUFFIX}`;
        ...
        logger_1.default.error('Error duplicating reusable block:', {
            blockId: req.params.id,
            error: error.message,
            stack: error.stack,
            userId: (_b = req.user) === null || _b === void 0 ? void 0 : _b.id
 ...
 */
router.get('/categories', auth_middleware_1.authenticate, async (req, res) => {
    var _a;
    try {
        ...
        logger_1.default.error('Error fetching block categories:', {
            error: error.message,
            stack: error.stack,
