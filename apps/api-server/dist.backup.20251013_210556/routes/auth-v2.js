...
router.get('/me', auth_1.authenticateCookie, async (req, res) => {
    var _a, _b;
    try {
        const userRepository = connection_1.AppDataSource.getRepository(User_1.User);
...
router.post('/logout-all', auth_1.authenticateCookie, async (req, res) => {
    var _a, _b;
    try {
...
router.post('/resend-verification-auth', auth_1.authenticateCookie, async (req, res) => {
    var _a, _b;
    try {
        if (!((_a = req.user) === null || _a === void 0 ? void 0 : _a.userId) && !((_b = req.user) === null || _b === void 0 ? void 0 : _b.id)) {
            return res.status(401).json({
