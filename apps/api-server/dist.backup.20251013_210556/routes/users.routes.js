...
const createUserValidation = [
    ...
    (0, express_validator_2.body)('role').optional().isIn(Object.values(auth_1.UserRole)),
    (0, express_validator_2.body)('roles').optional().isArray(),
    (0, express_validator_2.body)('roles.*').optional().isIn(Object.values(auth_1.UserRole))
];
...
const paginationValidation = [
    ...
    (0, express_validator_2.query)('sortBy').optional().isIn(['created_at', 'email', 'firstName', 'lastName']),
...
router.put('/:id/roles', [
    ...
    (0, express_validator_2.body)('roles.*').isIn(Object.values(auth_1.UserRole))
