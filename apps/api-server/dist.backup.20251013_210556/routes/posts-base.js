        ...
        const formattedPosts = posts.map(post => {
            ...
            return ({
                ...
                _embedded: {
                    ...
                    'wp:term': [
                        ((_d = post.categories) === null || _d === void 0 ? void 0 : _d.map(c => ({
                            id: c.id,
                            name: c.name,
                            slug: c.slug,
                            taxonomy: 'category'
...
router.post('/', auth_middleware_1.authenticate, (0, express_validator_1.body)('title').notEmpty().withMessage('Title is required'), (0, express_validator_1.body)('content').notEmpty().withMessage('Content is required'), (0, express_validator_1.body)('status').optional().isIn(['draft', 'publish', 'private', 'archived', 'scheduled']), validateDto_1.validateDto, async (req, res) => {
    var _a;
    try {
