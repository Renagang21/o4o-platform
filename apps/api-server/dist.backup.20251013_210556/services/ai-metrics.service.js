...
class AIMetricsService {
     ...
     */
    async collectMetrics(timeRangeMs) {
        try {
            // Get queue counts
            ...
            logger_1.default.error('Failed to collect AI metrics', { error: error.message });
            throw error;
        }
    }
    /**
    ...
    async collectRedisStats() {
        try {
            ...
            logger_1.default.warn('Failed to collect Redis stats', { error: error.message });
            return undefined;
        }
    }
    /**
        ...
        try {
            ...
            return allJobs.map(job => {
                ...
                return ({
                    ...
                    duration: (_a = job.returnvalue) === null || _a === void 0 ? void 0 : _a.duration,
            ...
            logger_1.default.error('Failed to get recent jobs', { error: error.message });
            throw error;
        }
    }
    /**
     ...
     */
    calculateErrorStats(failedJobs) {
        const errorsByType = {};
        let totalErrors = 0;
    ...
    async cleanup() {
        ...
        logger_1.default.info('AI metrics service cleaned up');
    }
}
exports.aiMetrics = AIMetricsService.getInstance();
