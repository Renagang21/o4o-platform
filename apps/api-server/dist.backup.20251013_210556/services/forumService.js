...
class ForumService {
    ...
    async createComment(data, authorId) {
        ...
        const requireApproval = (_a = category === null || category === void 0 ? void 0 : category.requireApproval) !== null && _a !== void 0 ? _a : false;
        const comment = this.commentRepository.create({
            ...data,
            authorId,
            status: requireApproval ? ForumComment_1.CommentStatus.PENDING : ForumComment_1.CommentStatus.PUBLISHED
        });
        // 멘션 추출
