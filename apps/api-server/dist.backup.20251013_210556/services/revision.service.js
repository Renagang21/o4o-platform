...
const PostRevision_1 = require("../entities/PostRevision");
const PageRevision_1 = require("../entities/PageRevision");
...
class RevisionService {
    constructor() {
        ...
        this.postRevisionRepository = connection_1.AppDataSource.getRepository(PostRevision_1.PostRevision);
        this.pageRevisionRepository = connection_1.AppDataSource.getRepository(PageRevision_1.PageRevision);
        this.maxRevisionsPerEntity = 20;
    }
    /**
     * Create a new revision for a post
     */
    async createPostRevision(post, revisionData) {
        var _a;
        try {
            ...
            const revisionNumber = ((latestRevision === null || latestRevision === void 0 ? void 0 : latestRevision.revisionNumber) || 0) + 1;
            ...
            const revision = this.postRevisionRepository.create({
                ...
                tags: ((_a = post.tags) === null || _a === void 0 ? void 0 : _a.map(tag => typeof tag === 'string' ? tag : tag.name)) || [],
            ...
            logger_1.default.info('Post revision created', {
                postId: post.id,
            ...
            logger_1.default.error('Error creating post revision:', error);
            throw error;
        }
    }
    /**
     ...
     */
    async createPageRevision(page, revisionData) {
        try {
            ...
            logger_1.default.info('Page revision created', {
                pageId: page.id,
                revisionId: savedRevision.id,
                revisionNumber,
                revisionType: revisionData.revisionType,
            ...
            logger_1.default.error('Error creating page revision:', error);
            throw error;
        }
    }
    /**
    ...
    async getPostRevisions(postId, limit = 20) {
        try {
            ...
            logger_1.default.error('Error getting post revisions:', error);
            throw error;
        }
    }
    /**
     ...
     */
    async getPageRevisions(pageId, limit = 20) {
        try {
            ...
            logger_1.default.error('Error getting page revisions:', error);
            throw error;
        }
    }
    /**
     ...
     */
    async restorePostRevision(postId, revisionId, restoredBy) {
        try {
            ...
            logger_1.default.info('Post restored from revision', {
                postId,
                revisionId,
            ...
            logger_1.default.error('Error restoring post revision:', error);
            throw error;
        }
    }
    /**
     ...
     */
    async restorePageRevision(pageId, revisionId, restoredBy) {
        try {
            ...
            logger_1.default.info('Page restored from revision', {
                pageId,
                revisionId,
                revisionNumber: revision.revisionNumber,
                restoredBy
            ...
            logger_1.default.error('Error restoring page revision:', error);
            throw error;
        }
    }
    /**
     ...
     */
    async compareRevisions(entityType, revisionId1, revisionId2) {
        try {
            let revision1;
            let revision2;
            if (entityType === 'post') {
            ...
            logger_1.default.error('Error comparing revisions:', error);
            throw error;
        }
    }
    /**
     ...
     */
    async autoSaveContent(entityId, entityType, content, authorId) {
        try {
            ...
            const revision = entityType === 'post'
                ? await this.createPostRevision(updatedEntity, {
                    entityId,
                    entityType,
                    authorId,
                ...
                : await this.createPageRevision(updatedEntity, {
                    entityId,
                    entityType,
                    authorId,
                    revisionType: 'autosave',
            ...
            logger_1.default.error('Error auto-saving content:', error);
     ...
     */
    async cleanupOldPostRevisions(postId) {
        try {
            ...
            if (totalRevisions > this.maxRevisionsPerEntity) {
                ...
                if (oldestRevisions.length > 0) {
                    ...
                    logger_1.default.debug('Cleaned up old post revisions', {
                        postId,
            ...
            logger_1.default.error('Error cleaning up old post revisions:', error);
        }
    }
    async cleanupOldPageRevisions(pageId) {
        try {
            ...
            if (totalRevisions > this.maxRevisionsPerEntity) {
                ...
                if (oldestRevisions.length > 0) {
                    ...
                    logger_1.default.debug('Cleaned up old page revisions', {
                        pageId,
                        deletedCount: oldestRevisions.length
                    });
                }
            ...
            logger_1.default.error('Error cleaning up old page revisions:', error);
        }
    }
    /**
     * Calculate changes between revisions
     */
    calculatePostChanges(oldRevision, newPost) {
        const changes = {};
    ...
    calculatePageChanges(oldRevision, newPage) {
        const changes = {};
    ...
    calculateDetailedChanges(revision1, revision2) {
        const changes = {};
    ...
    calculateSimilarity(revision1, revision2) {
     ...
     */
    async getRevisionStats(entityType, entityId) {
        try {
            ...
            logger_1.default.error('Error getting revision stats:', error);
            throw error;
        }
    }
}
