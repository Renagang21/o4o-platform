...
exports.OptimizeSystemPerformance1770000000000 = void 0;
const typeorm_1 = require("typeorm");
class OptimizeSystemPerformance1770000000000 {
    constructor() {
        this.name = 'OptimizeSystemPerformance1770000000000';
    }
    async up(queryRunner) {
        // Vendor performance indexes
        if (await queryRunner.hasTable('vendor_info')) {
            await queryRunner.createIndex('vendor_info', new typeorm_1.TableIndex({
        ...
        if (await queryRunner.hasTable('vendor_commissions')) {
            await queryRunner.createIndex('vendor_commissions', new typeorm_1.TableIndex({
        ...
        if (await queryRunner.hasTable('commission_settlements')) {
            await queryRunner.createIndex('commission_settlements', new typeorm_1.TableIndex({
        ...
        if (await queryRunner.hasTable('supplier_products')) {
            await queryRunner.createIndex('supplier_products', new typeorm_1.TableIndex({
        ...
        if (await queryRunner.hasTable('inventories')) {
            await queryRunner.createIndex('inventories', new typeorm_1.TableIndex({
        ...
        if (await queryRunner.hasTable('user_activity_logs')) {
            await queryRunner.createIndex('user_activity_logs', new typeorm_1.TableIndex({
        ...
        `);
        await queryRunner.createIndex('system_performance_logs', new typeorm_1.TableIndex({
...
exports.OptimizeSystemPerformance1770000000000 = OptimizeSystemPerformance1770000000000;
//# sourceMappingURL=1770000000000-OptimizeSystemPerformance.js.map