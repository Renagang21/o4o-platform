...
exports.ForumCPTController = void 0;
...
class ForumCPTController {
    constructor() {
        // Get Forum System Status
        this.getSystemStatus = async (req, res) => {
            try {
                const categoryRepo = (0, typeorm_1.getRepository)(ForumCategory_1.ForumCategory);
                const postRepo = (0, typeorm_1.getRepository)(ForumPost_1.ForumPost);
                const commentRepo = (0, typeorm_1.getRepository)(ForumComment_1.ForumComment);
                const tagRepo = (0, typeorm_1.getRepository)(ForumTag_1.ForumTag);
        ...
        this.getPosts = async (req, res) => {
            try {
                const { page = 1, limit = 20, categoryId, search, sortBy = 'latest' } = req.query;
                const postRepo = (0, typeorm_1.getRepository)(ForumPost_1.ForumPost);
                ...
                const mappedPosts = await Promise.all(posts.map(async (post) => {
                    ...
                    return ({
                        ...
                        authorName: ((_a = post.author) === null || _a === void 0 ? void 0 : _a.fullName) || ((_b = post.author) === null || _b === void 0 ? void 0 : _b.firstName) || ((_c = post.author) === null || _c === void 0 ? void 0 : _c.email) || 'Unknown',
        ...
        this.createCategory = async (req, res) => {
            ...
            try {
                ...
                const { name, slug, description, accessLevel = 'public', requireApproval = false, isActive = true, sortOrder = 0 } = req.body;
                if (!name || !slug) {
                    res.status(400).json({
                        success: false,
        ...
        this.updateCategory = async (req, res) => {
            try {
                const { id } = req.params;
                const { name, slug, description, accessLevel, requireApproval, isActive, sortOrder } = req.body;
                const categoryRepo = (0, typeorm_1.getRepository)(ForumCategory_1.ForumCategory);
                ...
                if (requireApproval !== undefined)
                    category.requireApproval = requireApproval;
        ...
        this.updatePost = async (req, res) => {
            try {
                const { id } = req.params;
                const { title, slug, content, excerpt, categoryId, status, isPinned, isLocked, allowComments, tags } = req.body;
                const postRepo = (0, typeorm_1.getRepository)(ForumPost_1.ForumPost);
        ...
        this.updatePostPin = async (req, res) => {
            try {
                const { id } = req.params;
...
exports.ForumCPTController = ForumCPTController;
//# sourceMappingURL=ForumCPTController.js.map