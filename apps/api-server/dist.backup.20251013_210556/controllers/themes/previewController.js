...
_a = PreviewController;
/**
 * Render preview page with live customizer settings
 */
PreviewController.renderPreview = (0, errorHandler_middleware_1.asyncHandler)(async (req, res) => {
...
<body>
  ...
  <script>
    ...
    logger_1.default.info('Preview rendered', { themeId });
});
