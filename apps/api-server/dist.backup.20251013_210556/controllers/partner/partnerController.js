...
class PartnerController {
    ...
    static async getDashboardSummary(req, res) {
        ...
        try {
            ...
            const tierProgress = Math.min(100, (totalEarnings / nextTierThreshold) * 100);
            // Generate summary
            const summary = {
                totalEarnings,
                monthlyEarnings,
                ...
                joinDate: ((_b = partner.createdAt) === null || _b === void 0 ? void 0 : _b.toISOString()) || new Date().toISOString(),
    ...
    static async generatePartnerLink(req, res) {
        var _a;
        try {
            const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.id;
    ...
    static async getPromotionalProducts(req, res) {
        var _a;
        try {
            const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.id;
            const { category, featured = false, sortBy = 'commission', page = 1, limit = 12 } = req.query;
            if (!userId) {
                return res.status(401).json({
                    success: false,
                    message: 'Authentication required'
            ...
            const sortFunction = sortFunctions[sortBy] || sortFunctions.commission;
