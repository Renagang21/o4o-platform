...
class AdminStatsController {
    ...
    async processSettlement(req, res) {
        ...
        try {
            ...
            logger_1.default.info(`Processing settlement ${id} with action: ${action}`);
            res.json({
                success: true,
                ...
                data: {
                    settlementId: id,
                    action,
                    processedBy: (_e = req.user) === null || _e === void 0 ? void 0 : _e.id,
...
exports.default = new AdminStatsController();
