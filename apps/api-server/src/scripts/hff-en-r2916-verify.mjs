...
fs.writeFileSync(`${D}/hff-en-r2916-final-hold-v1.jsonl`, queue.map((r) => JSON.stringify(r)).join('\n') + '\n');
fs.writeFileSync(`${D}/hff-en-r2916-final-hold-summary-v1.json`, JSON.stringify({
...
fs.writeFileSync(`${D}/hff-en-bulk-production-completed-through-r2916-v1.json`, JSON.stringify({
...
fs.writeFileSync(`${D}/hff-en-bulk-production-remaining-after-r2916-v1.json`, JSON.stringify({
...
const out = {
  ...
  globals: g, expectedEnDelta: 286, actualEnDelta: g.en_canon - 16780,
...
out.globalsOk = g.ko_canon === 40918 && g.pm_hff === 40948 && g.en_dup === 0 && g.en_canon === 17066;
...
fs.writeFileSync(`${D}/hff-en-r2916-independent-verification-v1.json`, JSON.stringify(out, null, 1));
