 ...
 *
 * 최종 잔여 ZH canonical INSERT (10,000).
 *   - INSERT 전용. KO canonical / EN / 다른 언어 / ProductMaster / candidate 는 쓰지 않는다.
 *   - 이중 게이트: `--apply` + HFF_ZH_FINAL_APPLY_CONFIRM=YES.
...
const APPLY = process.argv.includes('--apply') && process.env.HFF_ZH_FINAL_APPLY_CONFIRM === 'YES';
