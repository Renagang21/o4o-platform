// WO-O4O-OTC-REMAINING-READY-SHARD-NA-V2-LIVE-APPLY-V1 — EN config 저작 검증기 (에이전트 나).
//
...
//   npx tsx src/scripts/otc-v2-en-config-verify.na.mjs src/scripts/data/otc-v2-en-config-na-p01.json
...
console.log(`EN-CONFIG-VERIFY na — entries ${entries} · ${failures.length === 0 ? 'PASS' : `FAIL ${failures.length}`}`);
