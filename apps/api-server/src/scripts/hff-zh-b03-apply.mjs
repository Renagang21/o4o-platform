/**
 * WO-O4O-HFF-ZH-BATCH-03-10000-DIRECT-BULK-PRODUCTION-V1  §7
 *
...
const RENDER = JSON.parse(fs.readFileSync(`${D}/hff-zh-b03-render-audit-v1.json`, 'utf8'));
const TARGETS = JSON.parse(fs.readFileSync(`${D}/hff-zh-b03-safe-targets-v1.json`, 'utf8')).targets;
...
fs.writeFileSync(`${D}/hff-zh-b03-rollback-v1.json`, JSON.stringify({
...
fs.writeFileSync(`${D}/hff-zh-b03-apply-result-v1.json`, JSON.stringify({ ...out, insertedIds: inserted.map((x) => x.id) }, null, 1));
