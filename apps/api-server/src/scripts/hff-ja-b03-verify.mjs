/**
 * WO-O4O-HFF-JA-ALL-CURRENTLY-PRODUCIBLE-7414-DIRECT-BULK-PRODUCTION-V1  §7 독립검증
 *
...
const APPLIED = JSON.parse(fs.readFileSync(`${D}/hff-ja-b03-apply-result-v1.json`, 'utf8'));
...
fs.writeFileSync(`${D}/hff-ja-b03-verify-v1.json`, JSON.stringify(out, null, 1));
