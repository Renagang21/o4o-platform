/**
 * 비타민 C 확장 batch60 (누적 51~80) — 최신 Guard 전수 검사 (read-only)
 *   npx tsx src/scripts/hff-vc-guard-scan-60.ts
 * DB write 0.
 */
...
const F = 'C:/Users/sohae/o4o-platform/docs/checks/data/product-description-guard/hff-vitamin-c-60.json';
...
console.log(`비타민 C batch60 최신 Guard 검사\n`);
