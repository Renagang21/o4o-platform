...
export function runComboGuard(seed: ComboSeed, ko: string, en: string): MultiFinding[] {
  ...
  const SRC_LABEL: Record<string, RegExp> = {
    '비타민D': /비타민\s?D/i, '비타민C': /비타민\s?C/i, '비타민A': /비타민\s?A/i, '비타민E': /비타민\s?E|토코페롤/i, '비타민K': /비타민\s?K/i,
    '비타민B1': /비타민\s?B\s?1|티아민/i, '비타민B2': /비타민\s?B\s?2|리보플라빈/i, '비타민B6': /비타민\s?B\s?6|피리독/i, '비타민B12': /비타민\s?B\s?12/i,
