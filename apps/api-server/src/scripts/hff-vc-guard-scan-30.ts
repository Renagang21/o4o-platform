/**
 * 비타민 C 확장 30건 — 최신 Guard 전수 검사 (read-only)
 *   npx tsx src/scripts/hff-vc-guard-scan-30.ts
 * 물 규칙(G-WATER) 포함 최신 가드로 판정. DB write 0.
 */
...
const F = 'C:/Users/sohae/o4o-platform/docs/checks/data/product-description-guard/hff-vitamin-c-30.json';
...
console.log(`비타민 C 확장 30건 최신 Guard 검사\n`);
