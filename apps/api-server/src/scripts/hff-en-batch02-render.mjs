...
const ALL = JSON.parse(fs.readFileSync(`${D}/hff-en-batch02-safe-targets-v1.json`, 'utf8')).targets;
...
fs.writeFileSync(`${D}/hff-en-batch02-render-audit-v1.json`, JSON.stringify(out, null, 1));
