/**
 * WO-O4O-HFF-ZH-BATCH-02-10000-DIRECT-BULK-PRODUCTION-V1  §3 / §4
 ...
 * 산출: <CACHE>/hff-zh-b02-needed-phrases.json · data/hff-zh-b02-plan-v1.json
 */
...
const TARGET = 10000;
const pool = fs.readFileSync(`${CACHE}/hff-zh-b02-pool.jsonl`, 'utf8').trim().split('\n').map((l) => JSON.parse(l));
...
fs.writeFileSync(`${CACHE}/hff-zh-b02-needed-phrases.json`, JSON.stringify(needed, null, 1));
const out = {
...
fs.writeFileSync(`${D}/hff-zh-b02-plan-v1.json`, JSON.stringify(out, null, 1));
