...
const out = {
  ...
  total: HOLD.length, expected: 2630, matches: HOLD.length === 2630,
  blockers: reasons,
...
fs.writeFileSync(`${D}/hff-en-lp690-audit-v1.json`, JSON.stringify(out, null, 1));
fs.writeFileSync(`${D}/hff-en-lp690-docs-v1.json`, JSON.stringify({ builtAt: out.builtAt, docs }, null, 1));
