/**
 * WO-O4O-HFF-ZH-BATCH-03-10000-DIRECT-BULK-PRODUCTION-V1  §8 독립검증
 *
...
const APPLIED = JSON.parse(fs.readFileSync(`${D}/hff-zh-b03-apply-result-v1.json`, 'utf8'));
const QUEUE = fs.readFileSync(`${D}/hff-zh-deferred-issue-queue-through-batch03-v1.jsonl`, 'utf8')
...
fs.writeFileSync(`${D}/hff-zh-b03-verify-v1.json`, JSON.stringify(out, null, 1));
