/**
 * WO-O4O-HFF-ZH-BATCH-04-10000-DIRECT-BULK-PRODUCTION-V1  §3 / §4
 ...
 * 산출: <CACHE>/hff-zh-b04-needed-phrases.json · data/hff-zh-b04-plan-v1.json
 */
...
fs.writeFileSync(`${CACHE}/hff-zh-b04-needed-phrases.json`, JSON.stringify(needed, null, 1));
const out = {
...
fs.writeFileSync(`${D}/hff-zh-b04-plan-v1.json`, JSON.stringify(out, null, 1));
