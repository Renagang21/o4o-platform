...
const c = new pg.Client({ host: '127.0.0.1', port: parseInt(process.env.PROXY_PORT ?? '5515', 10), user: process.env.PGUSER, password: process.env.PGPW, database: 'o4o_platform', ssl: false });
await c.connect();
...
fs.writeFileSync(`${D}/hff-en-top1000-batch01-hold4209-final-hold-v1.jsonl`, queue.map((r) => JSON.stringify(r)).join('\n') + '\n');
fs.writeFileSync(`${D}/hff-en-top1000-batch01-hold4209-final-hold-summary-v1.json`, JSON.stringify({
...
fs.writeFileSync(`${D}/hff-en-bulk-production-completed-through-top1000-round1-v1.json`, JSON.stringify({
...
fs.writeFileSync(`${D}/hff-en-bulk-production-remaining-after-top1000-round1-v1.json`, JSON.stringify({
...
fs.writeFileSync(`${D}/hff-en-top1000-batch01-hold4209-independent-verification-v1.json`, JSON.stringify(out, null, 1));
fs.writeFileSync(`${D}/hff-en-top1000-batch01-hold4209-apply-results-v1.json`, JSON.stringify({
...
fs.writeFileSync(`${D}/hff-en-top1000-batch01-hold4209-rollback-v1.json`, JSON.stringify({
