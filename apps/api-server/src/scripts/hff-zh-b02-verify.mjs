/**
 * WO-O4O-HFF-ZH-BATCH-02-10000-DIRECT-BULK-PRODUCTION-V1  §8 독립검증
 *
...
const APPLIED = JSON.parse(fs.readFileSync(`${D}/hff-zh-b02-apply-result-v1.json`, 'utf8'));
...
fs.writeFileSync(`${D}/hff-zh-b02-verify-v1.json`, JSON.stringify(out, null, 1));
