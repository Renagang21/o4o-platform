/**
 * WO-O4O-HFF-EN-BATCH-03-5000-DIRECT-BULK-PRODUCTION-AND-DEFERRED-ISSUE-QUEUE-V1 §3
 * Batch 03 모집단 5,000건 선정 (read-only).
 *
...
fs.writeFileSync(`${D}/hff-en-batch03-population-5000-v1.json`, JSON.stringify({
  wo: 'WO-O4O-HFF-EN-BATCH-03-5000-DIRECT-BULK-PRODUCTION-AND-DEFERRED-ISSUE-QUEUE-V1',
  batch: 3, builtAt: new Date().toISOString(), readOnly: true, dbWrites: 0,
