 ...
 *       승인 WO = WO-O4O-OTC-EASY-DRUG-READY-ORAL-UNIT1-CONTENT-FP-V3-FINAL-PRODUCTION-V1 (oral-unit-1 단독)
 *       3중 게이트: --apply --confirm + per-unit·per-lang confirm env(OTC_V3_APPLY_{KO,EN}_ORAL_UNIT_1=CONFIRM)
 *                   + unit 화이트리스트(oral-unit-1 외 exit 3). EN 은 KO authored canonical 성립 후에만 진행.
...
// ── KO write 계약(4T): easy demote → authored insert → canonical flip → audit + TX 내 사후검증 ──
