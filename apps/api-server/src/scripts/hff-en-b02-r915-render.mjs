/**
 * WO-...-BATCH-02-5000-DIRECT-BULK-PRODUCTION-V1 §21 / 렌더 검증 (read-only, DB 미접근).
...
const ALL = JSON.parse(fs.readFileSync(`${D}/hff-en-batch02-remaining915-safe-targets-v1.json`, 'utf8')).targets;
...
fs.writeFileSync(`${D}/hff-en-batch02-remaining915-render-audit-v1.json`, JSON.stringify(out, null, 1));
