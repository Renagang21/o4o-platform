...
fs.writeFileSync(`${D}/hff-en-batch01-r2237-final-hold-v1.jsonl`, queue.map((r) => JSON.stringify(r)).join('\n') + '\n');
fs.writeFileSync(`${D}/hff-en-batch01-r2237-final-hold-summary-v1.json`, JSON.stringify({
...
fs.writeFileSync(`${D}/hff-en-batch01-completed-through-r2237-v1.json`, JSON.stringify({
...
fs.writeFileSync(`${D}/hff-en-batch01-remaining-after-r2237-v1.json`, JSON.stringify({
...
const out = {
  ...
  globals: g, expectedEnDelta: 184, actualEnDelta: g.en_canon - 17458,
...
out.globalsOk = g.ko_canon === 40918 && g.pm_hff === 40948 && g.en_dup === 0 && g.en_canon === 17642;
...
fs.writeFileSync(`${D}/hff-en-batch01-remaining2237-independent-verification-v1.json`, JSON.stringify(out, null, 1));
