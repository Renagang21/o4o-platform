/**
 * WO-O4O-OTC-NUTRITION-COMBO-LARGE-GROUP-2H-DA-V1 (에이전트 다) — 자기 전용 EN-only 러너(나 검증 계약 verbatim 복제, 대형 그룹).
 *
...
async function run(cfg: ComboEnConfig, opts: { apply: boolean }): Promise<Record<string, unknown>> {
  ...
  const report: any = {
    wo: 'WO-O4O-OTC-NUTRITION-COMBO-LARGE-GROUP-2H-DA-V1', mode, status: 'INIT', dbWrite: 0,
