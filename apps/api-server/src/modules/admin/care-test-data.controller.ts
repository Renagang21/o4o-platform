...
const TEST_USERS = [
  ...
  { id: TU.pharmA, email: 'pharmacist.a@test.glycopharm.com', name: '[TEST] 약사 김',     roles: ['pharmacy'] },
  { id: TU.pharmB, email: 'pharmacist.b@test.glycopharm.com', name: '[TEST] 약사 이',     roles: ['pharmacy'] },
];

const TEST_ROLE_ASSIGNMENTS = [
  { id: TR.admin,  userId: TU.admin,  role: 'platform:admin',        scopeType: 'global',       scopeId: null },
  { id: TR.pharmA, userId: TU.pharmA, role: 'pharmacy', scopeType: 'organization', scopeId: TO.pharmA },
  { id: TR.pharmB, userId: TU.pharmB, role: 'pharmacy', scopeType: 'organization', scopeId: TO.pharmB },
];
