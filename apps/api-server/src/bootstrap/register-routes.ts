...
export async function registerDomainRoutes(app: Application, dataSource: DataSource): Promise<void> {
  try {
    ...
    try {
      ...
      app.use('/api/v1/care', createCareAnalysisRouter(dataSource));
    ...
    try {
      ...
      app.use('/api/v1/care', createCareCoachingRouter(dataSource));
    ...
    try {
      ...
      app.use('/api/v1/care', createCareDashboardRouter(dataSource));
    ...
    try {
      ...
      app.use('/api/v1/care', createHealthReadingsRouter(dataSource));
    ...
    try {
      ...
      app.use('/api/v1/care', createCareLlmInsightRouter(dataSource));
    ...
    try {
      ...
      app.use('/api/v1/care', createCareAiChatRouter(dataSource));
    ...
    try {
      ...
      app.use('/api/v1/care', createPatientProfileRouter(dataSource));
    ...
    try {
      ...
      app.use('/api/v1/care', createPatientHealthReadingsRouter(dataSource));
    ...
    try {
      ...
      app.use('/api/v1/care', createPatientCoachingRouter(dataSource));
    ...
    try {
      ...
      app.use('/api/v1/care', createPharmacyLinkRouter(dataSource));
    ...
    try {
      ...
      app.use('/api/v1/care', createPatientAiInsightRouter(dataSource));
    ...
    try {
      ...
      app.use('/api/v1/care', createCareAppointmentRouter(dataSource));
      logger.info('✅ Care Appointment routes registered at /api/v1/care/appointments');
    ...
    try {
      ...
      app.use('/api/v1/ops/care-diagnostic', createCareDiagnosticRouter(dataSource));
    ...
    try {
      ...
      app.use('/api/v1/ops/care-test-data', createCareTestDataRouter(dataSource));
