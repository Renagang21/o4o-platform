...
function generateColorVariables(settings: any): string[] {
  const vars: string[] = [];
...
function generateTypographyVariables(settings: any): string[] {
  const vars: string[] = [];
...
function generateSpacingVariables(settings: any): string[] {
  const vars: string[] = [];
...
function generateResponsiveCSS(settings: any): string[] {
  const css: string[] = [];
  const typography = settings.typography;
  const colors = settings.colors;
...
function generateHeaderCSS(settings: any): string[] {
  const css: string[] = [];
  ...
  if (siteIdentity?.siteTitle?.display) {
    css.push('.site-title {');
    if (siteIdentity.siteTitle.color?.normal) {
      css.push(`  color: ${siteIdentity.siteTitle.color.normal};`);
    }
    if (siteIdentity.siteTitle.typography) {
      const typo = siteIdentity.siteTitle.typography;
    ...
    if (siteIdentity.siteTitle.color?.hover) {
...
function generateFooterCSS(settings: any): string[] {
  const css: string[] = [];
...
function generateContainerCSS(settings: any): string[] {
  const css: string[] = [];
  const { container } = settings;
