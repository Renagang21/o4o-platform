...
export class CreateCrowdfundingTables1700000000000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_FUNDING_PROJECTS_STATUS_END_DATE" ON "funding_projects" ("status", "endDate")`
    );

    await queryRunner.query(
      `CREATE INDEX "IDX_FUNDING_PROJECTS_CREATOR" ON "funding_projects" ("creatorId")`
    );

    await queryRunner.query(
      `CREATE INDEX "IDX_FUNDING_PROJECTS_CATEGORY" ON "funding_projects" ("category")`
    );
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_FUNDING_REWARDS_PROJECT_SORT" ON "funding_rewards" ("projectId", "sortOrder")`
    );
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_FUNDING_BACKINGS_PROJECT_BACKER" ON "funding_backings" ("projectId", "backerId")`
    );

    await queryRunner.query(
      `CREATE INDEX "IDX_FUNDING_BACKINGS_STATUS" ON "funding_backings" ("status")`
    );
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_BACKER_REWARDS_BACKING" ON "backer_rewards" ("backingId")`
    );
