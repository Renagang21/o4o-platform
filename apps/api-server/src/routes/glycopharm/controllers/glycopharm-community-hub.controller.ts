/**
 * GlycoPharm Community Hub Controller
 *
 * WO-GLYCOPHARM-COMMUNITY-HUB-IMPLEMENTATION-V1
 *
 * Reuses CommunityHubService from KPA with SERVICE_CODE = 'glycopharm'.
...
export function createGlycopharmCommunityHubController(
  dataSource: DataSource,
  requireAuth: AuthMiddleware,
  requireGlycopharmScope: ScopeMiddleware,
): Router {
  const router = Router();
