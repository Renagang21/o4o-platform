...
router.get('/projects/:id', crowdfundingController.getProjectDetails.bind(crowdfundingController));
router.get('/dashboard/stats', crowdfundingController.getCreatorDashboard.bind(crowdfundingController));

// 참여 관련 (Business/Affiliate 사용자만)
router.post('/projects/:id/join', requireRole(['business', 'affiliate']), crowdfundingController.createBacking.bind(crowdfundingController));
...
// 관리자 전용 라우트
router.patch('/projects/:id/status', requireRole(['admin']), crowdfundingController.approveProject.bind(crowdfundingController));
