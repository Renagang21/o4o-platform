...
import { ImageEditingController } from '../../controllers/content/ImageEditingController.js';
...
router.post('/resize', 
  ...
  imageEditingController.resizeImage
);
...
router.post('/crop', 
  roleGuard(['contributor', 'author', 'editor', 'admin']),
  imageEditingController.cropImage
);
...
router.post('/watermark', 
  roleGuard(['contributor', 'author', 'editor', 'admin']),
  imageEditingController.addWatermark
);
...
router.post('/optimize', 
  roleGuard(['contributor', 'author', 'editor', 'admin']),
  imageEditingController.optimizeImage
);
...
router.get('/:id/analysis', 
  roleGuard(['contributor', 'author', 'editor', 'admin']),
  imageEditingController.getImageAnalysis
);
...
router.post('/batch-optimize', 
  ...
  imageEditingController.batchOptimizeImages
);
...
router.post('/generate-responsive', 
  roleGuard(['editor', 'admin']),
  imageEditingController.generateResponsiveImages
);
