...
describe('11~14. 실행 · 종료 · 셸 · 파일 접근은 구현 자체가 없다', () => {
  ...
  it('13. 셸은 열려 있지 않다 — child_process 는 한 파일 · 체크인된 .ps1 다섯 개뿐이다', () => {
    ...
    // (c) 실행 대상은 저장소에 체크인된 .ps1 아홉 개뿐이고, argv 는 상수다.
    ...
    //      UIA-CANONICAL-TEST-SURFACE-V0 에서 개발/검증용 계측 창 1개,
    //      UIA-ELEMENT-IDENTITY-AND-PERSISTENT-CLIENT-V1 에서 지속 UIA 호스트 1개가 늘었다.)
