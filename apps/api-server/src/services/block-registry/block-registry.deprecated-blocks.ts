/**
 * Block Registry — Deprecated hardcoded block definitions
 *
 ...
 * Phase P0-C: This data is no longer used — blocks are loaded from @o4o/block-renderer metadata
 */

import type { BlockInfo } from '../../types/block.types.js';

/**
 * Register all deprecated hardcoded block definitions
 * @param register - callback to register each block
 */
export function registerDeprecatedBlocks(register: (name: string, info: BlockInfo) => void): void {
  // ============================================
  // 텍스트 블록 (Text Blocks)
  // ============================================

  register('o4o/paragraph', {
    name: 'o4o/paragraph',
    title: '단락',
