...
export class AddCommissionPolicyFields1830000000002 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        const hasBusinessInfoTable = await queryRunner.hasTable('business_info');

        if (!hasProductsTable && !hasBusinessInfoTable) {
            console.log('Skipping AddCommissionPolicyFields: Neither products nor business_info table exists');
            return;
        }
        ...
        if (hasProductsTable) {
            ...
            // Create index for commission fields
            await queryRunner.query(`
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        if (hasBusinessInfoTable) {
            ...
            await queryRunner.query(`ALTER TABLE "business_info" DROP COLUMN IF EXISTS "defaultCommissionRate"`);
        }
        ...
        if (hasProductsTable) {
            ...
            await queryRunner.query(`
                ...
                DROP COLUMN IF EXISTS "sellerCommissionRate",
