...
export class PlatformController {
  ...
  getActiveApps = async (req: Request, res: Response) => {
    try {
  ...
  // Update app status
  updateAppStatus = async (req: Request, res: Response) => {
    try {
      const { id } = req.params;
  ...
  getCustomPostTypes = async (req: Request, res: Response) => {
    try {
      return res.json({
        status: 'success',
        data: [
  ...
  getCustomPostType = async (req: Request, res: Response) => {
    try {
      const { id } = req.params;
  ...
  createCustomPostType = async (req: Request, res: Response) => {
    try {
  ...
  updateCustomPostType = async (req: Request, res: Response) => {
    try {
      const { id } = req.params;
  ...
  deleteCustomPostType = async (req: Request, res: Response) => {
    try {
      const { id } = req.params;
