...
export default defineConfig({
  ...
  entry: ['src/main.ts', 'src/migrate.ts', 'src/drug-seed-candidate-import-job.ts', 'src/drug-seed-promotion-apply-job.ts', 'src/easy-drug-seed-candidate-import-job.ts'],
  format: ['esm'],
  target: 'node22',
  platform: 'node',
  outDir: 'dist',
