...
__decorate([
    (0, typeorm_1.ManyToOne)(() => ForumPost_1.ForumPost, post => post.comments),
    (0, typeorm_1.JoinColumn)({ name: 'postId' }),
    __metadata("design:type", ForumPost_1.ForumPost)
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => ForumComment, comment => comment.replies, { nullable: true }),
    (0, typeorm_1.JoinColumn)({ name: 'parentId' }),
    __metadata("design:type", ForumComment)
], ForumComment.prototype, "parent", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => ForumComment, comment => comment.parent),
    __metadata("design:type", Array)
], ForumComment.prototype, "replies", void 0);
