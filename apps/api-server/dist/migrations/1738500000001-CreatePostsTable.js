...
class CreatePostsTable1738500000001 {
    ...
    async up(queryRunner) {
        ...
        await queryRunner.createIndex("posts", new typeorm_1.TableIndex({ name: "IDX_posts_publishedAt", columnNames: ["publishedAt"] }));
        await queryRunner.createIndex("posts", new typeorm_1.TableIndex({ name: "IDX_posts_authorId", columnNames: ["authorId"] }));
