...
router.post('/categories', auth_1.authenticateToken, forumController.createCategory);
router.put('/categories/:categoryId', auth_1.authenticateToken, forumController.updateCategory);
// Post routes
...
router.post('/posts', auth_1.authenticateToken, forumController.createPost);
router.put('/posts/:postId', auth_1.authenticateToken, forumController.updatePost);
// Comment routes
router.get('/posts/:postId/comments', forumController.getComments);
router.post('/comments', auth_1.authenticateToken, forumController.createComment);
// Statistics routes
router.get('/statistics', auth_1.authenticateToken, forumController.getStatistics);
