...
router.put('/:slug', auth_1.authenticateToken, auth_1.requireAdmin, async (req, res) => {
    try {
        const { slug } = req.params;
...
router.delete('/:slug', auth_1.authenticateToken, auth_1.requireAdmin, async (req, res) => {
    try {
        const { slug } = req.params;
        const cptIndex = mockCPTs.findIndex(c => c.slug === slug);
        if (cptIndex === -1) {
...
//# sourceMappingURL=custom-post-types.js.map