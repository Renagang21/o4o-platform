-- =============================================================================
-- O4O Platform Production Migration (Without Organization FK)
-- Date: 2026-01-29
-- Description: Forum Tables + Product Images Column
-- Note: Organization foreign keys removed as organization table doesn't exist yet
-- =============================================================================
...
CREATE TABLE IF NOT EXISTS forum_category (
  ...
  -- NOTE: organizationId FK removed - will be added later when organization table exists
);
...
CREATE TABLE IF NOT EXISTS forum_post (
  ...
  -- NOTE: organization_id FK removed - will be added later when organization table exists
);
...
-- ============================================================================
-- 7. Record Forum migration in migrations table (if exists)
-- ============================================================================
DO $$
BEGIN
...
-- ============================================================================
-- 9. Record Product Images migration in migrations table (if exists)
-- ============================================================================
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'migrations') THEN
