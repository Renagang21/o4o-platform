...
exports.CreatePostCategoriesTable1741000000000 = void 0;
const typeorm_1 = require("typeorm");
class CreatePostCategoriesTable1741000000000 {
    constructor() {
        this.name = 'CreatePostCategoriesTable1741000000000';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "post_categories" ADD CONSTRAINT "PK_POST_CATEGORIES" PRIMARY KEY ("postId", "categoryId")`);
...
exports.CreatePostCategoriesTable1741000000000 = CreatePostCategoriesTable1741000000000;
//# sourceMappingURL=1741000000000-CreatePostCategoriesTable.js.map