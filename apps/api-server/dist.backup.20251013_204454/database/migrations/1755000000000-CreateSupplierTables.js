...
exports.CreateSupplierTables1755000000000 = void 0;
const typeorm_1 = require("typeorm");
class CreateSupplierTables1755000000000 {
    async up(queryRunner) {
        ...
        await queryRunner.createIndex('supplier_vendors', new typeorm_1.TableIndex({
            name: 'IDX_supplier_vendors_primary',
            columnNames: ['supplierId', 'vendorId'],
            isUnique: true
        }));
        // Create foreign keys
        await queryRunner.createForeignKey('supplier_products', new typeorm_1.TableForeignKey({
            columnNames: ['supplierId'],
            referencedColumnNames: ['id'],
            referencedTableName: 'suppliers',
            onDelete: 'CASCADE'
        }));
        await queryRunner.createForeignKey('supplier_vendors', new typeorm_1.TableForeignKey({
            columnNames: ['supplierId'],
            referencedColumnNames: ['id'],
            referencedTableName: 'suppliers',
            onDelete: 'CASCADE'
    ...
    async down(queryRunner) {
        ...
        const supplierVendorsForeignKeys = (supplierVendorsTable === null || supplierVendorsTable === void 0 ? void 0 : supplierVendorsTable.foreignKeys) || [];
        ...
        const supplierProductsForeignKey = supplierProductsTable === null || supplierProductsTable === void 0 ? void 0 : supplierProductsTable.foreignKeys.find(fk => fk.columnNames.indexOf('supplierId') !== -1);
...
exports.CreateSupplierTables1755000000000 = CreateSupplierTables1755000000000;
//# sourceMappingURL=1755000000000-CreateSupplierTables.js.map