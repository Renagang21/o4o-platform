...
exports.CreateInventoryTables1750000000000 = void 0;
const typeorm_1 = require("typeorm");
class CreateInventoryTables1750000000000 {
    async up(queryRunner) {
        ...
        // Create indexes
        await queryRunner.createIndex('inventory', new typeorm_1.TableIndex({
        ...
        await queryRunner.createIndex('stock_movements', new typeorm_1.TableIndex({
        ...
        await queryRunner.createIndex('reorder_rules', new typeorm_1.TableIndex({
        ...
        await queryRunner.createIndex('inventory_alerts', new typeorm_1.TableIndex({
        ...
        // Create foreign keys
        await queryRunner.createForeignKey('inventory', new typeorm_1.TableForeignKey({
        ...
        await queryRunner.createForeignKey('reorder_rules', new typeorm_1.TableForeignKey({
            columnNames: ['inventoryId'],
            referencedColumnNames: ['id'],
            referencedTableName: 'inventory',
            onDelete: 'CASCADE'
        }));
        await queryRunner.createForeignKey('inventory_alerts', new typeorm_1.TableForeignKey({
            columnNames: ['inventoryId'],
            referencedColumnNames: ['id'],
            referencedTableName: 'inventory',
            onDelete: 'CASCADE'
    ...
    async down(queryRunner) {
        ...
        const inventoryAlertsForeignKey = inventoryAlertsTable === null || inventoryAlertsTable === void 0 ? void 0 : inventoryAlertsTable.foreignKeys.find(fk => fk.columnNames.indexOf('inventoryId') !== -1);
        ...
        const reorderRulesForeignKey = reorderRulesTable === null || reorderRulesTable === void 0 ? void 0 : reorderRulesTable.foreignKeys.find(fk => fk.columnNames.indexOf('inventoryId') !== -1);
        ...
        const stockMovementsForeignKey = stockMovementsTable === null || stockMovementsTable === void 0 ? void 0 : stockMovementsTable.foreignKeys.find(fk => fk.columnNames.indexOf('inventoryId') !== -1);
        ...
        const inventoryForeignKey = inventoryTable === null || inventoryTable === void 0 ? void 0 : inventoryTable.foreignKeys.find(fk => fk.columnNames.indexOf('vendorId') !== -1);
...
exports.CreateInventoryTables1750000000000 = CreateInventoryTables1750000000000;
//# sourceMappingURL=1750000000000-CreateInventoryTables.js.map