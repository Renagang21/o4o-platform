...
exports.SeedAppSpecificHeaders1825000000000 = void 0;
const TemplatePart_1 = require("../../entities/TemplatePart");
class SeedAppSpecificHeaders1825000000000 {
    async up(queryRunner) {
        const templatePartRepository = queryRunner.manager.getRepository(TemplatePart_1.TemplatePart);
        // ============================================
    ...
    async down(queryRunner) {
        await queryRunner.query(`DELETE FROM template_parts WHERE slug IN ('header-main', 'header-shop', 'header-funding')`);
    }
}
exports.SeedAppSpecificHeaders1825000000000 = SeedAppSpecificHeaders1825000000000;
//# sourceMappingURL=1825000000000-SeedAppSpecificHeaders.js.map