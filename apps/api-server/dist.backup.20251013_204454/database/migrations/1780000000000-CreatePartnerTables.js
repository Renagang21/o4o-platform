...
exports.CreatePartnerTables1780000000000 = void 0;
const typeorm_1 = require("typeorm");
class CreatePartnerTables1780000000000 {
    async up(queryRunner) {
        ...
        // Create indexes
        await queryRunner.createIndex('partner_users', new typeorm_1.TableIndex({
        ...
        await queryRunner.createIndex('partner_clicks', new typeorm_1.TableIndex({
        ...
        await queryRunner.createIndex('partner_conversions', new typeorm_1.TableIndex({
        ...
        await queryRunner.createIndex('partner_commissions', new typeorm_1.TableIndex({
        ...
        await queryRunner.createIndex('partner_payouts', new typeorm_1.TableIndex({
        ...
        await queryRunner.createIndex('partner_sessions', new typeorm_1.TableIndex({
        ...
        await queryRunner.createIndex('partner_notifications', new typeorm_1.TableIndex({
        ...
        await queryRunner.createIndex('partner_analytics_cache', new typeorm_1.TableIndex({
        ...
        await queryRunner.createIndex('partner_audit_logs', new typeorm_1.TableIndex({
        ...
        // Create foreign keys
        await queryRunner.createForeignKey('partner_users', new typeorm_1.TableForeignKey({
            columnNames: ['userId'],
            referencedColumnNames: ['id'],
            referencedTableName: 'users',
            onDelete: 'CASCADE'
        }));
        await queryRunner.createForeignKey('partner_clicks', new typeorm_1.TableForeignKey({
            columnNames: ['partnerUserId'],
            referencedColumnNames: ['id'],
            referencedTableName: 'partner_users',
            onDelete: 'CASCADE'
        }));
        await queryRunner.createForeignKey('partner_conversions', new typeorm_1.TableForeignKey({
            columnNames: ['partnerUserId'],
            referencedColumnNames: ['id'],
            referencedTableName: 'partner_users',
            onDelete: 'CASCADE'
        ...
        await queryRunner.createForeignKey('partner_commissions', new typeorm_1.TableForeignKey({
            columnNames: ['partnerUserId'],
            referencedColumnNames: ['id'],
            referencedTableName: 'partner_users'
        }));
        ...
        await queryRunner.createForeignKey('partner_payouts', new typeorm_1.TableForeignKey({
            columnNames: ['partnerUserId'],
            referencedColumnNames: ['id'],
            referencedTableName: 'partner_users'
        }));
        await queryRunner.createForeignKey('partner_sessions', new typeorm_1.TableForeignKey({
            columnNames: ['partnerUserId'],
            referencedColumnNames: ['id'],
            referencedTableName: 'partner_users'
        }));
        await queryRunner.createForeignKey('partner_notifications', new typeorm_1.TableForeignKey({
            columnNames: ['partnerUserId'],
            referencedColumnNames: ['id'],
            referencedTableName: 'partner_users'
        }));
...
exports.CreatePartnerTables1780000000000 = CreatePartnerTables1780000000000;
//# sourceMappingURL=1780000000000-CreatePartnerTables.js.map