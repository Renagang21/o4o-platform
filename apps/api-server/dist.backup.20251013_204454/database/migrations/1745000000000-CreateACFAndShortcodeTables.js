...
exports.CreateACFAndShortcodeTables1745000000000 = void 0;
const typeorm_1 = require("typeorm");
class CreateACFAndShortcodeTables1745000000000 {
    async up(queryRunner) {
        ...
        // Create indexes
        await queryRunner.createIndex('shortcodes', new typeorm_1.TableIndex({
        ...
        await queryRunner.createIndex('custom_field_values', new typeorm_1.TableIndex({
            name: 'IDX_custom_field_values_entity',
            columnNames: ['entityType', 'entityId']
        }));
        await queryRunner.createIndex('custom_post_types', new typeorm_1.TableIndex({
...
exports.CreateACFAndShortcodeTables1745000000000 = CreateACFAndShortcodeTables1745000000000;
//# sourceMappingURL=1745000000000-CreateACFAndShortcodeTables.js.map