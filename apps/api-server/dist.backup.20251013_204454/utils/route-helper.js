...
exports.extractRouteParams = exports.validateRoutePath = exports.API_ROUTES = exports.RouteHelper = void 0;
class RouteHelper {
    /**
     * 버전이 있는 API 경로 생성
     */
    static versioned(path) {
     ...
     * 라우트 그룹 생성 헬퍼
     */
    static createRouteGroup(basePath) {
        return {
            // 버전이 있는 경로
...
// API 버전
RouteHelper.API_VERSION = 'v1';
// Base paths
RouteHelper.BASE_PATH = '/api';
RouteHelper.VERSIONED_PATH = `/api/${RouteHelper.API_VERSION}`;
/**
 * 표준 API 경로 정의
 */
exports.API_ROUTES = {
