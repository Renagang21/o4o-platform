...
exports.CreatePostsTable1738500000001 = void 0;
const typeorm_1 = require("typeorm");
class CreatePostsTable1738500000001 {
    constructor() {
        this.name = 'CreatePostsTable1738500000001';
    }
    async up(queryRunner) {
        ...
        await queryRunner.createIndex("posts", new typeorm_1.TableIndex({ name: "IDX_posts_slug", columnNames: ["slug"] }));
        await queryRunner.createIndex("posts", new typeorm_1.TableIndex({ name: "IDX_posts_status", columnNames: ["status"] }));
        await queryRunner.createIndex("posts", new typeorm_1.TableIndex({ name: "IDX_posts_publishedAt", columnNames: ["published_at"] }));
        await queryRunner.createIndex("posts", new typeorm_1.TableIndex({ name: "IDX_posts_authorId", columnNames: ["author_id"] }));
        await queryRunner.createIndex("posts", new typeorm_1.TableIndex({ name: "IDX_posts_featured", columnNames: ["featured"] }));
        await queryRunner.createIndex("posts", new typeorm_1.TableIndex({ name: "IDX_posts_sticky", columnNames: ["sticky"] }));
        await queryRunner.createIndex("post_categories", new typeorm_1.TableIndex({ name: "IDX_post_categories_postId", columnNames: ["postId"] }));
        await queryRunner.createIndex("post_categories", new typeorm_1.TableIndex({ name: "IDX_post_categories_categoryId", columnNames: ["categoryId"] }));
...
exports.CreatePostsTable1738500000001 = CreatePostsTable1738500000001;
//# sourceMappingURL=1738500000001-CreatePostsTable.js.map