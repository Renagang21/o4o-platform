...
__decorate([
    (0, typeorm_1.Column)({
        type: 'enum',
        enum: account_linking_1.LinkingStatus,
        default: account_linking_1.LinkingStatus.PENDING
    }),
    __metadata("design:type", String)
...
exports.LinkingSession = LinkingSession = __decorate([
    (0, typeorm_1.Entity)('linking_sessions'),
    (0, typeorm_1.Index)(['userId', 'status']),
    (0, typeorm_1.Index)(['verificationToken'], { unique: true })
], LinkingSession);
