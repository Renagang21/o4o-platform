...
exports.setupGracefulShutdown = exports.setupProductionMiddleware = exports.monitoringConfig = exports.performanceConfig = exports.securityConfig = exports.rateLimitConfig = void 0;
...
exports.rateLimitConfig = {
    ...
    financial: (0, express_rate_limit_1.default)({
...
exports.securityConfig = {
    ...
    cors: {
        origin: ((_a = process.env.FRONTEND_URLS) === null || _a === void 0 ? void 0 : _a.split(',')) || ['http://localhost:5173', 'http://localhost:5174'],
        credentials: true,
...
const setupProductionMiddleware = (app) => {
    ...
    app.use(exports.securityConfig.compression);
    // Performance monitoring
    app.use(performance_middleware_1.performanceMiddleware);
    // Rate limiting
    app.use('/api/auth', exports.rateLimitConfig.auth);
    app.use('/api/webhooks', exports.rateLimitConfig.webhook);
    app.use('/api/vendors/*/commission', exports.rateLimitConfig.financial);
    app.use('/api/suppliers/*/settlement', exports.rateLimitConfig.financial);
    app.use('/api/admin', exports.rateLimitConfig.financial);
    app.use('/api', exports.rateLimitConfig.general);
    ...
    if (process.env.NODE_ENV === 'development' || process.env.ENABLE_DOCS === 'true') {
        app.use('/api-docs', swagger_config_1.swaggerUi.serve);
        app.get('/api-docs', swagger_config_1.swaggerUi.setup(swagger_config_1.specs, {
            explorer: true,
...
exports.setupProductionMiddleware = setupProductionMiddleware;
...
const config = {
    ...
    setupProductionMiddleware: exports.setupProductionMiddleware,
    setupGracefulShutdown: exports.setupGracefulShutdown,
};
