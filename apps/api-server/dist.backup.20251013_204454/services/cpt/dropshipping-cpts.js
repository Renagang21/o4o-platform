...
exports.registerDropshippingCPTs = exports.DROPSHIPPING_CPT_DEFINITIONS = void 0;
const CustomPostType_1 = require("../../entities/CustomPostType");
const connection_1 = require("../../database/connection");
const logger_1 = __importDefault(require("../../utils/logger"));
exports.DROPSHIPPING_CPT_DEFINITIONS = [
    {
        name: 'ds_supplier',
        label: '공급자',
        singular_label: '공급자',
...
async function registerDropshippingCPTs() {
    const cptRepository = connection_1.AppDataSource.getRepository(CustomPostType_1.CustomPostType);
    for (const cptDef of exports.DROPSHIPPING_CPT_DEFINITIONS) {
        ...
        if (!existing) {
            ...
            logger_1.default.info(`Registered CPT: ${cptDef.name}`);
        }
        else {
            logger_1.default.info(`CPT already exists: ${cptDef.name}`);
        }
    }
}
exports.registerDropshippingCPTs = registerDropshippingCPTs;
//# sourceMappingURL=dropshipping-cpts.js.map