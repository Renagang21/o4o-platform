...
// 현재 이메일 설정 가져오기
router.get('/email', auth_middleware_1.authenticate, permission_middleware_1.requireAdmin, async (req, res) => {
    try {
...
// 이메일 설정 업데이트
router.put('/email', auth_middleware_1.authenticate, permission_middleware_1.requireAdmin, async (req, res) => {
    try {
...
// 테스트 이메일 발송
router.post('/email/test', auth_middleware_1.authenticate, permission_middleware_1.requireAdmin, async (req, res) => {
    try {
