// WO-O4O-UNIFIED-STORE-WORKSPACE-FOUNDATION-V1 §8 Phase 2 — KPA canonical 내 매장 화면(Tailwind 토큰) 조립. KPA tailwind.config 와 동일 토큰.
...
export default {
  content: [
    ...
    "../../packages/store-products-ui/src/**/*.{ts,tsx}",
    "../../packages/store-asset-policy-core/src/**/*.{ts,tsx}",
  ...
  theme: {
    extend: {
      colors: {
        ...
        // Primary 색상 (KPA Society Blue 테마)
        primary: {
          50: '#eff6ff',
          100: '#dbeafe',
          200: '#bfdbfe',
          300: '#93c5fd',
          400: '#60a5fa',
          500: '#3b82f6',  // --color-primary-light
          600: '#2563eb',  // --color-primary (기본값)
          700: '#1d4ed8',  // --color-primary-dark
          800: '#1e40af',
          900: '#1e3a8a',  // --color-primary-darker
