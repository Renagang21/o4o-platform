...
const ENTRY_PATH = '/work/kpa-society/sales-channels/foreign-visitor';
const PARTNERS_PATH = '/work/kpa-society/sales-channels/foreign-visitor/partners';
...
export function ForeignVisitorPartnerQrCodesPage() {
  ...
  useEffect(() => {
    checkSubscription({ serviceKey: getActiveServiceShortKey(), planCode: PLAN_CODE }).then((r) => setEntitled(r.active)).catch(() => setEntitled(false));
