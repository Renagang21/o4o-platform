...
export function ForeignVisitorPartnersPage() {
  ...
  useEffect(() => {
    checkSubscription({ serviceKey: getActiveServiceShortKey(), planCode: PLAN_CODE })
                ...
                <tr key={p.id} className="border-b border-slate-50 last:border-0 hover:bg-slate-50/40">
                  ...
                  <td className="px-3 py-2.5">
                    <div className="flex items-center justify-end gap-1.5">
                      <button
                        type="button"
                        onClick={() => navigate(`/work/kpa-society/sales-channels/foreign-visitor/partners/${p.id}/qr-codes`)}
