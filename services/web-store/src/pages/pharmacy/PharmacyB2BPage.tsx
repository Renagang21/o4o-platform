...
export function PharmacyB2BPage() {
  ...
  const handleAddToWorktable = useCallback(() => {
    ...
    navigate('/work/kpa-society/commerce/order-worktable');
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.productNav}>
        ...
        <Link to="/work/kpa-society/commerce/products" style={styles.productNavActive}>B2B 구매</Link>
        <Link to="/work/kpa-society/commerce/products/b2c" style={styles.productNavLink}>진열 관리</Link>
      </div>
