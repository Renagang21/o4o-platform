  ...
  if (liveSignals) {
    if (liveSignals.newOrders > 0) {
      signalItems.push({
        ...
        to: '/work/kpa-society/commerce/orders',
      });
    }
    ...
    if (liveSignals.pendingSalesRequests > 0) {
      signalItems.push({
        ...
        to: '/work/kpa-society/commerce/products',
      });
    }
  }
              ...
              <div className="py-3">
                ...
                <StoreHomeShortcutGrid
                  ...
                  items={[
                    ...
                    { to: '/work/kpa-society/online-sales/settings', label: '판매 설정', icon: <Settings size={16} className="text-emerald-600" /> },
                  ]}
                />
              </div>
