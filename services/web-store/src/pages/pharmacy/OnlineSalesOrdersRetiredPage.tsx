 ...
 *
 *   구매(발주) 내역은 `/work/kpa-society/commerce/orders` (buyerId 축) 에서 계속 확인한다.
 */
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-16 text-center">
      ...
      <div className="mt-8 flex flex-col items-center gap-2 text-sm">
        <Link to="/work/kpa-society/commerce/orders" className="font-medium text-blue-600">
          공급자에게 발주한 내역 보기 →
        </Link>
        <Link to="/work/kpa-society/sales-channels" className="font-medium text-blue-600">
          외부 판매채널 연동 관리 →
        </Link>
      </div>
    </div>
