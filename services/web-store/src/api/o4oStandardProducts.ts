...
// WO-O4O-TABLET-ADDITIONAL-CONTENT-SKU-DISTINGUISHABILITY-V1: 태블릿 추가정보 모달과 공통 사용 →
//   buildProductVariantLabel 을 utils/productVariantLabel 로 이동하고 여기서는 재-export(기존 소비처 무변경).
