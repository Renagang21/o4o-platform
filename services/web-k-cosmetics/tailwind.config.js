  ...
  theme: {
    extend: {
      colors: {
        ...
        // Primary 색상 (K-Cosmetics Pink/Rose 테마)
        primary: {
          50: '#fdf2f8',
          100: '#fce7f3',
          200: '#fbcfe8',
          300: '#f9a8d4',
          400: '#f472b6',
          500: '#ec4899',  // --color-primary-light
          600: '#db2777',  // --color-primary (기본값)
          700: '#be185d',  // --color-primary-dark
          800: '#9d174d',  // --color-primary-darker
          900: '#831843',
