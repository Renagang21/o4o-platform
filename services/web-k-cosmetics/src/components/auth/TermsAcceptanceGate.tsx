/**
 * TermsAcceptanceGate — K-Cosmetics 기존 회원 이용약관 재동의 게이트
 *
 ...
 * 세션의 pendingPolicyAcceptances 가 비어 있지 않으면(공개 /terms · /privacy 제외) 서비스 화면 대신
 * 재동의 화면을 그린다. 서버 게이트(428)가 최종 방어선이다.
 */
