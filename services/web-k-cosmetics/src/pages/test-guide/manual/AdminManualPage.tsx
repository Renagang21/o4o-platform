...
export default function AdminManualPage() {
  ...
  // 권한 체크: admin만 접근 가능
  if (!isAuthenticated || user?.currentRole !== 'admin') {
    return <Navigate to="/test-guide" replace />;
  }

  return (
    <TestGuideLayout title="운영자 매뉴얼" subtitle="K-Cosmetics 플랫폼 관리 가이드 (내부용)">
      {/* 내부용 경고 */}
      ...
      <section style={styles.section}>
        ...
        <p style={styles.text}>
          운영자는 K-Cosmetics <strong>플랫폼 전체를 관리</strong>하는 역할입니다.
          사용자 관리, 상품 승인, 주문 모니터링, 정산 관리를 담당합니다.
        </p>
      </section>
      ...
      <section style={styles.section}>
        ...
        <p style={styles.text}>
          ...
          전체 주문 현황, 신규 가입자, 문의 현황, 시스템 상태를 한눈에 확인할 수 있습니다.
        </p>
      </section>
        ...
        <div style={styles.featureList}>
          <div style={styles.featureItem}>
            ...
            <div>
              ...
              <p style={styles.featureDesc}>판매자, 공급자 계정을 승인하고 역할을 부여합니다.</p>
            </div>
          </div>
          <div style={styles.featureItem}>
            ...
            <div>
              <strong>상품 승인</strong>
              <p style={styles.featureDesc}>등록된 상품을 검토하고 노출을 승인합니다.</p>
            </div>
          </div>
          <div style={styles.featureItem}>
            <span style={styles.featureNumber}>3</span>
            <div>
              <strong>주문 모니터링</strong>
              <p style={styles.featureDesc}>전체 주문 흐름을 모니터링하고 이슈를 처리합니다.</p>
            </div>
          </div>
        </div>
      </section>
