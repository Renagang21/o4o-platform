/**
 * SupplierManualPage - 공급자/파트너 역할 매뉴얼
...
export default function SupplierManualPage() {
  return (
    <TestGuideLayout title="공급자 매뉴얼" subtitle="K-Cosmetics 공급 관리 가이드">
      {/* 이 역할은 무엇을 하는가 */}
      <section style={styles.section}>
        <h2 style={styles.sectionTitle}>공급자는 무엇을 하나요?</h2>
        <p style={styles.text}>
          공급자는 K-Cosmetics에 <strong>화장품을 공급</strong>하는 역할입니다.
          직접 소비자에게 판매하지 않고, 플랫폼과 판매자에게 상품을 제공합니다.
        </p>
        <div style={styles.highlight}>
          공급자는 직접 판매가 아닙니다. Neture 플랫폼을 통해 판매자와 연결됩니다.
        </div>
      </section>
      ...
      <section style={styles.section}>
        ...
        <p style={styles.text}>
          ...
          공급 상품 현황, 발주 요청, 출고 현황을 확인할 수 있습니다.
        </p>
      </section>
      ...
      <section style={styles.section}>
        ...
        <div style={styles.featureList}>
          <div style={styles.featureItem}>
            ...
            <div>
              <strong>상품 등록</strong>
              <p style={styles.featureDesc}>공급 가능한 화장품을 등록하고 공급가를 설정합니다.</p>
            </div>
          </div>
          <div style={styles.featureItem}>
            ...
            <div>
              <strong>발주 확인</strong>
              <p style={styles.featureDesc}>판매자 또는 플랫폼에서 요청한 발주를 확인합니다.</p>
            </div>
          </div>
          <div style={styles.featureItem}>
            ...
            <div>
              <strong>출고 처리</strong>
              <p style={styles.featureDesc}>발주 요청에 따라 상품을 출고 처리합니다.</p>
            </div>
          </div>
        </div>
      </section>
