          ...
          <div className="relative bg-white rounded-2xl shadow-xl w-full max-w-md mx-4 p-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input type="text" className="w-full px-4 py-2 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-pink-500" placeholder="이벤트 이름" />
              </div>
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-1">시작일</label>
                  <input type="date" className="w-full px-4 py-2 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-pink-500" />
                </div>
                <div>
              ...
              <div>
                ...
                <select className="w-full px-4 py-2 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-pink-500">
                  <option>서울 전체</option>
            ...
            <div className="flex gap-3 mt-6">
              ...
              <button className="flex-1 px-4 py-2 bg-pink-600 text-white rounded-xl hover:bg-pink-700">추가</button>
            </div>
          </div>
        </div>
      )}
