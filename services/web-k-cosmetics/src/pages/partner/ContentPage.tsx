...
const mockContents: PartnerContent[] = [
  {
    ...
    type: 'text',
    title: '신제품 스킨케어 안내',
    description: '봄철 피부관리에 도움이 되는 새로운 제품을 소개합니다.',
    status: 'active',
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-white rounded-2xl shadow-xl w-full max-w-md mx-4 p-6">
                ...
                <div className="grid grid-cols-3 gap-2">
                  {Object.entries(typeConfig).map(([type, config]) => {
                    ...
                    return (
                      <button
                        key={type}
                        className="p-3 border rounded-xl hover:border-pink-300 hover:bg-pink-50 transition-colors"
                      >
            ...
            <div className="flex gap-3 mt-6">
              ...
              <button className="flex-1 px-4 py-2 bg-pink-600 text-white rounded-xl hover:bg-pink-700">
                추가
              </button>
            </div>
          </div>
