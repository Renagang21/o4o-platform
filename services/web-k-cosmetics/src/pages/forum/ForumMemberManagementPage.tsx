                      ...
                      {rejectingId === req.id ? (
                        ...
                        <div className="flex items-center gap-2 shrink-0 ml-3">
                          <button
                            ...
                            disabled={actionLoading === req.id}
                            className="px-3 py-1.5 text-sm font-medium text-white bg-pink-600 rounded-lg hover:bg-pink-700 transition-colors disabled:opacity-50 flex items-center gap-1"
                          >
