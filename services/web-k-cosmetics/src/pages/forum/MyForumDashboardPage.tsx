 ...
 * GlycoPharm MyForumDashboardPage 패턴 복제 — K-Cosmetics
 */
    ...
    <div className="max-w-4xl mx-auto py-8 px-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
        <Link
          ...
          className="flex items-center gap-3 p-4 bg-pink-50 border border-pink-200 rounded-xl hover:bg-pink-100 transition-colors"
        >
          <div className="w-10 h-10 rounded-lg bg-pink-100 flex items-center justify-center">
            <MessageSquarePlus className="w-5 h-5 text-pink-700" />
          </div>
          <div>
            <div className="font-semibold text-pink-800">포럼 개설 신청</div>
            <div className="text-sm text-pink-600">새로운 포럼을 요청합니다</div>
          </div>
        </Link>
      ...
      <div className="mb-8">
        ...
        {error && (
          <div className="bg-white rounded-xl border border-slate-200 p-8 text-center">
            ...
            <button onClick={loadRequests} className="mt-3 px-4 py-2 text-sm bg-pink-600 text-white rounded-lg hover:bg-pink-700 transition-colors">
              다시 시도
            </button>
          </div>
        )}
        ...
        {!isLoading && !error && requests.length === 0 && (
          <div className="bg-white rounded-xl border border-slate-200 p-8 text-center">
            ...
            <Link
              to="/forum/request-category"
              className="inline-flex items-center gap-2 mt-4 px-4 py-2 bg-pink-600 text-white rounded-lg hover:bg-pink-700 transition-colors text-sm"
            >
          ...
          <div className="relative bg-white rounded-2xl shadow-xl w-full max-w-md p-6 space-y-5">
            ...
            <div>
              ...
              <textarea value={editForm.description} onChange={(e) => setEditForm({ ...editForm, description: e.target.value })} rows={3}
                className="w-full px-3 py-2 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent text-sm resize-none" />
            </div>
            <div>
            ...
            <div className="flex gap-3 pt-2">
              ...
              <button onClick={handleSaveEdit} disabled={editSaving} className="flex-1 px-4 py-2.5 text-white bg-pink-600 rounded-lg hover:bg-pink-700 transition-colors text-sm font-medium disabled:opacity-50 flex items-center justify-center gap-2">
