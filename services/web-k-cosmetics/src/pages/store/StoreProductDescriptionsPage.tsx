...
import { fetchLocalProducts, type LocalProduct } from '@/services/localProductApi';
import {
              ...
              <div style={styles.aiBanner}>
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={styles.aiBannerDesc}>
                    {selectedTemplate
                      ? `${selectedTemplate.name} 스타일로 AI가 매장 상품설명 초안을 작성합니다.`
                      : '자료를 기반으로 AI가 매장 상품설명 초안을 작성합니다.'}
