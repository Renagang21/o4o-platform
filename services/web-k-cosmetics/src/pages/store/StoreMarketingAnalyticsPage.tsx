 ...
 *
 * KPA MarketingAnalyticsPage 기반 이식.
 * QR 스캔 KPI + TOP QR + 디바이스 분포 + 일별 추이.
 * serviceKey: cosmetics (k-cosmetics)
 */
...
// Color palette (inline — K-Cosmetics does not share KPA styles/theme)
const c = {
  primary:    '#0ea5e9',
  neutral50:  '#f9fafb',
  neutral100: '#f3f4f6',
...
export function StoreMarketingAnalyticsPage() {
  ...
  if (!data) {
    return (
      <div style={styles.container}>
        <div style={styles.loadingState}>
          <BarChart3 size={48} style={{ color: c.neutral300 }} />
    ...
    <div style={styles.container}>
      ...
      <div style={styles.header}>
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' }}>
            <Link to="/store" style={{ color: c.neutral400, fontSize: '13px', textDecoration: 'none' }}>
              매장 실행
            </Link>
            <span style={{ color: c.neutral300 }}>/</span>
            <span style={{ color: c.neutral600, fontSize: '13px' }}>마케팅 분석</span>
          </div>
      ...
      <div style={styles.kpiGrid}>
        <div style={styles.kpiCard}>
          <TrendingUp size={20} style={{ color: c.primary, marginBottom: '8px' }} />
