...
const playbackApi: SignagePlaybackApi = {
  ...
  fetchPublicPlaylist: (playlistId) =>
    publicContentApi.getPlaylist(playlistId, SERVICE_KEY) as any,
};
...
export default function SignagePlaybackPage() {
  return (
    <SignagePlaybackView
      api={playbackApi}
      fullscreenButtonClassName="flex items-center justify-center gap-2 w-full px-5 py-3.5 bg-pink-600 hover:bg-pink-500 text-white rounded-xl text-sm font-semibold transition-colors"
    />
  );
}
