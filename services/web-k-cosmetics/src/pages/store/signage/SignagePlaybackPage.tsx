/**
 * SignagePlaybackPage — K-Cosmetics
 * WO-O4O-KCOSMETICS-SIGNAGE-PLAYER-V1
 *
 * /store/marketing/signage/play/:playlistId
 * 단일 Playlist fullscreen 루프 재생
 *
 * Adapted from GlycoPharm SignagePlaybackPage:
 *   재생 시작 전 "전체화면으로 재생 / 일반 화면으로 재생" 선택 화면 포함.
  ...
  useEffect(() => {
    ...
    api.get(`${SIGNAGE_BASE}/playlists/${playlistId}`)
      ...
      .catch(() =>
        ...
        publicContentApi.getPlaylist(playlistId, SERVICE_KEY).then((res) => {
          ...
          <div className="text-center max-w-sm w-full px-6">
            ...
            <div className="flex flex-col gap-3">
              <button
                ...
                className="flex items-center justify-center gap-2 w-full px-5 py-3.5 bg-pink-600 hover:bg-pink-500 text-white rounded-xl text-sm font-semibold transition-colors"
              >
