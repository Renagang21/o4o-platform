/**
 * ProductPopBuilderPage — K-Cosmetics legacy compatibility route (은퇴)
 *
 ...
 *
 * 현재 역할:
 *   북마크·기존 내부 링크 보호용 legacy route. canonical POP 제작 화면(/store/marketing/pop)으로
 *   1홉 replace 수렴한다. source identity(store_local_products.id + origin='local')만 전달하고
 *   상품 정보는 canonical 화면이 organization-scoped API 로 다시 조회한다.
 */
