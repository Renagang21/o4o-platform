/**
 * K-Cosmetics LMS — 공통 View adapter
 *
 ...
 * K-Cosmetics `lmsApi` / `aiApi`(axios 래퍼) 위에 구현한다.
 *
 * K-Cosmetics 정책 유지:
 *  - 어휘는 기본(강의/레슨)
 *  - 수료증 화면 미제공 → `onCertificateUnavailable` 로 '준비 중' 안내
 *  - accent = 브랜드 pink
 */
...
export const KCOS_LMS_ACCENT = '#db2777';
export const KCOS_LMS_HUB_PATH = '/lms';

export const kcosLmsLabels: LmsViewLabels = createLmsLabels({
  enrolledMessage: '수강 등록이 완료되었습니다.',
  enrollFailedMessage: '수강 등록에 실패했습니다.',
...
export const kcosLmsPort: LmsLearnerPort = {
