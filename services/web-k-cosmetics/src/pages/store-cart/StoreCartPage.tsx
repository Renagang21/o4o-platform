/**
 * StoreCartPage — 내 장바구니 (K-Cosmetics)
 *
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-xl border border-slate-100 text-center py-16 text-slate-500">
          ...
          <button
            ...
            className="mt-4 px-4 py-2 text-sm font-semibold rounded-lg bg-pink-600 text-white hover:bg-pink-700"
          >
            이벤트 상품 보기
          </button>
        </div>
          ...
          <div className="bg-white rounded-xl border border-slate-100 p-5">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="px-6 py-3 text-sm font-semibold rounded-lg bg-pink-600 text-white hover:bg-pink-700 disabled:opacity-60"
              >
