/**
 * K-Cosmetics Admin — 서비스 설정(법정정보·약관) wrapper
 *
 * WO-O4O-GP-KCOS-SERVICE-LEGAL-POLICY-SETTINGS-UI-ROLLOUT-V1
 *
 * Neture 에서 검증된 공통 컴포넌트 `@o4o/operator-core-ui/modules/service-legal` 에
 * serviceKey('k-cosmetics' — canonical service_key) + authClient 기반 api 어댑터를 주입한다.
 * (role prefix 는 'cosmetics' 이나 backend admin API path 는 canonical 'k-cosmetics' 사용.)
