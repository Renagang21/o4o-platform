        ...
        {([
          ...
          <button
            ...
            style={{
              ...
              color: tab === key ? '#DB2777' : '#64748b',
              borderBottom: tab === key ? '2px solid #DB2777' : '2px solid transparent',
      ...
      <div style={{ display: 'flex', justifyContent: 'flex-end', marginBottom: 16 }}>
        <button
          ...
          style={{
            ...
            color: 'white', backgroundColor: '#DB2777',
        ...
        <tbody>
          {sponsors.map((s) => (
            <tr key={s.id} style={{ borderTop: '1px solid #e2e8f0' }}>
              ...
              <td style={tdStyle}>
                {s.linkUrl ? (
                  <a href={s.linkUrl} target="_blank" rel="noopener noreferrer" style={{ color: '#DB2777', fontSize: 12 }}>링크</a>
                ) : '-'}
              </td>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            ...
            style={{
              ...
              color: 'white', backgroundColor: saving ? '#94a3b8' : '#DB2777',
