...
export default function UsersPage() {
  ...
  const fetchUsers = useCallback(async (page = 1) => {
    ...
    try {
      ...
      params.set('serviceKey', 'k-cosmetics');
  ...
  const fetchStats = useCallback(async () => {
    try {
      ...
      const data = await apiFetch<any>('/api/v1/operator/members/stats?serviceKey=k-cosmetics');
      ...
      const allData = await apiFetch<any>('/api/v1/operator/members?limit=1000&serviceKey=k-cosmetics');
