/**
 * Centralized API Client — K-Cosmetics
...
// WO-O4O-LECTURE-INDEPENDENT-SERVICE-SEPARATION-V1 Phase 2 §14:
// K-Cosmetics 는 generic `/api/v1/lms/*` 소비처 0 — LMS serviceKey 부착 interceptor 제거
// (구 WO-O4O-LMS-CROSSSERVICE-READ-WRITE-BOUNDARY-COMPLETION-V1 의 LMS_SERVICE_KEY='k-cosmetics').
