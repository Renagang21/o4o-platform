/**
 * StorePopV2Page (Pharmacy-Hub adapter) — WO-O4O-STORE-POP-V2-CANONICAL-REBUILD-KPA-PH-V1
 *
 * 화면 본체는 `@o4o/store-ui-core` 의 공통 POP V2 Core 다.
 * KPA adapter 와 **같은 컴포넌트**를 쓰고, accent / 템플릿 / notify / api 만 다르게 주입한다.
 * 서비스별 본체 복제 없음.
 *
 * 기존 `PopPage`(/store-owner/pop, 원장 store_pops) 는 그대로 둔다.
...
import { popV2Api } from '../../lib/api/popV2';

const ACCENT = { color: '#0d9488', softBg: '#f0fdfa' };
