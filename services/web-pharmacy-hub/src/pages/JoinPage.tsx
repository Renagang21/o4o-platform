      ...
      <form onSubmit={onSubmit} className="space-y-3 rounded-lg border border-gray-200 bg-white p-5">
          ...
          {roleType === 'store_owner' && (
            <div className="space-y-3 rounded border border-gray-200 p-3">
              <label className="block text-sm">
                약국명
                <input value={form.businessName} onChange={set('businessName')} required className="mt-1 w-full rounded border border-gray-300 px-3 py-2" />
              </label>
              <label className="block text-sm">
                대표자명
                <input value={form.representativeName} onChange={set('representativeName')} required className="mt-1 w-full rounded border border-gray-300 px-3 py-2" />
              </label>
              <label className="block text-sm">
                사업자등록번호
                <input value={form.businessNumber} onChange={set('businessNumber')} required className="mt-1 w-full rounded border border-gray-300 px-3 py-2" />
              </label>
              <label className="block text-sm">
                사업장 주소
                <input value={form.businessAddress} onChange={set('businessAddress')} required className="mt-1 w-full rounded border border-gray-300 px-3 py-2" />
              </label>
              <label className="block text-sm">
                사업장 연락처
                <input value={form.businessPhone} onChange={set('businessPhone')} required className="mt-1 w-full rounded border border-gray-300 px-3 py-2" />
              </label>
            </div>
          )}
