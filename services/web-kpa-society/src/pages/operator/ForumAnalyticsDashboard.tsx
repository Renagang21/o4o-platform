/**
 * ForumAnalyticsDashboard - 포럼 운영 분석
 *
...
export default function ForumAnalyticsDashboard() {
  ...
  const kpis = summary
    ? [
        ...
        { label: '활성 포럼', value: summary.activeForums, icon: CheckCircle, color: 'text-emerald-600', bg: 'bg-emerald-50' },
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-6">
        ...
        <div className="flex items-center gap-4 mt-4 text-xs text-slate-500">
          <span className="flex items-center gap-1"><span className="w-3 h-3 bg-blue-500 rounded" /> 승인</span>
