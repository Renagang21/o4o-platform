/**
 * ProductPopBuilderPage — 상품 POP 만들기 (AI 자동 주입 + 편집 + PDF 생성)
 *
    ...
    (async () => {
      try {
        ...
        if (res.success && Array.isArray(res.data)) {
          for (const c of res.data) map.set(c.contentType, c.content);
        }
        ...
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' }}>
            <Link
              ...
              style={{ color: colors.neutral400, fontSize: '13px', textDecoration: 'none' }}
            >
              마케팅 자산
            </Link>
            <span style={{ color: colors.neutral300 }}>/</span>
            <span style={{ color: colors.neutral600, fontSize: '13px' }}>POP 만들기</span>
          </div>
