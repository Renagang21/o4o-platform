    ...
    <div style={styles.container}>
      ...
      <header style={styles.header}>
        <div style={styles.headerContent}>
          <Link to="/pharmacy/b2b/suppliers" style={styles.backLink}>← 공급자 목록</Link>
          ...
          <section style={styles.card}>
            ...
            <div style={styles.categoryGrid}>
              {supplier.categories.map((cat) => (
                <Link
                  key={cat.id}
                  to={`/pharmacy/b2b/suppliers/${supplierId}/products?category=${cat.id}`}
            ...
            <Link
              to={`/pharmacy/b2b/suppliers/${supplierId}/products`}
        ...
        <div style={styles.sidebar}>
            ...
            <section style={styles.sideCard}>
              ...
              {supplier.activeGroupbuys.map((gb) => (
                <div key={gb.id} style={styles.groupbuyItem}>
                  ...
                  {isOwner ? (
                    <Link
                      to={`/pharmacy/b2b/groupbuy/${gb.id}`}
          ...
          <section style={styles.sideCard}>
            ...
            <div style={styles.actionButtons}>
              ...
              {supplier.tradeTypes.includes('groupbuy') && (
                <Link
                  to={`/pharmacy/b2b/groupbuy?supplier=${supplierId}`}
                  style={styles.actionButton}
                >
                  🛒 공동구매 보기
                </Link>
