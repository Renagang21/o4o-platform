    ...
    return (
      <div className="space-y-4 pt-4">
        ...
        <div className="flex gap-3">
          <Link
            to="/login"
            className="flex-1 py-2.5 text-center text-sm font-medium bg-blue-600 text-white rounded-xl hover:bg-blue-700"
          >
            로그인하기
          </Link>
          <button
    ...
    <form onSubmit={handleSubmit} className="space-y-4 pt-4">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2.5 border border-slate-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
          required
        />
      </div>
      ...
      <button
        ...
        className="w-full py-2.5 text-sm font-medium bg-blue-600 text-white rounded-xl hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed"
      >
