/**
 * ContentLibraryPage — KPA 콘텐츠 라이브러리
 *
 * WO-O4O-CONTENT-FRONTEND-ACTIVATION-V1
 *
 * Route: /library/content
 * API: hubContentApi.list({ serviceKey: 'kpa', sourceDomain: 'cms' })
 */
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        <p style={styles.subtitle}>KPA 콘텐츠를 한눈에 확인하세요</p>
      </div>
      ...
      {loading ? (
        <div style={styles.center}>
          <p style={{ color: colors.neutral400 }}>불러오는 중...</p>
        </div>
      ) : filteredItems.length === 0 ? (
        <div style={styles.center}>
          <span style={{ fontSize: 40, color: '#e2e8f0' }}>📄</span>
          <p style={{ color: colors.neutral400, fontSize: 14, marginTop: 12 }}>등록된 콘텐츠가 없습니다.</p>
        </div>
      ) : (
      ...
      {totalPages > 1 && (
        <div style={styles.pagination}>
          ...
          <span style={{ fontSize: 12, color: colors.neutral500 }}>{page} / {totalPages}</span>
          <button
