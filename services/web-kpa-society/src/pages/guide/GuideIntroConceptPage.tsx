 ...
 */
import { GuideIntroConceptPage as Shared, kpaGuideIntroConceptProps } from '@o4o/shared-space-ui';
...
export function GuideIntroConceptPage() {
  return <Shared {...kpaGuideIntroConceptProps} renderText={renderText} />;
}
