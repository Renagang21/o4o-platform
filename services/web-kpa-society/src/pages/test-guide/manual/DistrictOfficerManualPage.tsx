/**
 * DistrictOfficerManualPage - 지부 임원 역할 매뉴얼
 * WO-ROLE-MANUALS-COPY-V1 기준
 *
 * 지부 임원은 직책만 보유하며 관리 권한은 없습니다.
...
export default function DistrictOfficerManualPage() {
  return (
    <TestGuideLayout title="지부 임원 매뉴얼" subtitle="약사회 SaaS 지부 임원 가이드">
      {/* 이 역할은 무엇을 하는가 */}
      <section style={styles.section}>
        <h2 style={styles.sectionTitle}>지부 임원은 무엇을 하나요?</h2>
        <p style={styles.text}>
          지부 임원은 약사회의 <strong>지부 단위 임원 직책을 가진 회원</strong>입니다.
          일반 회원과 동일한 서비스를 이용하면서, 임원 전용 정보에 접근할 수 있습니다.
        </p>
        <div style={styles.highlight}>
          <strong>참고:</strong> 임원은 "직책"만 있고 관리 "권한"은 없습니다.
          관리 기능이 필요하면 운영자(district_admin)로 문의하세요.
        </div>
      </section>
      ...
      <section style={styles.section}>
        ...
        <div style={styles.featureList}>
          <div style={styles.featureItem}>
            ...
            <div>
              <strong>공지사항 확인</strong>
              <p style={styles.featureDesc}>지부 공지 및 전체 공지를 확인합니다.</p>
            </div>
          </div>
          <div style={styles.featureItem}>
