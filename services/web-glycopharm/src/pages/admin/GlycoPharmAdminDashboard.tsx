 ...
 *   Legacy admin/dashboard 엔드포인트 제거 후 전환.
 *
 * Block 구조:
 ...
 *
 * API: fetchOperatorDashboard() from api/operatorDashboard.ts
 */
...
function buildAdminConfig(data: OperatorDashboardConfig): AdminDashboardConfig {
