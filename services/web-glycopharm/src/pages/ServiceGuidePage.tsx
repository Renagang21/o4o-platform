...
//   @o4o/shared-space-ui 의 copy config(glycopharmServiceIntroProps) 에서 주입한다.
//   문구는 공통화 전과 동일하다.
import { GuideServiceIntroPage, glycopharmServiceIntroProps } from '@o4o/shared-space-ui';

export default function ServiceGuidePage() {
  return <GuideServiceIntroPage {...glycopharmServiceIntroProps} />;
}
