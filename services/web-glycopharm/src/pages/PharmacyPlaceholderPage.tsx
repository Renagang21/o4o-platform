 ...
 * WO-O4O-GLYCOPHARM-PATIENT-SURFACE-REMOVAL-V1:
 *   환자 관련 버튼 및 info 배너 제거
 */

import { useState } from 'react';
import { useAuth } from '@/contexts/AuthContext';
import { useNavigate } from 'react-router-dom';
import { Activity, LogOut, Briefcase, ChevronDown, MessageSquare, LayoutGrid, Store } from 'lucide-react';
