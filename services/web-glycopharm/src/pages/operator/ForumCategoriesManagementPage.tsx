/**
 * ForumCategoriesManagementPage - 포럼 목록 관리 (GlycoPharm)
 *
 ...
 *   기존 공통 backend(/api/v1/forum/operator/categories*, serviceCode=glycopharm)를 그대로 호출하는
...
const SVC = 'serviceCode=glycopharm';
...
export default function ForumCategoriesManagementPage() {
  return <OperatorForumCategoriesPage client={client} tableId="glycopharm-forum-categories" />;
}
