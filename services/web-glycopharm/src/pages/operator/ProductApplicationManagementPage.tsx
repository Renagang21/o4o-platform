/**
 * GlycoPharm Operator — 공급 상품 신청 승인 wrapper
 *
 * WO-O4O-PRODUCT-APPROVAL-OPERATOR-SURFACE-ENABLE-GP-KCOS-V1 (Phase 4)
 *
 * 공통 콘솔 `@o4o/operator-core-ui` ProductApplicationManagementConsole 에 GlycoPharm
 * authClient api 어댑터(serviceKey='glycopharm' 백엔드 격리)를 주입.
 * backend: /api/v1/glycopharm/operator/product-applications (scope glycopharm:operator).
...
const BASE = '/glycopharm/operator/product-applications';
...
export default function ProductApplicationManagementPage() {
  return (
    <ProductApplicationManagementConsole
      ...
      config={{
        title: '공급 상품 신청 승인',
        description: '약국이 공급 상품 카탈로그에서 신청한 상품을 승인하거나 거절합니다.',
        orgLabel: '약국',
        accent: 'teal',
        tableId: 'glycopharm-product-applications',
      }}
    />
  );
}
