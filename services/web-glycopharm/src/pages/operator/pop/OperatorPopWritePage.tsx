/**
 * OperatorPopWritePage — 운영자 약국 HUB POP 작성/수정
 *
 * WO-O4O-GLYCOPHARM-OPERATOR-STORE-HUB-WRITE-CAPABILITY-V1 (2026-05-27)
 *
 * 운영자가 GlycoPharm 약국 HUB 에 게시할 POP 을 RichTextEditor 로 작성·수정.
 * URL 패턴:
 ...
 *   POST   /api/v1/glycopharm/operator/pop/posts
 *   PUT    /api/v1/glycopharm/operator/pop/posts/:id
 *   PATCH  /api/v1/glycopharm/operator/pop/posts/:id/publish
 *
