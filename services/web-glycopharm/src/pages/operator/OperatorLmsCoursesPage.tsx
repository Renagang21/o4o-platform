/**
 * OperatorLmsCoursesPage — GlycoPharm Operator 강의 관리
 *
 * WO-O4O-GLYCOPHARM-LMS-PHASE1-OPERATOR-PARITY-V1
 *
 * K-Cosmetics OperatorLmsCoursesPage 기준 이식.
 * 구조:
 *   - 상단 헤더 + 검색 + 상태 필터
...
const courseActionPolicy = defineActionPolicy<LmsCourse>('glyco:lms:courses', {
  rules: [
    {
      key: 'view',
      label: '상세 보기',
