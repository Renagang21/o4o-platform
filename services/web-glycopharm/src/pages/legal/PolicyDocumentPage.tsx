/**
 * GlycoPharm 공개 정책 문서 페이지 (이용약관 / 개인정보처리방침)
 *
 * WO-O4O-CROSSSERVICE-POLICY-ROUTES-V1
 *
 * 공통 `PolicyDocumentViewer`(@o4o/shared-space-ui)에 serviceKey('glycopharm') +
 * public API loader 를 주입. Admin 에서 게시한 published 문서만 표시(미게시 → 중립 empty).
 * backend: GET /api/v1/public/services/glycopharm/policies/:documentType.
 */
