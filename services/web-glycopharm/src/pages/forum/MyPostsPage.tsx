/**
 * MyPostsPage — GlycoPharm 내가 쓴 글 (/forum/my-posts)
 *
  ...
  return (
    <main className="min-h-screen bg-slate-50 py-8">
      <div className="mx-auto max-w-5xl px-4">
        <button className="mb-2 text-sm text-indigo-600" onClick={() => navigate('/forum')} type="button">
          ← 커뮤니티 홈
        </button>
        <MyForumPostsTemplate
          description="GlycoPharm 커뮤니티에 내가 작성한 글입니다."
          posts={posts}
          totalCount={total}
          currentPage={page}
