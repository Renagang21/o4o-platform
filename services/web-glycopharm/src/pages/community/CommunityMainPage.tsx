      ...
      heroSlot={
        <div style={heroStyles.wrapper} className={`${t.hero.bg} ${t.hero.border} ${t.hero.padding} mb-8 md:mb-16`}>
          <PageContainer>
            ...
            <div style={{ background: '#ffffff', border: '1px solid #a7f3d0', borderRadius: 12, padding: '12px 16px', marginBottom: 20, display: 'flex', alignItems: 'center', gap: 12, flexWrap: 'wrap', justifyContent: 'space-between' }}>
