 ...
 *
 * API: assetSnapshotApi.list({ type: 'content' }) → /glycopharm/assets?type=content (변경 없음)
 */
...
const GLYCOPHARM_PRODUCTION_TARGETS: StartProductionTargetConfig[] = [
  {
    ...
    defaultTemplateId: 'glyco-pop-diabetes-info',
  },
  {
    key: 'qr',
    label: 'QR 코드',
    ...
    supportsTemplates: true,
    defaultTemplateId: 'glyco-qr-glucose-management',
  },
];
...
export default function StoreLibraryContentsPage() {
  ...
  return (
    <StoreLibraryContentsView
      ...
      labels={LABELS}
      productionTargets={GLYCOPHARM_PRODUCTION_TARGETS}
