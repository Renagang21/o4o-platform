/**
 * HubQrLibraryPage — GlycoPharm 약국 HUB QR 진열 + 매장으로 가져오기
 *
...
export function HubQrLibraryPage() {
  ...
  return (
    <HubImportLibraryView
      ...
      accent="blue"
      title="약국 HUB QR"
      description="GlycoPharm 운영자가 발행한 QR 콘텐츠입니다. 선택해 일괄 가져가기 또는 행 클릭으로 단건 가져가기를 할 수 있습니다. 가져온 QR 은 매장 소유이며, 매장 QR 목록에서 자유롭게 관리할 수 있습니다."
      tableId="glyco-store-hub-qr"
      titleIcon={<QrCode className="w-3.5 h-3.5" />}
      labels={{
        ownerLabel: '내 매장',
        producerBadge: '운영자 자료',
        bulkTooltip: '선택한 QR 을 내 매장 QR 로 일괄 가져갑니다',
