/**
 * HubQrLibraryPage — GlycoPharm 매장 HUB QR 진열 (조회 전용)
 *
 * WO-O4O-GLYCOPHARM-HUB-POP-QR-LIBRARY-PAGES-V1
 *
 * KPA HubQrLibraryPage 패턴 mirror. SERVICE_KEY='glycopharm'.
 * - HUB 목록: hubContentApi.list({ serviceKey='glycopharm', sourceDomain='qr' })
 *
 * 가져가기(import) 동작은 본 WO 에서 구현하지 않는다.
 * 후속 P2 (WO-O4O-GLYCOPHARM-HUB-IMPORT-BLOG-POP-QR-V1) 에서:
 *   - getStoreSlug + importOperatorQr wire-up
    ...
    <div className="max-w-7xl mx-auto px-6 py-8">
      <header className="mb-6 pb-5 border-b-2 border-slate-200">
        ...
        <p className="mt-1.5 text-sm text-slate-500">
          GlycoPharm 운영자가 발행한 QR 콘텐츠입니다. 행을 클릭해 상세를 확인할 수 있습니다.
