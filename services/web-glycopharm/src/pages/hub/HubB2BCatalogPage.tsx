/**
 * HubB2BCatalogPage — GlycoPharm Store HUB 상품 카탈로그 (thin wrapper)
 *
 ...
 *   본 파일은 GlycoPharm api client + accent(teal) + tableId + 라벨만 주입하는 wrapper.
 *
 * 선행:
...
export function HubB2BCatalogPage() {
  return (
    <B2BCatalogHub<CatalogProduct>
      ...
      labels={{ supplierLabel: '공급자', channelManageHref: '/store/channels' }}
