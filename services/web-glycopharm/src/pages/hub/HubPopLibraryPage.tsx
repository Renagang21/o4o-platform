/**
 * HubPopLibraryPage — GlycoPharm 매장 HUB POP 진열 + 매장으로 가져오기
 *
 ...
 *
 * KPA HubPopLibraryPage 패턴 동일. SERVICE_KEY='glycopharm'.
    ...
    <div className="max-w-7xl mx-auto px-6 py-8">
      <header className="mb-6 pb-5 border-b-2 border-slate-200">
        ...
        <p className="mt-1.5 text-sm text-slate-500">
          GlycoPharm 운영자가 발행한 POP 콘텐츠입니다. 선택해 일괄 가져가기 또는 행 클릭으로 단건 가져가기를 할 수 있습니다.
