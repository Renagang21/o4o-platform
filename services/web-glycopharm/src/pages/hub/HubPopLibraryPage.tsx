/**
 * HubPopLibraryPage — GlycoPharm 약국 HUB POP 진열 + 매장으로 가져오기
 *
...
export function HubPopLibraryPage() {
  ...
  return (
    <HubImportLibraryView
      ...
      accent="blue"
      title="약국 HUB POP"
      description="GlycoPharm 운영자가 발행한 POP 콘텐츠입니다. 선택해 일괄 가져가기 또는 행 클릭으로 단건 가져가기를 할 수 있습니다. 가져온 POP 은 매장 소유이며, 초안 상태로 복사되어 자유롭게 수정·발행할 수 있습니다."
