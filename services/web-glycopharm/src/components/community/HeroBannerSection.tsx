    ...
    return (
      <section style={styles.defaultHero}>
        <div style={styles.defaultContent}>
          <span style={styles.badge}>GlycoPharm Community</span>
          <h1 style={styles.title}>약국 커뮤니티 허브</h1>
          <p style={styles.subtitle}>포럼, 영상, 자료 모두 한 곳에서</p>
        </div>
      </section>
    );
  }
