...
const defaultConfig: ServiceConfig = {
    ...
    serviceDescription: '혈당관리 전문 B2B 플랫폼. CGM, 혈당 측정기, 건강기능식품을 만나보세요',
    primaryColor: '#22c55e',
};
...
const mockFeedbackPosts: ForumPost[] = [
    { id: '1', title: 'CGM 데이터 연동 속도 개선 요청', author: '혈당관리약사', createdAt: '2026-01-13', commentCount: 3 },
    { id: '2', title: '공급업체 목록 필터 기능 추가 요청', author: '약사김', createdAt: '2026-01-12', commentCount: 1 },
    { id: '3', title: 'Market Trial 신청 프로세스 간소화 요청', author: '건강약국', createdAt: '2026-01-10', commentCount: 5 },
];

const mockUpdatePosts: ForumPost[] = [
    { id: '1', title: 'GlucoseView 연동 기능 업데이트', author: '운영팀', createdAt: '2026-01-14', commentCount: 0 },
    { id: '2', title: 'Market Trial 참여 기능 추가', author: '운영팀', createdAt: '2026-01-11', commentCount: 0 },
    { id: '3', title: '모바일 반응형 개선', author: '운영팀', createdAt: '2026-01-08', commentCount: 0 },
];
