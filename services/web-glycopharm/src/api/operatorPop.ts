/**
 * Operator POP API Client — GlycoPharm Operator HUB POP Write
 *
 * WO-O4O-GLYCOPHARM-OPERATOR-STORE-HUB-WRITE-CAPABILITY-V1 (2026-05-27)
 *
 * 운영자가 GlycoPharm 약국 HUB 에 게시할 POP 콘텐츠를 작성/수정/게시하는 API client.
...
function getApiBase(): string {
  ...
  return `${base}/api/v1/glycopharm/operator/pop`;
}
