/**
 * Operator Blog API Client — GlycoPharm Operator HUB Blog Write
 *
 * WO-O4O-GLYCOPHARM-OPERATOR-STORE-HUB-WRITE-CAPABILITY-V1 (2026-05-27)
 *
 * 운영자가 GlycoPharm 약국 HUB 에 게시할 블로그 콘텐츠를 작성/수정/게시하는 API client.
 * Backend 는 server-side 에서 author_role='operator', service_key='glycopharm', store_id=null 강제.
...
function getApiBase(): string {
  ...
  return `${base}/api/v1/glycopharm/operator/blog`;
}
