 ...
 * WO-O4O-GLYCO-BLOG-INTRODUCE-V1: GlycoPharm 도입 (KPA blogStaff 패턴 verbatim)
 *
 * Calls /api/v1/glycopharm/stores/:slug/blog/staff/* with auth token.
 * Service param defaults to 'glycopharm' for this service.
 */
