    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center py-12 px-4">
        <div className="max-w-md w-full text-center space-y-4">
          ...
          <Link
            to="/forgot-password"
            className="inline-block px-6 py-2.5 text-sm font-medium bg-teal-600 text-white rounded-xl hover:bg-teal-700"
          >
            비밀번호 찾기로 이동
          </Link>
        </div>
    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center py-12 px-4">
        <div className="max-w-md w-full text-center space-y-4">
          ...
          <p className="text-sm text-slate-600">
            새로운 비밀번호로 로그인해주세요. 3초 후 홈으로 이동합니다.
          </p>
          <Link
            to="/"
            className="inline-block px-6 py-2.5 text-sm font-medium bg-teal-600 text-white rounded-xl hover:bg-teal-700"
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-10 py-2.5 border border-slate-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500"
                placeholder="새 비밀번호"
                required
              />
              <button
