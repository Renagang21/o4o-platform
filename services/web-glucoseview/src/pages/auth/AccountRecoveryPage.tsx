...
const SERVICE_URL = import.meta.env.VITE_SERVICE_URL || 'https://glucoseview.co.kr';
    ...
    return (
      <div className="space-y-4 pt-4">
        ...
        <div className="flex gap-3">
          <Link
            to="/"
            className="flex-1 py-2.5 text-center text-sm font-medium bg-teal-600 text-white rounded-xl hover:bg-teal-700"
          >
            로그인하기
          </Link>
          <button
    ...
    <form onSubmit={handleSubmit} className="space-y-4 pt-4">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2.5 border border-slate-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500"
          required
        />
      </div>
      ...
      <button
        ...
        className="w-full py-2.5 text-sm font-medium bg-teal-600 text-white rounded-xl hover:bg-teal-700 disabled:opacity-50 disabled:cursor-not-allowed"
      >
