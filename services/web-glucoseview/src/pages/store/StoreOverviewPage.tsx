/**
 * StoreOverviewPage - GlucoseView Store Dashboard Overview
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-500 mt-1">GlucoseView 약국 현황을 확인하세요</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
          <p className="text-sm text-slate-500">이번달 방문</p>
          <p className="text-2xl font-bold text-slate-800 mt-1">-</p>
        </div>
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
          <p className="text-sm text-slate-500">CGM 데이터</p>
          <p className="text-2xl font-bold text-slate-800 mt-1">-</p>
        </div>
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
