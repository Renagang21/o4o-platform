...
const mockStatusItems: StatusItem[] = [
  { id: '1', name: '혈당 관리 가이드', type: 'content', status: 'active', updatedAt: '2026-01-15' },
  { id: '2', name: '1월 건강 캠페인 배너', type: 'content', status: 'active', updatedAt: '2026-01-14' },
  { id: '3', name: '1월 건강 관리 이벤트', type: 'event', status: 'ongoing', updatedAt: '2026-01-01' },
];
