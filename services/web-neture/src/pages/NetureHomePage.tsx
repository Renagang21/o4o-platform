 ...
 *   MarketTrialBanner → MarketTrialSection (모집중 유통참여형 펀딩 카드 표시)
 *
 * 구조:
...
/**
 * WO-NETURE-MARKET-TRIAL-PAGE-SEPARATION-AND-HOME-RESTRUCTURE-V1:
 * 참여자 관점 — 모집중 유통참여형 펀딩 카드 + 공급자 CTA
 */
    ...
    <section style={mts.section}>
      <PageContainer>
        ...
        <div style={mts.headerRow}>
          <div>
            <h2 style={mts.heading}>유통참여형 펀딩</h2>
        ...
        {trials.length > 0 ? (
          ...
          <div style={mts.emptyBox}>
            <p style={mts.emptyText}>현재 모집 중인 유통참여형 펀딩이 없습니다.</p>
