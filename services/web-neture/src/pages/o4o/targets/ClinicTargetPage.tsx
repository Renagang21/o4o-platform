  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        {/* 채널 활용 안내 — WO-O4O-NETURE-CHANNEL-PAGES-ABSORB-V1: /o4o/channels/medical 흡수 */}
        <div className="rounded-xl border border-slate-200 bg-slate-50 p-6">
          <h2 className="text-xl font-bold text-gray-900 mb-2">의료기관 채널에서 O4O는 어떻게 작동하나요?</h2>
          <p className="text-sm text-gray-500 mb-5">
            의료기관의 신뢰와 통제권을 유지하면서 채널을 운영합니다.
          </p>
          <ul className="space-y-3 mb-5">
            <li className="flex items-start gap-3">
              <span className="shrink-0 mt-0.5 text-lg">🎛️</span>
              <div>
                <strong className="text-gray-900">채널 주도권은 의료기관에 있습니다</strong>
                <p className="text-sm text-gray-600 mt-0.5">TV·디지털 채널에서 무엇을 보여줄지, 사용할지 말지는 의료기관이 결정합니다.</p>
              </div>
            </li>
            <li className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mt-0.5">콘텐츠와 도구는 운영자가 제공하고, 선택·편집은 의료기관이 합니다.</p>
              </div>
            </li>
            <li className="flex items-start gap-3">
              <span className="shrink-0 mt-0.5 text-lg">🔗</span>
          ...
          <Link
            to="/o4o/apply?industry=clinic"
            onClick={() => trackEvent({ event: 'channel_apply_click', target: 'clinic', action: 'apply', position: 'channel-section' })}
