/**
 * OpticalTargetPage - 안경원 대상 사업자 안내
 */
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-slate-900 text-white py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <h1 className="text-3xl font-bold mb-4">안경원</h1>
          <p className="text-slate-300 leading-relaxed">
            안경, 렌즈 관련 상품을 취급하는 안경원을 위한 채널 운영 환경
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          ...
          <div className="p-6 bg-slate-50 rounded-xl border border-slate-200">
            ...
            <p className="text-gray-600 text-sm leading-relaxed">
              안경원 전용 웹사이트를 통해 안경/렌즈 안내, 상담 예약,
              상품 소개가 가능합니다. 고객이 방문 전 미리 확인합니다.
            </p>
          </div>
          ...
          <div className="p-6 bg-slate-50 rounded-xl border border-slate-200">
            ...
            <p className="text-gray-600 text-sm leading-relaxed">
              매장 내에서 고객이 직접 안경 스타일, 렌즈 종류,
              관련 상품 정보를 검색하고 확인할 수 있습니다.
            </p>
          </div>
          ...
          <div className="p-6 bg-slate-50 rounded-xl border border-slate-200">
            ...
            <p className="text-gray-600 text-sm leading-relaxed">
              매장 내 TV로 자체 방송 채널을 운영합니다.
              신상품 안내, 렌즈 관리법, 프로모션 등을 직접 편성합니다.
            </p>
          </div>
          ...
          <div className="p-6 bg-slate-50 rounded-xl border border-slate-200">
            ...
            <p className="text-gray-600 text-sm leading-relaxed">
              렌즈 관리법, 눈 건강 상식, 안경 선택 가이드 등 자체 교육 콘텐츠를 제작하고
              고객에게 제공할 수 있습니다.
            </p>
          </div>
        </div>
