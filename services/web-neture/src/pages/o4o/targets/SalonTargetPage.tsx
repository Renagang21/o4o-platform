    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-slate-900 text-white py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <h1 className="text-3xl font-bold mb-4">미용실</h1>
          <p className="text-slate-300 leading-relaxed">
            화장품, 미용용품을 취급하는 미용실을 위한 채널 운영 환경
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          ...
          <div className="p-6 bg-slate-50 rounded-xl border border-slate-200">
            ...
            <p className="text-gray-600 text-sm leading-relaxed">
              미용실 전용 웹사이트를 통해 스타일 안내, 상품 소개,
              예약 접수가 가능합니다. 고객이 방문 전 미리 확인합니다.
            </p>
          </div>
          ...
          <div className="p-6 bg-slate-50 rounded-xl border border-slate-200">
            ...
            <p className="text-gray-600 text-sm leading-relaxed">
              매장 내에서 고객이 직접 스타일북을 보거나
              화장품, 미용용품 정보를 확인할 수 있습니다.
            </p>
          </div>
          ...
          <div className="p-6 bg-slate-50 rounded-xl border border-slate-200">
            ...
            <p className="text-gray-600 text-sm leading-relaxed">
              ...
              스타일 트렌드, 상품 소개, 이벤트 안내 등을 직접 편성합니다.
            </p>
          </div>
          ...
          <div className="p-6 bg-slate-50 rounded-xl border border-slate-200">
            ...
            <p className="text-gray-600 text-sm leading-relaxed">
              홈케어 방법, 스타일링 팁, 제품 사용법 등 자체 교육 콘텐츠를 제작하고
              고객에게 제공할 수 있습니다.
            </p>
          </div>
        </div>
