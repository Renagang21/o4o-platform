 ...
 *
 * API: GET /api/v1/operator/members (플랫폼 공통, scope-filtered)
 * 참조: GlycoPharm UsersPage.tsx
 */
                    ...
                    <div className="flex items-center justify-end gap-1" onClick={(e) => e.stopPropagation()}>
                      {actionLoading === user.id ? (
                        ...
                        <>
                          ...
                          <button onClick={() => handleDelete(user)} title="삭제" className="p-1.5 text-red-400 hover:bg-red-50 rounded-lg">
