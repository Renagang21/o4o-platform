      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="relative">
          <select
            ...
            className="pl-4 pr-8 py-2 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-primary-500 appearance-none bg-white"
          >
              ...
              {selectedRequest.status === 'pending' && (
                <div className="pt-4 border-t border-slate-200">
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full px-4 py-3 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-primary-500 resize-none"
                  />
                </div>
              )}
