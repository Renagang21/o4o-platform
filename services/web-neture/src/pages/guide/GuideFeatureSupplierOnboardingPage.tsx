/**
 * GuideFeatureSupplierOnboardingPage — wrapper around shared component
 *
...
const PAGE_KEY = 'guide/features/supplier-onboarding';
...
export function GuideFeatureSupplierOnboardingPage() {
  return <Shared {...netureGuideFeatureSupplierOnboardingProps} renderText={renderText} />;
}
