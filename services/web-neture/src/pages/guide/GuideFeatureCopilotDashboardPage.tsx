/**
 * GuideFeatureCopilotDashboardPage — wrapper around shared component
 *
...
const PAGE_KEY = 'guide/features/copilot-dashboard';
...
export function GuideFeatureCopilotDashboardPage() {
  return <Shared {...netureGuideFeatureCopilotDashboardProps} renderText={renderText} />;
}
