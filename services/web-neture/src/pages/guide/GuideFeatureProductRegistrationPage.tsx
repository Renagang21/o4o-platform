/**
 * GuideFeatureProductRegistrationPage — wrapper around shared component
 *
...
const PAGE_KEY = 'guide/features/product-registration';
...
export function GuideFeatureProductRegistrationPage() {
  return <Shared {...netureGuideFeatureProductRegistrationProps} renderText={renderText} />;
}
