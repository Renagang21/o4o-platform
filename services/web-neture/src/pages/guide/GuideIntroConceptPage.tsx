/**
 * GuideIntroConceptPage — wrapper around shared component
 *
 * WO-O4O-NETURE-GUIDE-IA-AND-WRAPPER-PAGES-V1
 */
import { GuideIntroConceptPage as Shared, netureGuideIntroConceptProps } from '@o4o/shared-space-ui';
import type { GuideTextRenderer } from '@o4o/shared-space-ui';
import { GuideEditableSection } from '../../components/guide';

const PAGE_KEY = 'guide/intro/concept';
...
export function GuideIntroConceptPage() {
  return <Shared {...netureGuideIntroConceptProps} renderText={renderText} />;
}
