/**
 * GuideFeaturePartnerProgramPage — wrapper around shared component
 *
...
const PAGE_KEY = 'guide/features/partner-program';
...
export function GuideFeaturePartnerProgramPage() {
  return <Shared {...netureGuideFeaturePartnerProgramProps} renderText={renderText} />;
}
