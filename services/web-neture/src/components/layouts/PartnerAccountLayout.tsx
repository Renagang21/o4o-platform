/**
 * PartnerAccountLayout - 파트너 계정 대시보드 레이아웃
 *
...
const SIDEBAR_ITEMS = [
  ...
  { label: 'Contents', path: '/account/partner/contents', icon: FileText },
  { label: 'Links', path: '/account/partner/links', icon: Link2 },
  { label: 'Stores', path: '/account/partner/stores', icon: Store },
  { label: 'Forum', path: '/partner/forum', icon: MessageSquare },
];

export default function PartnerAccountLayout() {
