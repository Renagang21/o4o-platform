/**
 * MediaPickerModal — WO-O4O-COMMON-MEDIA-FOLDER-AND-LIBRARY-MANAGEMENT-V1
 *
 * 공용 미디어 선택기/업로더.
...
export default function MediaPickerModal({
  ...
  // Load library when tab switches, modal opens, or folder changes
      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-xl mx-4 max-h-[80vh] flex flex-col" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="flex-1 overflow-y-auto px-5 py-4 space-y-4">
          {tab === 'upload' ? (
            ...
            /* ── Library Tab ── */
            <>
              {/* Folder filter pills + view toggle */}
