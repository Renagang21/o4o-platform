...
### 5-A. 처음부터 재조사
- 본 WO 의 IR ([IR-O4O-KPA-OPERATOR-PROFILE-PRESENCE-AUDIT-V1.md](../../archive/investigations/IR-O4O-KPA-OPERATOR-PROFILE-PRESENCE-AUDIT-V1.md)) 는 참고로 활용 가능하나, 새 IR 작성 권장
...
- 근거 IR (참고): `docs/archive/investigations/IR-O4O-KPA-OPERATOR-PROFILE-PRESENCE-AUDIT-V1.md`
