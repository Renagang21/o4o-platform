...
| Route | 역할 | 상태 |
|-------|------|------|
| `/store-hub/event-offers` | Event Offer 탐색·조회 | KPA, K-Cosmetics ✓ |
| `/store/my-products` | 매장 상품 관리 | KPA, K-Cosmetics ✓ |
