...
## 📄 yaksa-main-site-summary-setup.md

좋습니다! 요청하신 문서를 복사/붙여넣기 형식으로 바로 사용하실 수 있도록 아래에 정리해드립니다. 새로운 채팅방(o4o-프론트엔드 4)에서 **yaksa.site 프론트엔드 테스트 기반 개발을 이어갈 때 참조용 문서**로 활용하세요.

---

### 📄 파일명: `yaksa-main-site-summary-setup.md`

````markdown
# yaksa.site 개발 작업 요약 (이전 채팅방 정리)

이 문서는 yaksa.site 프론트엔드 개발을 위한 초기 설정, 오류 해결, `AuthContext` 정비, `Profile.tsx` 수정, GitHub 연동 등 **이전 채팅방에서의 핵심 개발 이슈 및 해결 내용**을 정리한 요약입니다.  
...
* `yaksa.site` 도메인은 Nginx를 통해 443 포트로 프록시
* React 앱은 `serve`로 실행
...
✅ 본 문서는 새로운 채팅방에서 이어지는 yaksa.site 테스트 기반 개발의 출발점입니다.
````
...
* `Coding/o4o-platform/docs/Coding/o4o-platform/services/main-site/docs/yaksa-main-site-summary-setup.md`
