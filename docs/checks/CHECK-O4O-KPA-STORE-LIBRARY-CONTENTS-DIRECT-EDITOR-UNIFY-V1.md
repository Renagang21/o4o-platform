...
| direct [편집] → o4o 표준 RichTextEditor(편집/HTML/미리보기 탭) 노출 | ⏳ 배포 후 smoke |
| 본문 디자인(배경/박스 등 inline style) 보존 편집·저장 | ⏳ (편집기 = HTML 탭 raw 보존 WO 반영) |
| 저장 후 보기 모드 정상 렌더 + 재진입 시 html 유지 | ⏳ |
