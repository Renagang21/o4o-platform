...
> 관련 정적 조사는 [`IR-O4O-STORE-PRODUCTION-MATERIALS-COMMON-ENTITY-RENAME-AUDIT-V1`](../investigations/IR-O4O-STORE-PRODUCTION-MATERIALS-COMMON-ENTITY-RENAME-AUDIT-V1.md) 참조.
...
[`IR-O4O-STORE-PRODUCTION-MATERIALS-COMMON-ENTITY-RENAME-AUDIT-V1`](../investigations/IR-O4O-STORE-PRODUCTION-MATERIALS-COMMON-ENTITY-RENAME-AUDIT-V1.md) 의 핵심 사실:
...
| Capability 조사 (자매 IR) | [`docs/investigations/IR-O4O-KPA-STORE-PRODUCTION-MATERIALS-CAPABILITY-AUDIT-V1.md`](../investigations/IR-O4O-KPA-STORE-PRODUCTION-MATERIALS-CAPABILITY-AUDIT-V1.md) |
| Rename 정적 조사 (자매 IR) | [`docs/investigations/IR-O4O-STORE-PRODUCTION-MATERIALS-COMMON-ENTITY-RENAME-AUDIT-V1.md`](../investigations/IR-O4O-STORE-PRODUCTION-MATERIALS-COMMON-ENTITY-RENAME-AUDIT-V1.md) |
| Execution Content Asset Policy | [`docs/investigations/IR-O4O-STORE-EXECUTION-CONTENT-ASSET-POLICY-V1.md`](../investigations/IR-O4O-STORE-EXECUTION-CONTENT-ASSET-POLICY-V1.md) |
| Store Library canonical | [`docs/investigations/IR-O4O-STORE-LIBRARY-CANONICAL-ASSET-FLOW-V1.md`](../investigations/IR-O4O-STORE-LIBRARY-CANONICAL-ASSET-FLOW-V1.md) |
| Community → Store copy flow | [`docs/investigations/IR-O4O-COMMUNITY-TO-STORE-COPY-FLOW-AUDIT-V1.md`](../investigations/IR-O4O-COMMUNITY-TO-STORE-COPY-FLOW-AUDIT-V1.md) |
