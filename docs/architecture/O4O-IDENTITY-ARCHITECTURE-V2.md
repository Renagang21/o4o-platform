...
- [`CHECK-O4O-AUTH-HANDOFF-ACTIVE-MEMBERSHIP-VERIFICATION-V1`](../investigations/CHECK-O4O-AUTH-HANDOFF-ACTIVE-MEMBERSHIP-VERIFICATION-V1.md) — 프로덕션 E2E 검증, 필수 5/5 PASS.
