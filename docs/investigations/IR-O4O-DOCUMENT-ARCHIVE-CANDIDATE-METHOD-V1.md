...
### 대상 (7개, 전부 `docs/work-orders/`)

```
docs/work-orders/CHECK-O4O-HFF-ZH-ALL-REMAINING-10414-DIRECT-BULK-PRODUCTION-AND-TRACK-CLOSURE-V1.md
docs/work-orders/CHECK-O4O-HFF-ZH-BATCH-01-10000-DIRECT-BULK-PRODUCTION-V1.md
docs/work-orders/CHECK-O4O-HFF-ZH-BATCH-02-10000-DIRECT-BULK-PRODUCTION-V1.md
docs/work-orders/CHECK-O4O-HFF-ZH-BATCH-03-10000-DIRECT-BULK-PRODUCTION-V1.md
docs/work-orders/CHECK-O4O-HFF-ZH-BATCH-04-10000-DIRECT-BULK-PRODUCTION-V1.md
docs/work-orders/CHECK-O4O-HFF-ZH-NUMBER-STRUCTURE-AMBIGUOUS-101-REPAIR-AND-APPLY-V1.md
docs/work-orders/CHECK-O4O-HFF-ZH-TRANSLATION-AMBIGUOUS-319-REPAIR-AND-APPLY-V1.md
```
