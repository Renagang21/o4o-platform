...
| KPI | Neture | K-Cosmetics | GlucoseView | KPA |
| ----- | :------: | :-----------: | :-----------: | :---: |
| 활성 약국/매장 | ✅ | ✅ | ✅ | — |
| 활성 공급사/벤더 | ✅ | — | ✅ | — |
| 판매 상품 | ✅ | ✅ | — | — |
...
| Action | Neture | K-Cosmetics | GlucoseView | KPA |
| -------- | :------: | :-----------: | :-----------: | :---: |
| 가입/신청 승인 | ✅ | — | ✅ (2개) | ✅ |
| 공급사/상품 승인 | ✅ (2개) | ✅ (2개) | — | — |
| 주문 처리 | — | ✅ | — | — |
...
| QuickAction | Neture | K-Cosmetics | GlucoseView | KPA |
| ------------- | :------: | :-----------: | :-----------: | :---: |
| 공급사/약국 관리 | ✅ | ✅ | ✅ | — |
| 상품 관리 | ✅ | ✅ | ✅ | — |
| 주문 관리 | ✅ | ✅ | — | — |
...
| Group | Neture | K-Cosmetics | GlucoseView | KPA |
| ------- | :------: | :-----------: | :-----------: | :---: |
| 1. Dashboard | ✅ | ✅ | ✅ | ✅ |
| 2. Users | ❌ | ✅ | ✅ | ✅ |
| 3. Approvals | ✅ (1개) | ✅ | ✅ | ✅ |
...
|----------|:------------------:|------|
| **Users** | Backend API 없음 | KPA에는 회원 관리 페이지 존재 |
