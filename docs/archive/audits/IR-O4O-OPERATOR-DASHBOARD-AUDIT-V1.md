...
- **service_memberships** 테이블: 서비스 접근 제어
  ...
  - 서비스별 key: `neture`, `kpa-society`, `k-cosmetics`, `glucoseview`
...
|---------|:-------------:|-----------------|
| Neture | YES | kpa, cosmetics, glucoseview |
| KPA | NO | platform, neture, cosmetics, glucoseview |
| K-Cosmetics | YES | kpa, neture |
...
**평가**: Admin(4개) 대비 Operator(16개) 기능 역전.
...
| 기능 영역 | Neture | KPA | K-Cosmetics |
| ---------- | :------: | :---: | :-----------: |
| 사용자 관리 | Admin | Admin | Operator |
| 상품 관리 | Admin | — | Operator |
| 주문 관리 | Admin | — | Operator |
| 정산 관리 | Admin | — | Operator |
| 콘텐츠/CMS | Operator | Operator | Operator |
| 사이니지 | Operator | Operator | Operator |
| 포럼 관리 | Operator | Operator | — |
| AI 관리 | Admin+Oper | — | Operator |
| 가입 승인 | Operator | Admin | — |
| 공급자 관리 | Admin | — | — |
| 파트너 관리 | Admin | — | — |
...
| # | 서비스 | 메뉴 항목 | 문제 |
|---|--------|----------|------|
| M1 | — | 주문 관리 | Backend deprecated ("Phase 4-A: Legacy deprecated, returns empty") |
| M2 | — | 재고/공급 | Backend 부분 구현 |
| M3 | — | 고객지원 | Backend 미확인 |
| M4 | — | 설정 | Backend 미확인 |
...
**원인 분석**: K-Cosmetics에서 Admin은 "플랫폼 전체 관리자" 개념이고, Operator가 "실질적 서비스 운영자"로 설계됨. Admin 메뉴가 사실상 placeholder 수준.
...
| # | 항목 | 서비스 | 설명 |
|---|------|--------|------|
| C1 | Admin/Operator 기능 역전 | K-Cosmetics | Admin(4개) < Operator(23/16개). Admin이 사실상 빈 껍데기 |

### 8.2 Important (차기 정비)

| # | 항목 | 서비스 | 설명 |
|---|------|--------|------|
| I2 | 미확인 Backend | K-Cosmetics | "고객지원", "설정" 메뉴의 Backend 연결 불확실 |
