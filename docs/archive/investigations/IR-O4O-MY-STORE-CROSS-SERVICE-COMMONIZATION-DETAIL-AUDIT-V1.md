...
> KPA 기준 내 매장 구조를 K-Cosmetics에 어느 범위까지 공통화할 수 있는지 조사.
>
> 날짜: 2026-05-26
...
| **콘텐츠 가져오기** (StoreAssetsPanel) | ✅ /store/content | ✅ /store/content |
| **블로그 관리** | ✅ PharmacyBlogPage | ✅ StoreBlogManagePage |
| **POP 관리** | ✅ StorePopPage | ✅ StorePopPage |
...
| pharmacy/store 용어 혼재 | — | Phase 3 용어 통일 WO 대상 |
...
- **서비스별 Config**: `KPA_SOCIETY_STORE_CONFIG`, `COSMETICS_STORE_CONFIG` 공통 패키지에서 관리
...
| 항목 | 현상 | 철학 기준 | 심각도 |
|------|------|----------|--------|
| 내 자료함 K-Cosmetics 없음 | 3개 섹션 모두 누락 | 실행 자산 보관 흐름 미완 | 낮음 (기능 선택적) |
| K-Cosmetics `/store/orders` Placeholder | 실 데이터 없음 | 주문 관리 동선 미완 | 낮음 (주문 흐름 미도달) |
| pharmacy/store 용어 혼재 | — | 서비스 중립 명명 미이행 | 낮음 (Phase 3 대상) |
