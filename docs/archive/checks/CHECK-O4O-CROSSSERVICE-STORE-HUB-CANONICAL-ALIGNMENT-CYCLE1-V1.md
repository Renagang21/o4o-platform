...
**날짜**: 2026-06-01  
**목적**: KPA-Society canonical 기준으로 K-Cosmetics Store HUB 1차 정렬 완료 상태 문서화  
...
| 영역 | KPA | K-Cosmetics | 판정 | 비고 |
| ------ | ----- | ------------- | ------ | ------ |
| **상품 카탈로그** | HubB2BCatalogPage (793줄) | HubB2BPage (369줄) | ✅ 정렬 완료 | DataTable+ActionBar 통일 |
| **블로그** | HubBlogLibraryPage (400줄) | HubBlogLibraryPage (320줄) | ✅ 정렬 완료 | DataTable+ActionBar 통일 |
| **POP** | HubPopLibraryPage (374줄) | HubPopLibraryPage (320줄) | ✅ 정렬 완료 | DataTable+ActionBar 통일 |
| **QR** | HubQrLibraryPage (385줄) | HubQrLibraryPage (320줄) | ✅ 정렬 완료 | DataTable+ActionBar 통일 |
| **사이니지** | HubSignageLibraryPage (604줄) | HubSignagePage (579줄) | ✅ 정렬 완료 | assetSnapshot.copy 통일 |
| **콘텐츠** | HubContentLibraryPage (171줄) | HubContentPage (201줄) | ✅ 정렬 완료* | ContentHubTemplate 통일, copy API 통일 |
...
| 항목 | KPA | K-Cosmetics |
| ------ | ----- | ------------- |
| route `/store-hub/*` | ✅ 6영역 완비 | ✅ 6영역 완비 |
| DataTable (B2B/Signage/Blog/Pop/QR) | ✅ | ✅ |
| ActionBar (bulk 가져가기) | ✅ | ✅ |
| ContentHubTemplate (콘텐츠) | ✅ single-action | ✅ single-action |
| `assetSnapshotApi.copy({ assetType:'signage' })` | ✅ | ✅ |
| `assetSnapshotApi.copy({ assetType:'cms' })` | ✅ | ✅ |
| `dashboardCopyApi` 잔존 | ❌ 없음 | ❌ 없음 |
| Hub 루프 (`/store-hub/content` infoLinks 루프) | ❌ 없음 | ❌ 없음 |
| 내 매장 연결 (`/store/library/contents`) | `/store/content` | ✅ |
| copyLabel 문구 | '내 매장에 복사' | '내 매장에 복사' |
